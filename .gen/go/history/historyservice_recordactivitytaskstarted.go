...
func init() {
	HistoryService_RecordActivityTaskStarted_Helper.Args = func(addRequest *RecordActivityTaskStartedRequest) *HistoryService_RecordActivityTaskStarted_Args {
		return &HistoryService_RecordActivityTaskStarted_Args{AddRequest: addRequest}
	}
