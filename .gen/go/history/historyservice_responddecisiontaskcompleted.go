...
var HistoryService_RespondDecisionTaskCompleted_Helper = struct {
	Args           func(completeRequest *RespondDecisionTaskCompletedRequest) *HistoryService_RespondDecisionTaskCompleted_Args
...
func init() {
	HistoryService_RespondDecisionTaskCompleted_Helper.Args = func(completeRequest *RespondDecisionTaskCompletedRequest) *HistoryService_RespondDecisionTaskCompleted_Args {
		return &HistoryService_RespondDecisionTaskCompleted_Args{CompleteRequest: completeRequest}
	}
