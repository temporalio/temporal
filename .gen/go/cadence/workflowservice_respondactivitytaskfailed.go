...
func init() {
	WorkflowService_RespondActivityTaskFailed_Helper.Args = func(failRequest *shared.RespondActivityTaskFailedRequest) *WorkflowService_RespondActivityTaskFailed_Args {
		return &WorkflowService_RespondActivityTaskFailed_Args{FailRequest: failRequest}
	}
