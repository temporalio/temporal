...
var WorkflowService_PollForActivityTask_Helper = struct {
	Args           func(pollRequest *shared.PollForActivityTaskRequest) *WorkflowService_PollForActivityTask_Args
...
func init() {
	WorkflowService_PollForActivityTask_Helper.Args = func(pollRequest *shared.PollForActivityTaskRequest) *WorkflowService_PollForActivityTask_Args {
		return &WorkflowService_PollForActivityTask_Args{PollRequest: pollRequest}
	}
