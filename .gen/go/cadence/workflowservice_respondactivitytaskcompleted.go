...
var WorkflowService_RespondActivityTaskCompleted_Helper = struct {
	Args           func(completeRequest *shared.RespondActivityTaskCompletedRequest) *WorkflowService_RespondActivityTaskCompleted_Args
...
func init() {
	WorkflowService_RespondActivityTaskCompleted_Helper.Args = func(completeRequest *shared.RespondActivityTaskCompletedRequest) *WorkflowService_RespondActivityTaskCompleted_Args {
		return &WorkflowService_RespondActivityTaskCompleted_Args{CompleteRequest: completeRequest}
	}
