...
## Important Commands:
- Fast Go linting for changed packages: `make lint-code-changed`
- Full Go linting: `make lint-code`
...
6. **Verify (Standards):** VERY IMPORTANT: After making code changes, execute the project-specific build, linting and type-checking commands (`make lint-code-changed` for development; use `make lint-code` for full-repository linting)
