...
6. **Verify (Standards):** VERY IMPORTANT: Before pushing or completing changes, execute the project-specific build, linting and type-checking commands (`make lint-code`)
