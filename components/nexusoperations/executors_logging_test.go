...
func TestTaskExecutorLogCallFailure(t *testing.T) {
	...
	executor := taskExecutor{TaskExecutorOptions: TaskExecutorOptions{Logger: logger}}
	executor.logCallFailure(invocationTraceContext{
