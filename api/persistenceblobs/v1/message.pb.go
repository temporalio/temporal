...
type ActivityInfo struct {
	...
	StartedTime            *types.Timestamp `protobuf:"bytes,9,opt,name=started_time,json=startedTime,proto3" json:"started_time,omitempty"`
	...
	// (-- api-linter: core::0140::prepositions=disabled
	//     aip.dev/not-precedent: "to" is used to indicate interval. --)
	ScheduleToCloseTimeout *time.Duration `protobuf:"bytes,13,opt,name=schedule_to_close_timeout,json=scheduleToCloseTimeout,proto3,stdduration" json:"schedule_to_close_timeout,omitempty"`
	// (-- api-linter: core::0140::prepositions=disabled
	//     aip.dev/not-precedent: "to" is used to indicate interval. --)
	StartToCloseTimeout         *time.Duration   `protobuf:"bytes,14,opt,name=start_to_close_timeout,json=startToCloseTimeout,proto3,stdduration" json:"start_to_close_timeout,omitempty"`
	HeartbeatTimeout            *time.Duration   `protobuf:"bytes,15,opt,name=heartbeat_timeout,json=heartbeatTimeout,proto3,stdduration" json:"heartbeat_timeout,omitempty"`
	...
	RetryInitialInterval        *time.Duration   `protobuf:"bytes,23,opt,name=retry_initial_interval,json=retryInitialInterval,proto3,stdduration" json:"retry_initial_interval,omitempty"`
	RetryMaximumInterval        *time.Duration   `protobuf:"bytes,24,opt,name=retry_maximum_interval,json=retryMaximumInterval,proto3,stdduration" json:"retry_maximum_interval,omitempty"`
	...
	RetryExpirationTime         *types.Timestamp `protobuf:"bytes,26,opt,name=retry_expiration_time,json=retryExpirationTime,proto3" json:"retry_expiration_time,omitempty"`
	...
	LastHeartbeatUpdateTime     *types.Timestamp `protobuf:"bytes,34,opt,name=last_heartbeat_update_time,json=lastHeartbeatUpdateTime,proto3" json:"last_heartbeat_update_time,omitempty"`
}
...
func (m *ActivityInfo) GetScheduledTime() *types.Timestamp {
	if m != nil {
...
func (m *ActivityInfo) GetStartedTime() *types.Timestamp {
	if m != nil {
...
func (m *ActivityInfo) GetRetryExpirationTime() *types.Timestamp {
	if m != nil {
...
type WorkflowExecutionInfo struct {
	...
	StartTime                         *types.Timestamp `protobuf:"bytes,22,opt,name=start_time,json=startTime,proto3" json:"start_time,omitempty"`
	LastUpdateTime                    *types.Timestamp `protobuf:"bytes,23,opt,name=last_update_time,json=lastUpdateTime,proto3" json:"last_update_time,omitempty"`
	...
	WorkflowTaskStartedTime           *types.Timestamp `protobuf:"bytes,29,opt,name=workflow_task_started_time,json=workflowTaskStartedTime,proto3" json:"workflow_task_started_time,omitempty"`
	WorkflowTaskScheduledTime         *types.Timestamp `protobuf:"bytes,30,opt,name=workflow_task_scheduled_time,json=workflowTaskScheduledTime,proto3" json:"workflow_task_scheduled_time,omitempty"`
	...
	WorkflowTaskOriginalScheduledTime *types.Timestamp `protobuf:"bytes,32,opt,name=workflow_task_original_scheduled_time,json=workflowTaskOriginalScheduledTime,proto3" json:"workflow_task_original_scheduled_time,omitempty"`
	...
	RetryInitialInterval         *time.Duration          `protobuf:"bytes,39,opt,name=retry_initial_interval,json=retryInitialInterval,proto3,stdduration" json:"retry_initial_interval,omitempty"`
	RetryMaximumInterval         *time.Duration          `protobuf:"bytes,40,opt,name=retry_maximum_interval,json=retryMaximumInterval,proto3,stdduration" json:"retry_maximum_interval,omitempty"`
	...
	RetryExpirationTime          *types.Timestamp        `protobuf:"bytes,43,opt,name=retry_expiration_time,json=retryExpirationTime,proto3" json:"retry_expiration_time,omitempty"`
...
func (m *WorkflowExecutionInfo) GetLastUpdateTime() *types.Timestamp {
	if m != nil {
		return m.LastUpdateTime
	}
	return nil
...
func (m *WorkflowExecutionInfo) GetWorkflowTaskStartedTime() *types.Timestamp {
	if m != nil {
...
func (m *WorkflowExecutionInfo) GetWorkflowTaskScheduledTime() *types.Timestamp {
	if m != nil {
...
func (m *WorkflowExecutionInfo) GetWorkflowTaskOriginalScheduledTime() *types.Timestamp {
	if m != nil {
...
func (m *WorkflowExecutionInfo) GetRetryExpirationTime() *types.Timestamp {
	if m != nil {
		return m.RetryExpirationTime
	}
	return nil
...
type ChildExecutionInfo struct {
	...
	ParentClosePolicy      v14.ParentClosePolicy `protobuf:"varint,13,opt,name=parent_close_policy,json=parentClosePolicy,proto3,enum=temporal.api.enums.v1.ParentClosePolicy" json:"parent_close_policy,omitempty"`
...
type NamespaceConfig struct {
	...
	BadBinaries             *v15.BadBinaries  `protobuf:"bytes,3,opt,name=bad_binaries,json=badBinaries,proto3" json:"bad_binaries,omitempty"`
...
var fileDescriptor_ef806e155800e59a = []byte{
	...
	,
}
...
func (this *ActivityInfo) Equal(that interface{}) bool {
	...
	if !this.RetryExpirationTime.Equal(that1.RetryExpirationTime) {
		return false
	}
	...
	if !this.LastHeartbeatUpdateTime.Equal(that1.LastHeartbeatUpdateTime) {
		return false
	}
	return true
}
func (this *ShardInfo) Equal(that interface{}) bool {
	...
	if !this.TimerAckLevelTime.Equal(that1.TimerAckLevelTime) {
		return false
	}
...
func (this *WorkflowExecutionInfo) Equal(that interface{}) bool {
	...
	if !this.WorkflowTaskStartedTime.Equal(that1.WorkflowTaskStartedTime) {
		return false
	}
	if !this.WorkflowTaskScheduledTime.Equal(that1.WorkflowTaskScheduledTime) {
		return false
	}
	if this.CancelRequested != that1.CancelRequested {
		return false
	}
	if !this.WorkflowTaskOriginalScheduledTime.Equal(that1.WorkflowTaskOriginalScheduledTime) {
		return false
	}
...
func (m *ActivityInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.LastHeartbeatUpdateTime != nil {
		{
			size, err := m.LastHeartbeatUpdateTime.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.RetryExpirationTime != nil {
		{
			size, err := m.RetryExpirationTime.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ShardInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.TimerAckLevelTime != nil {
		{
			size, err := m.TimerAckLevelTime.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *WorkflowExecutionInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.StickyScheduleToStartTimeout != nil {
		n33, err33 := github_com_gogo_protobuf_types.StdDurationMarshalTo(*m.StickyScheduleToStartTimeout, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(*m.StickyScheduleToStartTimeout):])
		if err33 != nil {
			return 0, err33
		}
		i -= n33
	...
	if m.WorkflowTaskOriginalScheduledTime != nil {
		{
			size, err := m.WorkflowTaskOriginalScheduledTime.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.WorkflowTaskScheduledTime != nil {
		{
			size, err := m.WorkflowTaskScheduledTime.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.WorkflowTaskStartedTime != nil {
		{
			size, err := m.WorkflowTaskStartedTime.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.DefaultWorkflowTaskTimeout != nil {
		n41, err41 := github_com_gogo_protobuf_types.StdDurationMarshalTo(*m.DefaultWorkflowTaskTimeout, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(*m.DefaultWorkflowTaskTimeout):])
		if err41 != nil {
			return 0, err41
		}
		i -= n41
	...
	if m.WorkflowRunTimeout != nil {
		n42, err42 := github_com_gogo_protobuf_types.StdDurationMarshalTo(*m.WorkflowRunTimeout, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(*m.WorkflowRunTimeout):])
		if err42 != nil {
			return 0, err42
		}
		i -= n42
	...
	if m.WorkflowExecutionTimeout != nil {
		n43, err43 := github_com_gogo_protobuf_types.StdDurationMarshalTo(*m.WorkflowExecutionTimeout, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(*m.WorkflowExecutionTimeout):])
		if err43 != nil {
			return 0, err43
		}
		i -= n43
...
func (m *NamespaceConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Retention != nil {
		n48, err48 := github_com_gogo_protobuf_types.StdDurationMarshalTo(*m.Retention, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(*m.Retention):])
		if err48 != nil {
			return 0, err48
		}
		i -= n48
...
func (m *ActivityInfo) Size() (n int) {
	...
	if m.LastHeartbeatUpdateTime != nil {
		l = m.LastHeartbeatUpdateTime.Size()
		n += 2 + l + sovMessage(uint64(l))
	}
	return n
}
...
func (m *WorkflowExecutionInfo) Size() (n int) {
	...
	if m.WorkflowTaskStartedTime != nil {
		l = m.WorkflowTaskStartedTime.Size()
		n += 2 + l + sovMessage(uint64(l))
	}
	if m.WorkflowTaskScheduledTime != nil {
		l = m.WorkflowTaskScheduledTime.Size()
		n += 2 + l + sovMessage(uint64(l))
	}
	if m.CancelRequested {
		n += 3
	...
	if m.WorkflowTaskOriginalScheduledTime != nil {
		l = m.WorkflowTaskOriginalScheduledTime.Size()
		n += 2 + l + sovMessage(uint64(l))
	}
...
func (m *ActivityInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 26:
			...
			if m.RetryExpirationTime == nil {
				m.RetryExpirationTime = &types.Timestamp{}
			}
			if err := m.RetryExpirationTime.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 27:
		...
		case 34:
			...
			if m.LastHeartbeatUpdateTime == nil {
				m.LastHeartbeatUpdateTime = &types.Timestamp{}
			}
			if err := m.LastHeartbeatUpdateTime.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ShardInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			if m.TimerAckLevelTime == nil {
				m.TimerAckLevelTime = &types.Timestamp{}
			}
			if err := m.TimerAckLevelTime.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 9:
	...
	for iNdEx < l {
		...
		case 28:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.WorkflowTaskAttempt |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 29:
			...
			if m.WorkflowTaskStartedTime == nil {
				m.WorkflowTaskStartedTime = &types.Timestamp{}
			}
			if err := m.WorkflowTaskStartedTime.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 30:
			...
			if m.WorkflowTaskScheduledTime == nil {
				m.WorkflowTaskScheduledTime = &types.Timestamp{}
			}
			if err := m.WorkflowTaskScheduledTime.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 31:
		...
		case 32:
			...
			if m.WorkflowTaskOriginalScheduledTime == nil {
				m.WorkflowTaskOriginalScheduledTime = &types.Timestamp{}
			}
			if err := m.WorkflowTaskOriginalScheduledTime.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 34:
