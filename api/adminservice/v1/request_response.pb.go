...
type UpdateLocalExecutionStateRequest_State int32

const (
	UpdateLocalExecutionStateRequest_STATE_UNSPECIFIED    UpdateLocalExecutionStateRequest_State = 0
	UpdateLocalExecutionStateRequest_STATE_RUNNABLE       UpdateLocalExecutionStateRequest_State = 1
	UpdateLocalExecutionStateRequest_STATE_PAUSED         UpdateLocalExecutionStateRequest_State = 2
	UpdateLocalExecutionStateRequest_STATE_OWNERSHIP_LOST UpdateLocalExecutionStateRequest_State = 3
)

// Enum value maps for UpdateLocalExecutionStateRequest_State.
var (
	UpdateLocalExecutionStateRequest_State_name = map[int32]string{
		0: "STATE_UNSPECIFIED",
		1: "STATE_RUNNABLE",
		2: "STATE_PAUSED",
		3: "STATE_OWNERSHIP_LOST",
	}
	UpdateLocalExecutionStateRequest_State_value = map[string]int32{
		"STATE_UNSPECIFIED":    0,
		"STATE_RUNNABLE":       1,
		"STATE_PAUSED":         2,
		"STATE_OWNERSHIP_LOST": 3,
	}
)

func (x UpdateLocalExecutionStateRequest_State) Enum() *UpdateLocalExecutionStateRequest_State {
	p := new(UpdateLocalExecutionStateRequest_State)
	*p = x
	return p
}

func (x UpdateLocalExecutionStateRequest_State) String() string {
	switch x {
	case UpdateLocalExecutionStateRequest_STATE_UNSPECIFIED:
		return "UpdateLocalExecutionStateRequestStateUnspecified"
	case UpdateLocalExecutionStateRequest_STATE_RUNNABLE:
		return "UpdateLocalExecutionStateRequestStateRunnable"
	case UpdateLocalExecutionStateRequest_STATE_PAUSED:
		return "UpdateLocalExecutionStateRequestStatePaused"
	case UpdateLocalExecutionStateRequest_STATE_OWNERSHIP_LOST:
		return "UpdateLocalExecutionStateRequestStateOwnershipLost"
	default:
		return strconv.Itoa(int(x))
	}
...
func (UpdateLocalExecutionStateRequest_State) Descriptor() protoreflect.EnumDescriptor {
	return file_temporal_server_api_adminservice_v1_request_response_proto_enumTypes[1].Descriptor()
}

func (UpdateLocalExecutionStateRequest_State) Type() protoreflect.EnumType {
	return &file_temporal_server_api_adminservice_v1_request_response_proto_enumTypes[1]
}

func (x UpdateLocalExecutionStateRequest_State) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use UpdateLocalExecutionStateRequest_State.Descriptor instead.
func (UpdateLocalExecutionStateRequest_State) EnumDescriptor() ([]byte, []int) {
	return file_temporal_server_api_adminservice_v1_request_response_proto_rawDescGZIP(), []int{97, 0}
}
...
// SyncLocalExecutionRequest is the first prototype transport for history produced by a trusted
// local bridge. Ownership and lease fields will be added with poll-based acquisition.
type SyncLocalExecutionRequest struct {
	...
	LocalServerId        string                 `protobuf:"bytes,4,opt,name=local_server_id,json=localServerId,proto3" json:"local_server_id,omitempty"`
	SyncId               string                 `protobuf:"bytes,5,opt,name=sync_id,json=syncId,proto3" json:"sync_id,omitempty"`
	...
	HistoryBatches       []*v1.DataBlob         `protobuf:"bytes,10,rep,name=history_batches,json=historyBatches,proto3" json:"history_batches,omitempty"`
	VersionHistory       *v11.VersionHistory    `protobuf:"bytes,11,opt,name=version_history,json=versionHistory,proto3" json:"version_history,omitempty"`
	Release              bool                   `protobuf:"varint,12,opt,name=release,proto3" json:"release,omitempty"`
	OwnershipToken       []byte                 `protobuf:"bytes,13,opt,name=ownership_token,json=ownershipToken,proto3" json:"ownership_token,omitempty"`
	FencingEpoch         int64                  `protobuf:"varint,14,opt,name=fencing_epoch,json=fencingEpoch,proto3" json:"fencing_epoch,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *SyncLocalExecutionRequest) GetNamespace() string {
	if x != nil {
		return x.Namespace
	}
	return ""
...
func (x *SyncLocalExecutionRequest) GetExecution() *v1.WorkflowExecution {
	if x != nil {
		return x.Execution
	}
	return nil
...
func (x *SyncLocalExecutionRequest) GetProtocolVersion() int32 {
	if x != nil {
...
func (x *SyncLocalExecutionRequest) GetLocalServerId() string {
	if x != nil {
...
func (x *SyncLocalExecutionRequest) GetSyncId() string {
	if x != nil {
		return x.SyncId
	}
	return ""
...
func (x *SyncLocalExecutionRequest) GetPreviousEventId() int64 {
	if x != nil {
...
func (x *SyncLocalExecutionRequest) GetPreviousEventVersion() int64 {
	if x != nil {
...
func (x *SyncLocalExecutionRequest) GetNewEventId() int64 {
	if x != nil {
		return x.NewEventId
	}
	return 0
...
func (x *SyncLocalExecutionRequest) GetNewEventVersion() int64 {
	if x != nil {
...
func (x *SyncLocalExecutionRequest) GetHistoryBatches() []*v1.DataBlob {
	if x != nil {
		return x.HistoryBatches
	}
	return nil
...
func (x *SyncLocalExecutionRequest) GetVersionHistory() *v11.VersionHistory {
	if x != nil {
		return x.VersionHistory
	}
	return nil
...
func (x *SyncLocalExecutionRequest) GetRelease() bool {
	if x != nil {
		return x.Release
	}
	return false
...
func (x *SyncLocalExecutionRequest) GetOwnershipToken() []byte {
	if x != nil {
...
func (x *SyncLocalExecutionRequest) GetFencingEpoch() int64 {
	if x != nil {
...
type SyncLocalExecutionResponse struct {
	...
	AcknowledgedEventId      int64                  `protobuf:"varint,2,opt,name=acknowledged_event_id,json=acknowledgedEventId,proto3" json:"acknowledged_event_id,omitempty"`
	AcknowledgedEventVersion int64                  `protobuf:"varint,3,opt,name=acknowledged_event_version,json=acknowledgedEventVersion,proto3" json:"acknowledged_event_version,omitempty"`
	LeaseExpirationTime      *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=lease_expiration_time,json=leaseExpirationTime,proto3" json:"lease_expiration_time,omitempty"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *SyncLocalExecutionResponse) GetSyncId() string {
	if x != nil {
		return x.SyncId
	}
	return ""
...
func (x *SyncLocalExecutionResponse) GetAcknowledgedEventId() int64 {
	if x != nil {
		return x.AcknowledgedEventId
	}
	return 0
}

func (x *SyncLocalExecutionResponse) GetAcknowledgedEventVersion() int64 {
	if x != nil {
		return x.AcknowledgedEventVersion
	}
	return 0
}

func (x *SyncLocalExecutionResponse) GetLeaseExpirationTime() *timestamppb.Timestamp {
	if x != nil {
...
type UpdateLocalExecutionStateRequest struct {
	...
	FencingEpoch  int64                                  `protobuf:"varint,4,opt,name=fencing_epoch,json=fencingEpoch,proto3" json:"fencing_epoch,omitempty"`
	State         UpdateLocalExecutionStateRequest_State `protobuf:"varint,5,opt,name=state,proto3,enum=temporal.server.api.adminservice.v1.UpdateLocalExecutionStateRequest_State" json:"state,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UpdateLocalExecutionStateRequest) GetNamespace() string {
	if x != nil {
		return x.Namespace
	}
	return ""
...
func (x *UpdateLocalExecutionStateRequest) GetExecution() *v1.WorkflowExecution {
	if x != nil {
		return x.Execution
	}
	return nil
...
func (x *UpdateLocalExecutionStateRequest) GetLocalServerId() string {
	if x != nil {
		return x.LocalServerId
	}
	return ""
...
func (x *UpdateLocalExecutionStateRequest) GetFencingEpoch() int64 {
	if x != nil {
		return x.FencingEpoch
	}
	return 0
...
func (x *UpdateLocalExecutionStateRequest) GetState() UpdateLocalExecutionStateRequest_State {
	if x != nil {
		return x.State
	}
	return UpdateLocalExecutionStateRequest_STATE_UNSPECIFIED
}
...
const file_temporal_server_api_adminservice_v1_request_response_proto_rawDesc = "" +
	...
	"\x17MigrateScheduleResponse\"\xaa\x05\n" +
	"\x19SyncLocalExecutionRequest\x12\x1c\n" +
	"\tnamespace\x18\x01 \x01(\tR\tnamespace\x12G\n" +
	"\texecution\x18\x02 \x01(\v2).temporal.api.common.v1.WorkflowExecutionR\texecution\x12)\n" +
	"\x10protocol_version\x18\x03 \x01(\x05R\x0fprotocolVersion\x12&\n" +
	"\x0flocal_server_id\x18\x04 \x01(\tR\rlocalServerId\x12\x17\n" +
	"\async_id\x18\x05 \x01(\tR\x06syncId\x12*\n" +
	...
	"newEventId\x12*\n" +
	"\x11new_event_version\x18\t \x01(\x03R\x0fnewEventVersion\x12I\n" +
	"\x0fhistory_batches\x18\n" +
	" \x03(\v2 .temporal.api.common.v1.DataBlobR\x0ehistoryBatches\x12W\n" +
	"\x0fversion_history\x18\v \x01(\v2..temporal.server.api.history.v1.VersionHistoryR\x0eversionHistory\x12\x18\n" +
	"\arelease\x18\f \x01(\bR\arelease\x12'\n" +
	"\x0fownership_token\x18\r \x01(\fR\x0eownershipToken\x12#\n" +
	"\rfencing_epoch\x18\x0e \x01(\x03R\ffencingEpoch\"\xf7\x01\n" +
	"\x1aSyncLocalExecutionResponse\x12\x17\n" +
	"\async_id\x18\x01 \x01(\tR\x06syncId\x122\n" +
	"\x15acknowledged_event_id\x18\x02 \x01(\x03R\x13acknowledgedEventId\x12<\n" +
	"\x1aacknowledged_event_version\x18\x03 \x01(\x03R\x18acknowledgedEventVersion\x12N\n" +
	"\x15lease_expiration_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\x13leaseExpirationTime\"\x99\x03\n" +
	" UpdateLocalExecutionStateRequest\x12\x1c\n" +
	"\tnamespace\x18\x01 \x01(\tR\tnamespace\x12G\n" +
	"\texecution\x18\x02 \x01(\v2).temporal.api.common.v1.WorkflowExecutionR\texecution\x12&\n" +
	"\x0flocal_server_id\x18\x03 \x01(\tR\rlocalServerId\x12#\n" +
	"\rfencing_epoch\x18\x04 \x01(\x03R\ffencingEpoch\x12a\n" +
	"\x05state\x18\x05 \x01(\x0e2K.temporal.server.api.adminservice.v1.UpdateLocalExecutionStateRequest.StateR\x05state\"^\n" +
	"\x05State\x12\x15\n" +
	"\x11STATE_UNSPECIFIED\x10\x00\x12\x12\n" +
	"\x0eSTATE_RUNNABLE\x10\x01\x12\x10\n" +
	"\fSTATE_PAUSED\x10\x02\x12\x18\n" +
	"\x14STATE_OWNERSHIP_LOST\x10\x03\"#\n" +
	"!UpdateLocalExecutionStateResponseB8Z6go.temporal.io/server/api/adminservice/v1;adminserviceb\x06proto3"
...
var file_temporal_server_api_adminservice_v1_request_response_proto_goTypes = []any{
	...
	(UpdateLocalExecutionStateRequest_State)(0),         // 1: temporal.server.api.adminservice.v1.UpdateLocalExecutionStateRequest.State
	...
	(*SyncLocalExecutionRequest)(nil),                   // 97: temporal.server.api.adminservice.v1.SyncLocalExecutionRequest
	(*SyncLocalExecutionResponse)(nil),                  // 98: temporal.server.api.adminservice.v1.SyncLocalExecutionResponse
	(*UpdateLocalExecutionStateRequest)(nil),            // 99: temporal.server.api.adminservice.v1.UpdateLocalExecutionStateRequest
	(*UpdateLocalExecutionStateResponse)(nil),           // 100: temporal.server.api.adminservice.v1.UpdateLocalExecutionStateResponse
...
var file_temporal_server_api_adminservice_v1_request_response_proto_depIdxs = []int32{
	...
	111, // 73: temporal.server.api.adminservice.v1.SyncWorkflowStateRequest.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	147, // 74: temporal.server.api.adminservice.v1.SyncWorkflowStateRequest.versioned_transition:type_name -> temporal.server.api.persistence.v1.VersionedTransition
	148, // 75: temporal.server.api.adminservice.v1.SyncWorkflowStateRequest.version_histories:type_name -> temporal.server.api.history.v1.VersionHistories
	149, // 76: temporal.server.api.adminservice.v1.SyncWorkflowStateResponse.versioned_transition_artifact:type_name -> temporal.server.api.replication.v1.VersionedTransitionArtifact
	111, // 77: temporal.server.api.adminservice.v1.GenerateLastHistoryReplicationTasksRequest.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	150, // 78: temporal.server.api.adminservice.v1.DescribeTaskQueuePartitionRequest.task_queue_partition:type_name -> temporal.server.api.taskqueue.v1.TaskQueuePartition
	151, // 79: temporal.server.api.adminservice.v1.DescribeTaskQueuePartitionRequest.build_ids:type_name -> temporal.api.taskqueue.v1.TaskQueueVersionSelection
	...
	152, // 81: temporal.server.api.adminservice.v1.DescribeTaskQueuePartitionResponse.scale_info:type_name -> temporal.server.api.taskqueue.v1.PartitionScaleInfo
	150, // 82: temporal.server.api.adminservice.v1.ForceUnloadTaskQueuePartitionRequest.task_queue_partition:type_name -> temporal.server.api.taskqueue.v1.TaskQueuePartition
	132, // 83: temporal.server.api.adminservice.v1.GetTaskQueueUserDataRequest.task_queue_type:type_name -> temporal.api.enums.v1.TaskQueueType
	153, // 84: temporal.server.api.adminservice.v1.GetTaskQueueUserDataResponse.user_data:type_name -> temporal.server.api.persistence.v1.TaskQueueTypeUserData
	111, // 85: temporal.server.api.adminservice.v1.StartAdminBatchOperationRequest.executions:type_name -> temporal.api.common.v1.WorkflowExecution
	94,  // 86: temporal.server.api.adminservice.v1.StartAdminBatchOperationRequest.refresh_tasks_operation:type_name -> temporal.server.api.adminservice.v1.BatchOperationRefreshTasks
	...
	111, // 88: temporal.server.api.adminservice.v1.SyncLocalExecutionRequest.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	112, // 89: temporal.server.api.adminservice.v1.SyncLocalExecutionRequest.history_batches:type_name -> temporal.api.common.v1.DataBlob
	113, // 90: temporal.server.api.adminservice.v1.SyncLocalExecutionRequest.version_history:type_name -> temporal.server.api.history.v1.VersionHistory
	119, // 91: temporal.server.api.adminservice.v1.SyncLocalExecutionResponse.lease_expiration_time:type_name -> google.protobuf.Timestamp
	111, // 92: temporal.server.api.adminservice.v1.UpdateLocalExecutionStateRequest.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	1,   // 93: temporal.server.api.adminservice.v1.UpdateLocalExecutionStateRequest.state:type_name -> temporal.server.api.adminservice.v1.UpdateLocalExecutionStateRequest.State
	121, // 94: temporal.server.api.adminservice.v1.GetReplicationMessagesResponse.ShardMessagesEntry.value:type_name -> temporal.server.api.replication.v1.ReplicationMessages
	154, // 95: temporal.server.api.adminservice.v1.AddSearchAttributesRequest.SearchAttributesEntry.value:type_name -> temporal.api.enums.v1.IndexedValueType
	154, // 96: temporal.server.api.adminservice.v1.GetSearchAttributesResponse.CustomAttributesEntry.value:type_name -> temporal.api.enums.v1.IndexedValueType
	154, // 97: temporal.server.api.adminservice.v1.GetSearchAttributesResponse.SystemAttributesEntry.value:type_name -> temporal.api.enums.v1.IndexedValueType
	112, // 98: temporal.server.api.adminservice.v1.AddTasksRequest.Task.blob:type_name -> temporal.api.common.v1.DataBlob
	155, // 99: temporal.server.api.adminservice.v1.DescribeTaskQueuePartitionResponse.VersionsInfoInternalEntry.value:type_name -> temporal.server.api.taskqueue.v1.TaskQueueVersionInfoInternal
