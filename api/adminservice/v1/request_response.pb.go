...
type StartAdminBatchOperationRequest struct {
	...
	//	*StartAdminBatchOperationRequest_DeleteOperation
	//	*StartAdminBatchOperationRequest_ReplicateOperation
	//	*StartAdminBatchOperationRequest_RebuildOperation
...
func (x *StartAdminBatchOperationRequest) GetDeleteOperation() *BatchOperationDelete {
	if x != nil {
		if x, ok := x.Operation.(*StartAdminBatchOperationRequest_DeleteOperation); ok {
...
func (x *StartAdminBatchOperationRequest) GetReplicateOperation() *BatchOperationReplicate {
	if x != nil {
		if x, ok := x.Operation.(*StartAdminBatchOperationRequest_ReplicateOperation); ok {
			return x.ReplicateOperation
		}
	}
	return nil
}

func (x *StartAdminBatchOperationRequest) GetRebuildOperation() *BatchOperationRebuild {
	if x != nil {
		if x, ok := x.Operation.(*StartAdminBatchOperationRequest_RebuildOperation); ok {
			return x.RebuildOperation
		}
	}
	return nil
}
...
type StartAdminBatchOperationRequest_DeleteOperation struct {
	// Add admin batch delete, replicate and rebuild
	DeleteOperation *BatchOperationDelete `protobuf:"bytes,11,opt,name=delete_operation,json=deleteOperation,proto3,oneof"`
}

type StartAdminBatchOperationRequest_ReplicateOperation struct {
	ReplicateOperation *BatchOperationReplicate `protobuf:"bytes,12,opt,name=replicate_operation,json=replicateOperation,proto3,oneof"`
}

type StartAdminBatchOperationRequest_RebuildOperation struct {
	RebuildOperation *BatchOperationRebuild `protobuf:"bytes,13,opt,name=rebuild_operation,json=rebuildOperation,proto3,oneof"`
}

func (*StartAdminBatchOperationRequest_RefreshTasksOperation) isStartAdminBatchOperationRequest_Operation() {
}

func (*StartAdminBatchOperationRequest_DeleteOperation) isStartAdminBatchOperationRequest_Operation() {
}

func (*StartAdminBatchOperationRequest_ReplicateOperation) isStartAdminBatchOperationRequest_Operation() {
}

func (*StartAdminBatchOperationRequest_RebuildOperation) isStartAdminBatchOperationRequest_Operation() {
}
...
func (x *BatchOperationDelete) Reset() {
	*x = BatchOperationDelete{}
	mi := &file_temporal_server_api_adminservice_v1_request_response_proto_msgTypes[91]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BatchOperationDelete) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BatchOperationDelete) ProtoMessage() {}

func (x *BatchOperationDelete) ProtoReflect() protoreflect.Message {
	mi := &file_temporal_server_api_adminservice_v1_request_response_proto_msgTypes[91]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BatchOperationDelete.ProtoReflect.Descriptor instead.
func (*BatchOperationDelete) Descriptor() ([]byte, []int) {
...
func (x *BatchOperationReplicate) Reset() {
	*x = BatchOperationReplicate{}
	mi := &file_temporal_server_api_adminservice_v1_request_response_proto_msgTypes[92]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BatchOperationReplicate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BatchOperationReplicate) ProtoMessage() {}

func (x *BatchOperationReplicate) ProtoReflect() protoreflect.Message {
	mi := &file_temporal_server_api_adminservice_v1_request_response_proto_msgTypes[92]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BatchOperationReplicate.ProtoReflect.Descriptor instead.
func (*BatchOperationReplicate) Descriptor() ([]byte, []int) {
	return file_temporal_server_api_adminservice_v1_request_response_proto_rawDescGZIP(), []int{92}
}

func (x *BatchOperationReplicate) GetTargetClusters() []string {
	if x != nil {
		return x.TargetClusters
	}
	return nil
...
type BatchOperationRebuild struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *BatchOperationRebuild) Reset() {
	*x = BatchOperationRebuild{}
	mi := &file_temporal_server_api_adminservice_v1_request_response_proto_msgTypes[93]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BatchOperationRebuild) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BatchOperationRebuild) ProtoMessage() {}

func (x *BatchOperationRebuild) ProtoReflect() protoreflect.Message {
	mi := &file_temporal_server_api_adminservice_v1_request_response_proto_msgTypes[93]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BatchOperationRebuild.ProtoReflect.Descriptor instead.
func (*BatchOperationRebuild) Descriptor() ([]byte, []int) {
...
const file_temporal_server_api_adminservice_v1_request_response_proto_rawDesc = "" +
	...
	"\n" +
	"was_loaded\x18\x01 \x01(\bR\twasLoaded\"\xcc\x05\n" +
	...
	" \x01(\v2?.temporal.server.api.adminservice.v1.BatchOperationRefreshTasksH\x00R\x15refreshTasksOperation\x12f\n" +
	"\x10delete_operation\x18\v \x01(\v29.temporal.server.api.adminservice.v1.BatchOperationDeleteH\x00R\x0fdeleteOperation\x12o\n" +
	"\x13replicate_operation\x18\f \x01(\v2<.temporal.server.api.adminservice.v1.BatchOperationReplicateH\x00R\x12replicateOperation\x12i\n" +
	"\x11rebuild_operation\x18\r \x01(\v2:.temporal.server.api.adminservice.v1.BatchOperationRebuildH\x00R\x10rebuildOperationB\v\n" +
	"\toperation\"\"\n" +
	" StartAdminBatchOperationResponse\"\x1c\n" +
	"\x1aBatchOperationRefreshTasks\"\x16\n" +
	"\x14BatchOperationDelete\"B\n" +
	"\x17BatchOperationReplicate\x12'\n" +
	"\x0ftarget_clusters\x18\x01 \x03(\tR\x0etargetClusters\"\x17\n" +
	"\x15BatchOperationRebuildB8Z6go.temporal.io/server/api/adminservice/v1;adminserviceb\x06proto3"
...
var file_temporal_server_api_adminservice_v1_request_response_proto_goTypes = []any{
	...
	(*BatchOperationDelete)(nil),                        // 91: temporal.server.api.adminservice.v1.BatchOperationDelete
	(*BatchOperationReplicate)(nil),                     // 92: temporal.server.api.adminservice.v1.BatchOperationReplicate
	(*BatchOperationRebuild)(nil),                       // 93: temporal.server.api.adminservice.v1.BatchOperationRebuild
...
var file_temporal_server_api_adminservice_v1_request_response_proto_depIdxs = []int32{
	...
	103, // 79: temporal.server.api.adminservice.v1.DescribeTaskQueuePartitionResponse.versions_info_internal:type_name -> temporal.server.api.adminservice.v1.DescribeTaskQueuePartitionResponse.VersionsInfoInternalEntry
	142, // 80: temporal.server.api.adminservice.v1.ForceUnloadTaskQueuePartitionRequest.task_queue_partition:type_name -> temporal.server.api.taskqueue.v1.TaskQueuePartition
	104, // 81: temporal.server.api.adminservice.v1.StartAdminBatchOperationRequest.executions:type_name -> temporal.api.common.v1.WorkflowExecution
	...
	91,  // 83: temporal.server.api.adminservice.v1.StartAdminBatchOperationRequest.delete_operation:type_name -> temporal.server.api.adminservice.v1.BatchOperationDelete
	92,  // 84: temporal.server.api.adminservice.v1.StartAdminBatchOperationRequest.replicate_operation:type_name -> temporal.server.api.adminservice.v1.BatchOperationReplicate
	93,  // 85: temporal.server.api.adminservice.v1.StartAdminBatchOperationRequest.rebuild_operation:type_name -> temporal.server.api.adminservice.v1.BatchOperationRebuild
	...
	144, // 87: temporal.server.api.adminservice.v1.AddSearchAttributesRequest.SearchAttributesEntry.value:type_name -> temporal.api.enums.v1.IndexedValueType
	144, // 88: temporal.server.api.adminservice.v1.GetSearchAttributesResponse.CustomAttributesEntry.value:type_name -> temporal.api.enums.v1.IndexedValueType
	144, // 89: temporal.server.api.adminservice.v1.GetSearchAttributesResponse.SystemAttributesEntry.value:type_name -> temporal.api.enums.v1.IndexedValueType
	105, // 90: temporal.server.api.adminservice.v1.AddTasksRequest.Task.blob:type_name -> temporal.api.common.v1.DataBlob
	145, // 91: temporal.server.api.adminservice.v1.DescribeTaskQueuePartitionResponse.VersionsInfoInternalEntry.value:type_name -> temporal.server.api.taskqueue.v1.TaskQueueVersionInfoInternal
...
func file_temporal_server_api_adminservice_v1_request_response_proto_init() {
	...
	file_temporal_server_api_adminservice_v1_request_response_proto_msgTypes[88].OneofWrappers = []any{
		...
		(*StartAdminBatchOperationRequest_DeleteOperation)(nil),
		(*StartAdminBatchOperationRequest_ReplicateOperation)(nil),
		(*StartAdminBatchOperationRequest_RebuildOperation)(nil),
	}
	type x struct{}
