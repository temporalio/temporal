...
func (MigrateScheduleRequest_SchedulerTarget) EnumDescriptor() ([]byte, []int) {
	return file_temporal_server_api_adminservice_v1_request_response_proto_rawDescGZIP(), []int{100, 0}
}
...
func (x *GetDynamicConfigValueRequest) Reset() {
	*x = GetDynamicConfigValueRequest{}
	mi := &file_temporal_server_api_adminservice_v1_request_response_proto_msgTypes[90]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetDynamicConfigValueRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetDynamicConfigValueRequest) ProtoMessage() {}

func (x *GetDynamicConfigValueRequest) ProtoReflect() protoreflect.Message {
	mi := &file_temporal_server_api_adminservice_v1_request_response_proto_msgTypes[90]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetDynamicConfigValueRequest.ProtoReflect.Descriptor instead.
func (*GetDynamicConfigValueRequest) Descriptor() ([]byte, []int) {
	return file_temporal_server_api_adminservice_v1_request_response_proto_rawDescGZIP(), []int{90}
}

func (x *GetDynamicConfigValueRequest) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
func (x *GetDynamicConfigValueRequest) GetConstraints() string {
	if x != nil {
...
func (x *GetDynamicConfigValueRequest) GetIncludeConstrainedValues() bool {
	if x != nil {
		return x.IncludeConstrainedValues
	}
	return false
}
...
func (x *GetDynamicConfigValueResponse) Reset() {
	*x = GetDynamicConfigValueResponse{}
	mi := &file_temporal_server_api_adminservice_v1_request_response_proto_msgTypes[91]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetDynamicConfigValueResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetDynamicConfigValueResponse) ProtoMessage() {}

func (x *GetDynamicConfigValueResponse) ProtoReflect() protoreflect.Message {
	mi := &file_temporal_server_api_adminservice_v1_request_response_proto_msgTypes[91]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetDynamicConfigValueResponse.ProtoReflect.Descriptor instead.
func (*GetDynamicConfigValueResponse) Descriptor() ([]byte, []int) {
	return file_temporal_server_api_adminservice_v1_request_response_proto_rawDescGZIP(), []int{91}
}

func (x *GetDynamicConfigValueResponse) GetValue() []byte {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *GetDynamicConfigValueResponse) GetConstrainedValues() []byte {
	if x != nil {
		return x.ConstrainedValues
	}
	return nil
}

type DescribeDynamicConfigSettingRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Key           string                 `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *DescribeDynamicConfigSettingRequest) Reset() {
	*x = DescribeDynamicConfigSettingRequest{}
	mi := &file_temporal_server_api_adminservice_v1_request_response_proto_msgTypes[92]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DescribeDynamicConfigSettingRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DescribeDynamicConfigSettingRequest) ProtoMessage() {}

func (x *DescribeDynamicConfigSettingRequest) ProtoReflect() protoreflect.Message {
	mi := &file_temporal_server_api_adminservice_v1_request_response_proto_msgTypes[92]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DescribeDynamicConfigSettingRequest.ProtoReflect.Descriptor instead.
func (*DescribeDynamicConfigSettingRequest) Descriptor() ([]byte, []int) {
	return file_temporal_server_api_adminservice_v1_request_response_proto_rawDescGZIP(), []int{92}
}

func (x *DescribeDynamicConfigSettingRequest) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
type DynamicConfigConstraintFields struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *DynamicConfigConstraintFields) Reset() {
	*x = DynamicConfigConstraintFields{}
	mi := &file_temporal_server_api_adminservice_v1_request_response_proto_msgTypes[93]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DynamicConfigConstraintFields) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DynamicConfigConstraintFields) ProtoMessage() {}

func (x *DynamicConfigConstraintFields) ProtoReflect() protoreflect.Message {
	mi := &file_temporal_server_api_adminservice_v1_request_response_proto_msgTypes[93]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DynamicConfigConstraintFields.ProtoReflect.Descriptor instead.
func (*DynamicConfigConstraintFields) Descriptor() ([]byte, []int) {
	return file_temporal_server_api_adminservice_v1_request_response_proto_rawDescGZIP(), []int{93}
}

func (x *DynamicConfigConstraintFields) GetFields() []string {
	if x != nil {
		return x.Fields
	}
	return nil
...
type DescribeDynamicConfigSettingResponse struct {
	state                protoimpl.MessageState           `protogen:"open.v1"`
	Key                  string                           `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
...
func (x *DescribeDynamicConfigSettingResponse) Reset() {
	*x = DescribeDynamicConfigSettingResponse{}
	mi := &file_temporal_server_api_adminservice_v1_request_response_proto_msgTypes[94]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DescribeDynamicConfigSettingResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DescribeDynamicConfigSettingResponse) ProtoMessage() {}

func (x *DescribeDynamicConfigSettingResponse) ProtoReflect() protoreflect.Message {
	mi := &file_temporal_server_api_adminservice_v1_request_response_proto_msgTypes[94]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DescribeDynamicConfigSettingResponse.ProtoReflect.Descriptor instead.
func (*DescribeDynamicConfigSettingResponse) Descriptor() ([]byte, []int) {
	return file_temporal_server_api_adminservice_v1_request_response_proto_rawDescGZIP(), []int{94}
}

func (x *DescribeDynamicConfigSettingResponse) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
func (x *DescribeDynamicConfigSettingResponse) GetPrecedence() string {
	if x != nil {
		return x.Precedence
	}
	return ""
...
func (x *DescribeDynamicConfigSettingResponse) GetSupportedConstraints() []string {
	if x != nil {
		return x.SupportedConstraints
	}
	return nil
}

func (x *DescribeDynamicConfigSettingResponse) GetConstraintPrecedence() []*DynamicConfigConstraintFields {
	if x != nil {
...
func (x *DumpDynamicConfigValuesRequest) Reset() {
	*x = DumpDynamicConfigValuesRequest{}
	mi := &file_temporal_server_api_adminservice_v1_request_response_proto_msgTypes[95]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DumpDynamicConfigValuesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DumpDynamicConfigValuesRequest) ProtoMessage() {}

func (x *DumpDynamicConfigValuesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_temporal_server_api_adminservice_v1_request_response_proto_msgTypes[95]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DumpDynamicConfigValuesRequest.ProtoReflect.Descriptor instead.
func (*DumpDynamicConfigValuesRequest) Descriptor() ([]byte, []int) {
...
func (x *DumpDynamicConfigValuesResponse) Reset() {
	*x = DumpDynamicConfigValuesResponse{}
	mi := &file_temporal_server_api_adminservice_v1_request_response_proto_msgTypes[96]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DumpDynamicConfigValuesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DumpDynamicConfigValuesResponse) ProtoMessage() {}

func (x *DumpDynamicConfigValuesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_temporal_server_api_adminservice_v1_request_response_proto_msgTypes[96]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DumpDynamicConfigValuesResponse.ProtoReflect.Descriptor instead.
func (*DumpDynamicConfigValuesResponse) Descriptor() ([]byte, []int) {
	return file_temporal_server_api_adminservice_v1_request_response_proto_rawDescGZIP(), []int{96}
}

func (x *DumpDynamicConfigValuesResponse) GetValues() []byte {
	if x != nil {
		return x.Values
	}
	return nil
...
func (*MigrateScheduleResponse) Descriptor() ([]byte, []int) {
	return file_temporal_server_api_adminservice_v1_request_response_proto_rawDescGZIP(), []int{101}
}
...
func (x *ListQueuesResponse_QueueInfo) Reset() {
	*x = ListQueuesResponse_QueueInfo{}
	mi := &file_temporal_server_api_adminservice_v1_request_response_proto_msgTypes[110]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_temporal_server_api_adminservice_v1_request_response_proto_rawDesc = "" +
	...
	"\x1cGetDynamicConfigValueRequest\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12 \n" +
	"\vconstraints\x18\x02 \x01(\tR\vconstraints\x12<\n" +
	"\x1ainclude_constrained_values\x18\x03 \x01(\bR\x18includeConstrainedValues\"d\n" +
	"\x1dGetDynamicConfigValueResponse\x12\x14\n" +
	"\x05value\x18\x01 \x01(\fR\x05value\x12-\n" +
	"\x12constrained_values\x18\x02 \x01(\fR\x11constrainedValues\"7\n" +
...
var file_temporal_server_api_adminservice_v1_request_response_proto_goTypes = []any{
	...
	(*GetDynamicConfigValueRequest)(nil),                // 91: temporal.server.api.adminservice.v1.GetDynamicConfigValueRequest
	(*GetDynamicConfigValueResponse)(nil),               // 92: temporal.server.api.adminservice.v1.GetDynamicConfigValueResponse
	(*DescribeDynamicConfigSettingRequest)(nil),         // 93: temporal.server.api.adminservice.v1.DescribeDynamicConfigSettingRequest
	(*DynamicConfigConstraintFields)(nil),               // 94: temporal.server.api.adminservice.v1.DynamicConfigConstraintFields
	(*DescribeDynamicConfigSettingResponse)(nil),        // 95: temporal.server.api.adminservice.v1.DescribeDynamicConfigSettingResponse
	(*DumpDynamicConfigValuesRequest)(nil),              // 96: temporal.server.api.adminservice.v1.DumpDynamicConfigValuesRequest
	(*DumpDynamicConfigValuesResponse)(nil),             // 97: temporal.server.api.adminservice.v1.DumpDynamicConfigValuesResponse
	(*StartAdminBatchOperationRequest)(nil),             // 98: temporal.server.api.adminservice.v1.StartAdminBatchOperationRequest
	(*StartAdminBatchOperationResponse)(nil),            // 99: temporal.server.api.adminservice.v1.StartAdminBatchOperationResponse
	(*BatchOperationRefreshTasks)(nil),                  // 100: temporal.server.api.adminservice.v1.BatchOperationRefreshTasks
	(*MigrateScheduleRequest)(nil),                      // 101: temporal.server.api.adminservice.v1.MigrateScheduleRequest
	(*MigrateScheduleResponse)(nil),                     // 102: temporal.server.api.adminservice.v1.MigrateScheduleResponse
	nil,                                                 // 103: temporal.server.api.adminservice.v1.GetReplicationMessagesResponse.ShardMessagesEntry
	nil,                                                 // 104: temporal.server.api.adminservice.v1.AddSearchAttributesRequest.SearchAttributesEntry
	nil,                                                 // 105: temporal.server.api.adminservice.v1.GetSearchAttributesResponse.CustomAttributesEntry
	nil,                                                 // 106: temporal.server.api.adminservice.v1.GetSearchAttributesResponse.SystemAttributesEntry
	nil,                                                 // 107: temporal.server.api.adminservice.v1.GetSearchAttributesResponse.MappingEntry
	nil,                                                 // 108: temporal.server.api.adminservice.v1.DescribeClusterResponse.SupportedClientsEntry
	nil,                                                 // 109: temporal.server.api.adminservice.v1.DescribeClusterResponse.TagsEntry
	(*AddTasksRequest_Task)(nil),                        // 110: temporal.server.api.adminservice.v1.AddTasksRequest.Task
	(*ListQueuesResponse_QueueInfo)(nil),                // 111: temporal.server.api.adminservice.v1.ListQueuesResponse.QueueInfo
	nil,                                                 // 112: temporal.server.api.adminservice.v1.DescribeTaskQueuePartitionResponse.VersionsInfoInternalEntry
	(*v1.WorkflowExecution)(nil),                        // 113: temporal.api.common.v1.WorkflowExecution
	(*v1.DataBlob)(nil),                                 // 114: temporal.api.common.v1.DataBlob
	(*v11.VersionHistory)(nil),                          // 115: temporal.server.api.history.v1.VersionHistory
	(*v12.WorkflowMutableState)(nil),                    // 116: temporal.server.api.persistence.v1.WorkflowMutableState
	(*v13.NamespaceCacheInfo)(nil),                      // 117: temporal.server.api.namespace.v1.NamespaceCacheInfo
	(*v12.ShardInfo)(nil),                               // 118: temporal.server.api.persistence.v1.ShardInfo
	(*v11.TaskRange)(nil),                               // 119: temporal.server.api.history.v1.TaskRange
	(v14.TaskType)(0),                                   // 120: temporal.server.api.enums.v1.TaskType
	(*timestamppb.Timestamp)(nil),                       // 121: google.protobuf.Timestamp
	(*v15.ReplicationToken)(nil),                        // 122: temporal.server.api.replication.v1.ReplicationToken
	(*v15.ReplicationMessages)(nil),                     // 123: temporal.server.api.replication.v1.ReplicationMessages
	(*v15.ReplicationTaskInfo)(nil),                     // 124: temporal.server.api.replication.v1.ReplicationTaskInfo
	(*v15.ReplicationTask)(nil),                         // 125: temporal.server.api.replication.v1.ReplicationTask
	(*v17.WorkflowExecutionInfo)(nil),                   // 126: temporal.api.workflow.v1.WorkflowExecutionInfo
	(*v18.MembershipInfo)(nil),                          // 127: temporal.server.api.cluster.v1.MembershipInfo
	(*v19.VersionInfo)(nil),                             // 128: temporal.api.version.v1.VersionInfo
	(*v12.ClusterMetadata)(nil),                         // 129: temporal.server.api.persistence.v1.ClusterMetadata
	(*durationpb.Duration)(nil),                         // 130: google.protobuf.Duration
	(v14.ClusterMemberRole)(0),                          // 131: temporal.server.api.enums.v1.ClusterMemberRole
	(*v18.ClusterMember)(nil),                           // 132: temporal.server.api.cluster.v1.ClusterMember
	(v14.DeadLetterQueueType)(0),                        // 133: temporal.server.api.enums.v1.DeadLetterQueueType
	(v16.TaskQueueType)(0),                              // 134: temporal.api.enums.v1.TaskQueueType
	(*v12.AllocatedTaskInfo)(nil),                       // 135: temporal.server.api.persistence.v1.AllocatedTaskInfo
	(*v15.SyncReplicationState)(nil),                    // 136: temporal.server.api.replication.v1.SyncReplicationState
	(*v15.WorkflowReplicationMessages)(nil),             // 137: temporal.server.api.replication.v1.WorkflowReplicationMessages
	(*v110.NamespaceInfo)(nil),                          // 138: temporal.api.namespace.v1.NamespaceInfo
	(*v110.NamespaceConfig)(nil),                        // 139: temporal.api.namespace.v1.NamespaceConfig
	(*v111.NamespaceReplicationConfig)(nil),             // 140: temporal.api.replication.v1.NamespaceReplicationConfig
	(*v111.FailoverStatus)(nil),                         // 141: temporal.api.replication.v1.FailoverStatus
	(*v112.HistoryDLQKey)(nil),                          // 142: temporal.server.api.common.v1.HistoryDLQKey
	(*v112.HistoryDLQTask)(nil),                         // 143: temporal.server.api.common.v1.HistoryDLQTask
	(*v112.HistoryDLQTaskMetadata)(nil),                 // 144: temporal.server.api.common.v1.HistoryDLQTaskMetadata
	(v14.DLQOperationType)(0),                           // 145: temporal.server.api.enums.v1.DLQOperationType
	(v14.DLQOperationState)(0),                          // 146: temporal.server.api.enums.v1.DLQOperationState
	(v14.HealthState)(0),                                // 147: temporal.server.api.enums.v1.HealthState
	(*v113.ServiceHealthDetail)(nil),                    // 148: temporal.server.api.health.v1.ServiceHealthDetail
	(*v12.VersionedTransition)(nil),                     // 149: temporal.server.api.persistence.v1.VersionedTransition
	(*v11.VersionHistories)(nil),                        // 150: temporal.server.api.history.v1.VersionHistories
	(*v15.VersionedTransitionArtifact)(nil),             // 151: temporal.server.api.replication.v1.VersionedTransitionArtifact
	(*v114.TaskQueuePartition)(nil),                     // 152: temporal.server.api.taskqueue.v1.TaskQueuePartition
	(*v115.TaskQueueVersionSelection)(nil),              // 153: temporal.api.taskqueue.v1.TaskQueueVersionSelection
	(*v114.PartitionScaleInfo)(nil),                     // 154: temporal.server.api.taskqueue.v1.PartitionScaleInfo
	(*v12.TaskQueueTypeUserData)(nil),                   // 155: temporal.server.api.persistence.v1.TaskQueueTypeUserData
...
var file_temporal_server_api_adminservice_v1_request_response_proto_depIdxs = []int32{
	113, // 0: temporal.server.api.adminservice.v1.RebuildMutableStateRequest.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	113, // 1: temporal.server.api.adminservice.v1.ImportWorkflowExecutionRequest.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	114, // 2: temporal.server.api.adminservice.v1.ImportWorkflowExecutionRequest.history_batches:type_name -> temporal.api.common.v1.DataBlob
	115, // 3: temporal.server.api.adminservice.v1.ImportWorkflowExecutionRequest.version_history:type_name -> temporal.server.api.history.v1.VersionHistory
	113, // 4: temporal.server.api.adminservice.v1.DescribeMutableStateRequest.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	116, // 5: temporal.server.api.adminservice.v1.DescribeMutableStateResponse.cache_mutable_state:type_name -> temporal.server.api.persistence.v1.WorkflowMutableState
	116, // 6: temporal.server.api.adminservice.v1.DescribeMutableStateResponse.database_mutable_state:type_name -> temporal.server.api.persistence.v1.WorkflowMutableState
	113, // 7: temporal.server.api.adminservice.v1.DescribeHistoryHostRequest.workflow_execution:type_name -> temporal.api.common.v1.WorkflowExecution
	117, // 8: temporal.server.api.adminservice.v1.DescribeHistoryHostResponse.namespace_cache:type_name -> temporal.server.api.namespace.v1.NamespaceCacheInfo
	118, // 9: temporal.server.api.adminservice.v1.GetShardResponse.shard_info:type_name -> temporal.server.api.persistence.v1.ShardInfo
	119, // 10: temporal.server.api.adminservice.v1.ListHistoryTasksRequest.task_range:type_name -> temporal.server.api.history.v1.TaskRange
	...
	120, // 12: temporal.server.api.adminservice.v1.Task.task_type:type_name -> temporal.server.api.enums.v1.TaskType
	121, // 13: temporal.server.api.adminservice.v1.Task.fire_time:type_name -> google.protobuf.Timestamp
	121, // 14: temporal.server.api.adminservice.v1.RemoveTaskRequest.visibility_time:type_name -> google.protobuf.Timestamp
	113, // 15: temporal.server.api.adminservice.v1.GetWorkflowExecutionRawHistoryV2Request.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	114, // 16: temporal.server.api.adminservice.v1.GetWorkflowExecutionRawHistoryV2Response.history_batches:type_name -> temporal.api.common.v1.DataBlob
	115, // 17: temporal.server.api.adminservice.v1.GetWorkflowExecutionRawHistoryV2Response.version_history:type_name -> temporal.server.api.history.v1.VersionHistory
	113, // 18: temporal.server.api.adminservice.v1.GetWorkflowExecutionRawHistoryRequest.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	114, // 19: temporal.server.api.adminservice.v1.GetWorkflowExecutionRawHistoryResponse.history_batches:type_name -> temporal.api.common.v1.DataBlob
	115, // 20: temporal.server.api.adminservice.v1.GetWorkflowExecutionRawHistoryResponse.version_history:type_name -> temporal.server.api.history.v1.VersionHistory
	122, // 21: temporal.server.api.adminservice.v1.GetReplicationMessagesRequest.tokens:type_name -> temporal.server.api.replication.v1.ReplicationToken
	103, // 22: temporal.server.api.adminservice.v1.GetReplicationMessagesResponse.shard_messages:type_name -> temporal.server.api.adminservice.v1.GetReplicationMessagesResponse.ShardMessagesEntry
	123, // 23: temporal.server.api.adminservice.v1.GetNamespaceReplicationMessagesResponse.messages:type_name -> temporal.server.api.replication.v1.ReplicationMessages
	124, // 24: temporal.server.api.adminservice.v1.GetDLQReplicationMessagesRequest.task_infos:type_name -> temporal.server.api.replication.v1.ReplicationTaskInfo
	125, // 25: temporal.server.api.adminservice.v1.GetDLQReplicationMessagesResponse.replication_tasks:type_name -> temporal.server.api.replication.v1.ReplicationTask
	113, // 26: temporal.server.api.adminservice.v1.ReapplyEventsRequest.workflow_execution:type_name -> temporal.api.common.v1.WorkflowExecution
	114, // 27: temporal.server.api.adminservice.v1.ReapplyEventsRequest.events:type_name -> temporal.api.common.v1.DataBlob
	104, // 28: temporal.server.api.adminservice.v1.AddSearchAttributesRequest.search_attributes:type_name -> temporal.server.api.adminservice.v1.AddSearchAttributesRequest.SearchAttributesEntry
	105, // 29: temporal.server.api.adminservice.v1.GetSearchAttributesResponse.custom_attributes:type_name -> temporal.server.api.adminservice.v1.GetSearchAttributesResponse.CustomAttributesEntry
	106, // 30: temporal.server.api.adminservice.v1.GetSearchAttributesResponse.system_attributes:type_name -> temporal.server.api.adminservice.v1.GetSearchAttributesResponse.SystemAttributesEntry
	107, // 31: temporal.server.api.adminservice.v1.GetSearchAttributesResponse.mapping:type_name -> temporal.server.api.adminservice.v1.GetSearchAttributesResponse.MappingEntry
	126, // 32: temporal.server.api.adminservice.v1.GetSearchAttributesResponse.add_workflow_execution_info:type_name -> temporal.api.workflow.v1.WorkflowExecutionInfo
	108, // 33: temporal.server.api.adminservice.v1.DescribeClusterResponse.supported_clients:type_name -> temporal.server.api.adminservice.v1.DescribeClusterResponse.SupportedClientsEntry
	127, // 34: temporal.server.api.adminservice.v1.DescribeClusterResponse.membership_info:type_name -> temporal.server.api.cluster.v1.MembershipInfo
	128, // 35: temporal.server.api.adminservice.v1.DescribeClusterResponse.version_info:type_name -> temporal.api.version.v1.VersionInfo
	109, // 36: temporal.server.api.adminservice.v1.DescribeClusterResponse.tags:type_name -> temporal.server.api.adminservice.v1.DescribeClusterResponse.TagsEntry
	129, // 37: temporal.server.api.adminservice.v1.ListClustersResponse.clusters:type_name -> temporal.server.api.persistence.v1.ClusterMetadata
	130, // 38: temporal.server.api.adminservice.v1.ListClusterMembersRequest.last_heartbeat_within:type_name -> google.protobuf.Duration
	131, // 39: temporal.server.api.adminservice.v1.ListClusterMembersRequest.role:type_name -> temporal.server.api.enums.v1.ClusterMemberRole
	121, // 40: temporal.server.api.adminservice.v1.ListClusterMembersRequest.session_started_after_time:type_name -> google.protobuf.Timestamp
	132, // 41: temporal.server.api.adminservice.v1.ListClusterMembersResponse.active_members:type_name -> temporal.server.api.cluster.v1.ClusterMember
	133, // 42: temporal.server.api.adminservice.v1.GetDLQMessagesRequest.type:type_name -> temporal.server.api.enums.v1.DeadLetterQueueType
	133, // 43: temporal.server.api.adminservice.v1.GetDLQMessagesResponse.type:type_name -> temporal.server.api.enums.v1.DeadLetterQueueType
	125, // 44: temporal.server.api.adminservice.v1.GetDLQMessagesResponse.replication_tasks:type_name -> temporal.server.api.replication.v1.ReplicationTask
	124, // 45: temporal.server.api.adminservice.v1.GetDLQMessagesResponse.replication_tasks_info:type_name -> temporal.server.api.replication.v1.ReplicationTaskInfo
	133, // 46: temporal.server.api.adminservice.v1.PurgeDLQMessagesRequest.type:type_name -> temporal.server.api.enums.v1.DeadLetterQueueType
	133, // 47: temporal.server.api.adminservice.v1.MergeDLQMessagesRequest.type:type_name -> temporal.server.api.enums.v1.DeadLetterQueueType
	113, // 48: temporal.server.api.adminservice.v1.RefreshWorkflowTasksRequest.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	134, // 49: temporal.server.api.adminservice.v1.GetTaskQueueTasksRequest.task_queue_type:type_name -> temporal.api.enums.v1.TaskQueueType
	135, // 50: temporal.server.api.adminservice.v1.GetTaskQueueTasksResponse.tasks:type_name -> temporal.server.api.persistence.v1.AllocatedTaskInfo
	113, // 51: temporal.server.api.adminservice.v1.DeleteWorkflowExecutionRequest.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	136, // 52: temporal.server.api.adminservice.v1.StreamWorkflowReplicationMessagesRequest.sync_replication_state:type_name -> temporal.server.api.replication.v1.SyncReplicationState
	137, // 53: temporal.server.api.adminservice.v1.StreamWorkflowReplicationMessagesResponse.messages:type_name -> temporal.server.api.replication.v1.WorkflowReplicationMessages
	138, // 54: temporal.server.api.adminservice.v1.GetNamespaceResponse.info:type_name -> temporal.api.namespace.v1.NamespaceInfo
	139, // 55: temporal.server.api.adminservice.v1.GetNamespaceResponse.config:type_name -> temporal.api.namespace.v1.NamespaceConfig
	140, // 56: temporal.server.api.adminservice.v1.GetNamespaceResponse.replication_config:type_name -> temporal.api.replication.v1.NamespaceReplicationConfig
	141, // 57: temporal.server.api.adminservice.v1.GetNamespaceResponse.failover_history:type_name -> temporal.api.replication.v1.FailoverStatus
	142, // 58: temporal.server.api.adminservice.v1.GetDLQTasksRequest.dlq_key:type_name -> temporal.server.api.common.v1.HistoryDLQKey
	143, // 59: temporal.server.api.adminservice.v1.GetDLQTasksResponse.dlq_tasks:type_name -> temporal.server.api.common.v1.HistoryDLQTask
	142, // 60: temporal.server.api.adminservice.v1.PurgeDLQTasksRequest.dlq_key:type_name -> temporal.server.api.common.v1.HistoryDLQKey
	144, // 61: temporal.server.api.adminservice.v1.PurgeDLQTasksRequest.inclusive_max_task_metadata:type_name -> temporal.server.api.common.v1.HistoryDLQTaskMetadata
	142, // 62: temporal.server.api.adminservice.v1.MergeDLQTasksRequest.dlq_key:type_name -> temporal.server.api.common.v1.HistoryDLQKey
	144, // 63: temporal.server.api.adminservice.v1.MergeDLQTasksRequest.inclusive_max_task_metadata:type_name -> temporal.server.api.common.v1.HistoryDLQTaskMetadata
	142, // 64: temporal.server.api.adminservice.v1.DescribeDLQJobResponse.dlq_key:type_name -> temporal.server.api.common.v1.HistoryDLQKey
	145, // 65: temporal.server.api.adminservice.v1.DescribeDLQJobResponse.operation_type:type_name -> temporal.server.api.enums.v1.DLQOperationType
	146, // 66: temporal.server.api.adminservice.v1.DescribeDLQJobResponse.operation_state:type_name -> temporal.server.api.enums.v1.DLQOperationState
	121, // 67: temporal.server.api.adminservice.v1.DescribeDLQJobResponse.start_time:type_name -> google.protobuf.Timestamp
	121, // 68: temporal.server.api.adminservice.v1.DescribeDLQJobResponse.end_time:type_name -> google.protobuf.Timestamp
	110, // 69: temporal.server.api.adminservice.v1.AddTasksRequest.tasks:type_name -> temporal.server.api.adminservice.v1.AddTasksRequest.Task
	111, // 70: temporal.server.api.adminservice.v1.ListQueuesResponse.queues:type_name -> temporal.server.api.adminservice.v1.ListQueuesResponse.QueueInfo
	147, // 71: temporal.server.api.adminservice.v1.DeepHealthCheckResponse.state:type_name -> temporal.server.api.enums.v1.HealthState
	148, // 72: temporal.server.api.adminservice.v1.DeepHealthCheckResponse.services:type_name -> temporal.server.api.health.v1.ServiceHealthDetail
	113, // 73: temporal.server.api.adminservice.v1.SyncWorkflowStateRequest.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	149, // 74: temporal.server.api.adminservice.v1.SyncWorkflowStateRequest.versioned_transition:type_name -> temporal.server.api.persistence.v1.VersionedTransition
	150, // 75: temporal.server.api.adminservice.v1.SyncWorkflowStateRequest.version_histories:type_name -> temporal.server.api.history.v1.VersionHistories
	151, // 76: temporal.server.api.adminservice.v1.SyncWorkflowStateResponse.versioned_transition_artifact:type_name -> temporal.server.api.replication.v1.VersionedTransitionArtifact
	113, // 77: temporal.server.api.adminservice.v1.GenerateLastHistoryReplicationTasksRequest.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	152, // 78: temporal.server.api.adminservice.v1.DescribeTaskQueuePartitionRequest.task_queue_partition:type_name -> temporal.server.api.taskqueue.v1.TaskQueuePartition
	153, // 79: temporal.server.api.adminservice.v1.DescribeTaskQueuePartitionRequest.build_ids:type_name -> temporal.api.taskqueue.v1.TaskQueueVersionSelection
	112, // 80: temporal.server.api.adminservice.v1.DescribeTaskQueuePartitionResponse.versions_info_internal:type_name -> temporal.server.api.adminservice.v1.DescribeTaskQueuePartitionResponse.VersionsInfoInternalEntry
	154, // 81: temporal.server.api.adminservice.v1.DescribeTaskQueuePartitionResponse.scale_info:type_name -> temporal.server.api.taskqueue.v1.PartitionScaleInfo
	152, // 82: temporal.server.api.adminservice.v1.ForceUnloadTaskQueuePartitionRequest.task_queue_partition:type_name -> temporal.server.api.taskqueue.v1.TaskQueuePartition
	134, // 83: temporal.server.api.adminservice.v1.GetTaskQueueUserDataRequest.task_queue_type:type_name -> temporal.api.enums.v1.TaskQueueType
	155, // 84: temporal.server.api.adminservice.v1.GetTaskQueueUserDataResponse.user_data:type_name -> temporal.server.api.persistence.v1.TaskQueueTypeUserData
	94,  // 85: temporal.server.api.adminservice.v1.DescribeDynamicConfigSettingResponse.constraint_precedence:type_name -> temporal.server.api.adminservice.v1.DynamicConfigConstraintFields
	113, // 86: temporal.server.api.adminservice.v1.StartAdminBatchOperationRequest.executions:type_name -> temporal.api.common.v1.WorkflowExecution
	100, // 87: temporal.server.api.adminservice.v1.StartAdminBatchOperationRequest.refresh_tasks_operation:type_name -> temporal.server.api.adminservice.v1.BatchOperationRefreshTasks
	...
	123, // 89: temporal.server.api.adminservice.v1.GetReplicationMessagesResponse.ShardMessagesEntry.value:type_name -> temporal.server.api.replication.v1.ReplicationMessages
	156, // 90: temporal.server.api.adminservice.v1.AddSearchAttributesRequest.SearchAttributesEntry.value:type_name -> temporal.api.enums.v1.IndexedValueType
	156, // 91: temporal.server.api.adminservice.v1.GetSearchAttributesResponse.CustomAttributesEntry.value:type_name -> temporal.api.enums.v1.IndexedValueType
	156, // 92: temporal.server.api.adminservice.v1.GetSearchAttributesResponse.SystemAttributesEntry.value:type_name -> temporal.api.enums.v1.IndexedValueType
	114, // 93: temporal.server.api.adminservice.v1.AddTasksRequest.Task.blob:type_name -> temporal.api.common.v1.DataBlob
	157, // 94: temporal.server.api.adminservice.v1.DescribeTaskQueuePartitionResponse.VersionsInfoInternalEntry.value:type_name -> temporal.server.api.taskqueue.v1.TaskQueueVersionInfoInternal
...
func file_temporal_server_api_adminservice_v1_request_response_proto_init() {
	...
	file_temporal_server_api_adminservice_v1_request_response_proto_msgTypes[97].OneofWrappers = []any{
