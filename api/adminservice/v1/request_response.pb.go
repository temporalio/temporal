...
func (x *DisableTimeSkippingRequest) GetNamespace() string {
	if x != nil {
		return x.Namespace
	}
	return ""
...
func (x *DisableTimeSkippingRequest) GetExecution() *v1.WorkflowExecution {
	if x != nil {
		return x.Execution
	}
	return nil
...
func (x *DisableTimeSkippingRequest) GetArchetype() string {
	if x != nil {
		return x.Archetype
	}
	return ""
...
const file_temporal_server_api_adminservice_v1_request_response_proto_rawDesc = "" +
	...
	"\x17MigrateScheduleResponse\"\xc4\x01\n" +
	"\x1aDisableTimeSkippingRequest\x12\x1c\n" +
	"\tnamespace\x18\x01 \x01(\tR\tnamespace\x12G\n" +
	"\texecution\x18\x02 \x01(\v2).temporal.api.common.v1.WorkflowExecutionR\texecution\x12\x1c\n" +
	"\tarchetype\x18\x03 \x01(\tR\tarchetype\x12!\n" +
	"\farchetype_id\x18\x04 \x01(\rR\varchetypeId\"9\n" +
	"\x1bDisableTimeSkippingResponse\x12\x1a\n" +
	"\bdisabled\x18\x01 \x01(\bR\bdisabledB8Z6go.temporal.io/server/api/adminservice/v1;adminserviceb\x06proto3"
...
var file_temporal_server_api_adminservice_v1_request_response_proto_goTypes = []any{
	...
	(*DisableTimeSkippingRequest)(nil),                  // 96: temporal.server.api.adminservice.v1.DisableTimeSkippingRequest
	(*DisableTimeSkippingResponse)(nil),                 // 97: temporal.server.api.adminservice.v1.DisableTimeSkippingResponse
...
var file_temporal_server_api_adminservice_v1_request_response_proto_depIdxs = []int32{
	...
	142, // 73: temporal.server.api.adminservice.v1.DeepHealthCheckResponse.unenforced_state:type_name -> temporal.server.api.enums.v1.HealthState
	108, // 74: temporal.server.api.adminservice.v1.SyncWorkflowStateRequest.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	144, // 75: temporal.server.api.adminservice.v1.SyncWorkflowStateRequest.versioned_transition:type_name -> temporal.server.api.persistence.v1.VersionedTransition
	145, // 76: temporal.server.api.adminservice.v1.SyncWorkflowStateRequest.version_histories:type_name -> temporal.server.api.history.v1.VersionHistories
	146, // 77: temporal.server.api.adminservice.v1.SyncWorkflowStateResponse.versioned_transition_artifact:type_name -> temporal.server.api.replication.v1.VersionedTransitionArtifact
	108, // 78: temporal.server.api.adminservice.v1.GenerateLastHistoryReplicationTasksRequest.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	147, // 79: temporal.server.api.adminservice.v1.DescribeTaskQueuePartitionRequest.task_queue_partition:type_name -> temporal.server.api.taskqueue.v1.TaskQueuePartition
	148, // 80: temporal.server.api.adminservice.v1.DescribeTaskQueuePartitionRequest.build_ids:type_name -> temporal.api.taskqueue.v1.TaskQueueVersionSelection
	107, // 81: temporal.server.api.adminservice.v1.DescribeTaskQueuePartitionResponse.versions_info_internal:type_name -> temporal.server.api.adminservice.v1.DescribeTaskQueuePartitionResponse.VersionsInfoInternalEntry
	149, // 82: temporal.server.api.adminservice.v1.DescribeTaskQueuePartitionResponse.scale_info:type_name -> temporal.server.api.taskqueue.v1.PartitionScaleInfo
	...
	108, // 89: temporal.server.api.adminservice.v1.DisableTimeSkippingRequest.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	118, // 90: temporal.server.api.adminservice.v1.GetReplicationMessagesResponse.ShardMessagesEntry.value:type_name -> temporal.server.api.replication.v1.ReplicationMessages
	...
	109, // 94: temporal.server.api.adminservice.v1.AddTasksRequest.Task.blob:type_name -> temporal.api.common.v1.DataBlob
