...
const file_temporal_server_api_adminservice_v1_request_response_proto_rawDesc = "" +
	...
	"\x05value\x18\x01 \x01(\fR\x05value\"\x88\x03\n" +
...
var file_temporal_server_api_adminservice_v1_request_response_proto_depIdxs = []int32{
	...
	129, // 85: temporal.server.api.adminservice.v1.GetDynamicConfigValueRequest.task_queue_type:type_name -> temporal.api.enums.v1.TaskQueueType
	115, // 86: temporal.server.api.adminservice.v1.GetDynamicConfigValueRequest.task_type:type_name -> temporal.server.api.enums.v1.TaskType
	108, // 87: temporal.server.api.adminservice.v1.StartAdminBatchOperationRequest.executions:type_name -> temporal.api.common.v1.WorkflowExecution
	95,  // 88: temporal.server.api.adminservice.v1.StartAdminBatchOperationRequest.refresh_tasks_operation:type_name -> temporal.server.api.adminservice.v1.BatchOperationRefreshTasks
