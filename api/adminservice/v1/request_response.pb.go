...
const file_temporal_server_api_adminservice_v1_request_response_proto_rawDesc = "" +
	...
	"\x15lease_expiration_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\x13leaseExpirationTimeB8Z6go.temporal.io/server/api/adminservice/v1;adminserviceb\x06proto3"
...
var file_temporal_server_api_adminservice_v1_request_response_proto_goTypes = []any{
	...
	(*SyncLocalExecutionRequest)(nil),                   // 96: temporal.server.api.adminservice.v1.SyncLocalExecutionRequest
	(*SyncLocalExecutionResponse)(nil),                  // 97: temporal.server.api.adminservice.v1.SyncLocalExecutionResponse
...
var file_temporal_server_api_adminservice_v1_request_response_proto_depIdxs = []int32{
	...
	108, // 88: temporal.server.api.adminservice.v1.SyncLocalExecutionRequest.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	109, // 89: temporal.server.api.adminservice.v1.SyncLocalExecutionRequest.history_batches:type_name -> temporal.api.common.v1.DataBlob
	110, // 90: temporal.server.api.adminservice.v1.SyncLocalExecutionRequest.version_history:type_name -> temporal.server.api.history.v1.VersionHistory
	116, // 91: temporal.server.api.adminservice.v1.SyncLocalExecutionResponse.lease_expiration_time:type_name -> google.protobuf.Timestamp
	...
	151, // 93: temporal.server.api.adminservice.v1.AddSearchAttributesRequest.SearchAttributesEntry.value:type_name -> temporal.api.enums.v1.IndexedValueType
	151, // 94: temporal.server.api.adminservice.v1.GetSearchAttributesResponse.CustomAttributesEntry.value:type_name -> temporal.api.enums.v1.IndexedValueType
	151, // 95: temporal.server.api.adminservice.v1.GetSearchAttributesResponse.SystemAttributesEntry.value:type_name -> temporal.api.enums.v1.IndexedValueType
	109, // 96: temporal.server.api.adminservice.v1.AddTasksRequest.Task.blob:type_name -> temporal.api.common.v1.DataBlob
	152, // 97: temporal.server.api.adminservice.v1.DescribeTaskQueuePartitionResponse.VersionsInfoInternalEntry.value:type_name -> temporal.server.api.taskqueue.v1.TaskQueueVersionInfoInternal
