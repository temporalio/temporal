...
const file_temporal_server_api_adminservice_v1_service_proto_rawDesc = "" +
	"\n" +
	"1temporal/server/api/adminservice/v1/service.proto\x12#temporal.server.api.adminservice.v1\x1a:temporal/server/api/adminservice/v1/request_response.proto\x1a0temporal/server/api/common/v1/api_category.proto2\x8b=\n" +
	...
	"\x15GetDynamicConfigValue\x12A.temporal.server.api.adminservice.v1.GetDynamicConfigValueRequest\x1aB.temporal.server.api.adminservice.v1.GetDynamicConfigValueResponse\"\x06\x8a\xb5\x18\x02\b\x03\x12\xac\x01\n" +
...
var file_temporal_server_api_adminservice_v1_service_proto_goTypes = []any{
	...
	(*DumpDynamicConfigValuesRequest)(nil),              // 46: temporal.server.api.adminservice.v1.DumpDynamicConfigValuesRequest
	...
	(*GetDynamicConfigValueResponse)(nil),               // 93: temporal.server.api.adminservice.v1.GetDynamicConfigValueResponse
...
var file_temporal_server_api_adminservice_v1_service_proto_depIdxs = []int32{
	...
	46, // 46: temporal.server.api.adminservice.v1.AdminService.DumpDynamicConfigValues:input_type -> temporal.server.api.adminservice.v1.DumpDynamicConfigValuesRequest
	...
	93, // 93: temporal.server.api.adminservice.v1.AdminService.GetDynamicConfigValue:output_type -> temporal.server.api.adminservice.v1.GetDynamicConfigValueResponse
	94, // 94: temporal.server.api.adminservice.v1.AdminService.DumpDynamicConfigValues:output_type -> temporal.server.api.adminservice.v1.DumpDynamicConfigValuesResponse
