...
const file_temporal_server_api_adminservice_v1_service_proto_rawDesc = "" +
	...
	"\x10GetDynamicConfig\x12<.temporal.server.api.adminservice.v1.GetDynamicConfigRequest\x1a=.temporal.server.api.adminservice.v1.GetDynamicConfigResponse\"\x00B8Z6go.temporal.io/server/api/adminservice/v1;adminserviceb\x06proto3"
...
var file_temporal_server_api_adminservice_v1_service_proto_goTypes = []any{
	...
	(*GetDynamicConfigRequest)(nil),                     // 43: temporal.server.api.adminservice.v1.GetDynamicConfigRequest
	...
	(*GetDynamicConfigResponse)(nil),                    // 87: temporal.server.api.adminservice.v1.GetDynamicConfigResponse
}
var file_temporal_server_api_adminservice_v1_service_proto_depIdxs = []int32{
	...
	43, // 43: temporal.server.api.adminservice.v1.AdminService.GetDynamicConfig:input_type -> temporal.server.api.adminservice.v1.GetDynamicConfigRequest
	...
	87, // 87: temporal.server.api.adminservice.v1.AdminService.GetDynamicConfig:output_type -> temporal.server.api.adminservice.v1.GetDynamicConfigResponse
