...
const file_temporal_server_api_adminservice_v1_service_proto_rawDesc = "" +
	"\n" +
	"1temporal/server/api/adminservice/v1/service.proto\x12#temporal.server.api.adminservice.v1\x1a:temporal/server/api/adminservice/v1/request_response.proto\x1a0temporal/server/api/common/v1/api_category.proto2\xe2;\n" +
...
var file_temporal_server_api_adminservice_v1_service_proto_goTypes = []any{
	...
	(*DumpDynamicConfigValuesRequest)(nil),              // 45: temporal.server.api.adminservice.v1.DumpDynamicConfigValuesRequest
	...
	(*DumpDynamicConfigValuesResponse)(nil),             // 92: temporal.server.api.adminservice.v1.DumpDynamicConfigValuesResponse
...
var file_temporal_server_api_adminservice_v1_service_proto_depIdxs = []int32{
	...
	45, // 45: temporal.server.api.adminservice.v1.AdminService.DumpDynamicConfigValues:input_type -> temporal.server.api.adminservice.v1.DumpDynamicConfigValuesRequest
	...
	92, // 92: temporal.server.api.adminservice.v1.AdminService.DumpDynamicConfigValues:output_type -> temporal.server.api.adminservice.v1.DumpDynamicConfigValuesResponse
