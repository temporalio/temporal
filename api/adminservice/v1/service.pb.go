...
const file_temporal_server_api_adminservice_v1_service_proto_rawDesc = "" +
	...
	"\x14GetTaskQueueUserData\x12@.temporal.server.api.adminservice.v1.GetTaskQueueUserDataRequest\x1aA.temporal.server.api.adminservice.v1.GetTaskQueueUserDataResponse\"\x06\x8a\xb5\x18\x02\b\x03\x12\xa0\x01\n" +
	"\x13UpdateFairnessState\x12?.temporal.server.api.adminservice.v1.UpdateFairnessStateRequest\x1a@.temporal.server.api.adminservice.v1.UpdateFairnessStateResponse\"\x06\x8a\xb5\x18\x02\b\x03\x12\x94\x01\n" +
...
var file_temporal_server_api_adminservice_v1_service_proto_goTypes = []any{
	...
	(*UpdateFairnessStateRequest)(nil),                  // 45: temporal.server.api.adminservice.v1.UpdateFairnessStateRequest
	...
	(*UpdateFairnessStateResponse)(nil),                 // 92: temporal.server.api.adminservice.v1.UpdateFairnessStateResponse
...
var file_temporal_server_api_adminservice_v1_service_proto_depIdxs = []int32{
	...
	45, // 45: temporal.server.api.adminservice.v1.AdminService.UpdateFairnessState:input_type -> temporal.server.api.adminservice.v1.UpdateFairnessStateRequest
	...
	92, // 92: temporal.server.api.adminservice.v1.AdminService.UpdateFairnessState:output_type -> temporal.server.api.adminservice.v1.UpdateFairnessStateResponse
