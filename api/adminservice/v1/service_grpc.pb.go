...
const (
	...
	AdminService_DescribeDynamicConfigSetting_FullMethodName        = "/temporal.server.api.adminservice.v1.AdminService/DescribeDynamicConfigSetting"
...
type AdminServiceClient interface {
	...
	// GetDynamicConfigValue returns the effective dynamic config value for a key and constraints.
	...
	// DescribeDynamicConfigSetting returns constraint metadata for a registered dynamic config setting.
	DescribeDynamicConfigSetting(ctx context.Context, in *DescribeDynamicConfigSettingRequest, opts ...grpc.CallOption) (*DescribeDynamicConfigSettingResponse, error)
...
func (c *adminServiceClient) GetDynamicConfigValue(ctx context.Context, in *GetDynamicConfigValueRequest, opts ...grpc.CallOption) (*GetDynamicConfigValueResponse, error) {
	out := new(GetDynamicConfigValueResponse)
	err := c.cc.Invoke(ctx, AdminService_GetDynamicConfigValue_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminServiceClient) DescribeDynamicConfigSetting(ctx context.Context, in *DescribeDynamicConfigSettingRequest, opts ...grpc.CallOption) (*DescribeDynamicConfigSettingResponse, error) {
	out := new(DescribeDynamicConfigSettingResponse)
	err := c.cc.Invoke(ctx, AdminService_DescribeDynamicConfigSetting_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AdminServiceServer interface {
	...
	// DescribeDynamicConfigSetting returns constraint metadata for a registered dynamic config setting.
	DescribeDynamicConfigSetting(context.Context, *DescribeDynamicConfigSettingRequest) (*DescribeDynamicConfigSettingResponse, error)
	// DumpDynamicConfigValues returns all constrained values held by the dynamic config client.
...
func (UnimplementedAdminServiceServer) DescribeDynamicConfigSetting(context.Context, *DescribeDynamicConfigSettingRequest) (*DescribeDynamicConfigSettingResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DescribeDynamicConfigSetting not implemented")
}
...
func _AdminService_GetDynamicConfigValue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetDynamicConfigValueRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServiceServer).GetDynamicConfigValue(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdminService_GetDynamicConfigValue_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServiceServer).GetDynamicConfigValue(ctx, req.(*GetDynamicConfigValueRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AdminService_DescribeDynamicConfigSetting_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DescribeDynamicConfigSettingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServiceServer).DescribeDynamicConfigSetting(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdminService_DescribeDynamicConfigSetting_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServiceServer).DescribeDynamicConfigSetting(ctx, req.(*DescribeDynamicConfigSettingRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AdminService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DescribeDynamicConfigSetting",
			Handler:    _AdminService_DescribeDynamicConfigSetting_Handler,
		},
		{
