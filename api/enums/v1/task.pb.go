...
const (
	...
	// A task to notify a worker to cancel a running activity.
	TASK_TYPE_TRANSFER_ACTIVITY_CANCEL_CONTROL TaskType = 34
)
...
var (
	TaskType_name = map[int32]string{
		...
		33: "TASK_TYPE_CHASM",
		34: "TASK_TYPE_TRANSFER_ACTIVITY_CANCEL_CONTROL",
	}
	TaskType_value = map[string]int32{
		...
		"TASK_TYPE_CHASM":                                 33,
		"TASK_TYPE_TRANSFER_ACTIVITY_CANCEL_CONTROL":      34,
	}
)
...
func (x TaskType) String() string {
	...
	case TASK_TYPE_CHASM:
		return "Chasm"
	case TASK_TYPE_TRANSFER_ACTIVITY_CANCEL_CONTROL:
		return "TransferActivityCancelControl"
	default:
		return strconv.Itoa(int(x))
	}
...
const file_temporal_server_api_enums_v1_task_proto_rawDesc = "" +
	...
	"\x16TASK_SOURCE_DB_BACKLOG\x10\x02*\xe6\t\n" +
	"\bTaskType\x12\x19\n" +
	...
	"*TASK_TYPE_TRANSFER_ACTIVITY_CANCEL_CONTROL\x10\"\"\x04\b\t\x10\t\"\x04\b\v\x10\v\"\x04\b\x17\x10\x17*\\\n" +
