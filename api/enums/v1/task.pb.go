...
const (
	...
	// A task to apply parent close policy to a child workflow.
	TASK_TYPE_TRANSFER_PARENT_CLOSE_POLICY TaskType = 34
)
...
var (
	TaskType_name = map[int32]string{
		...
		33: "TASK_TYPE_CHASM",
		34: "TASK_TYPE_TRANSFER_PARENT_CLOSE_POLICY",
	}
	TaskType_value = map[string]int32{
		...
		"TASK_TYPE_CHASM":                                 33,
		"TASK_TYPE_TRANSFER_PARENT_CLOSE_POLICY":          34,
	}
)
...
func (x TaskType) String() string {
	...
	case TASK_TYPE_CHASM:
		return "Chasm"
	case TASK_TYPE_TRANSFER_PARENT_CLOSE_POLICY:
		return "TransferParentClosePolicy"
	default:
		return strconv.Itoa(int(x))
	}
...
const file_temporal_server_api_enums_v1_task_proto_rawDesc = "" +
	...
	"&TASK_TYPE_TRANSFER_PARENT_CLOSE_POLICY\x10\"\"\x04\b\t\x10\t\"\x04\b\v\x10\v\"\x04\b\x17\x10\x17*\\\n" +
