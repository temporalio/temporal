...
const (
	...
	TASK_TYPE_TRANSFER_CANCEL_ACTIVITY_NEXUS TaskType = 34
)
...
var (
	TaskType_name = map[int32]string{
		...
		33: "TASK_TYPE_CHASM",
		34: "TASK_TYPE_TRANSFER_CANCEL_ACTIVITY_NEXUS",
	}
...
func (x TaskType) String() string {
	...
	case TASK_TYPE_CHASM:
		return "Chasm"
	case TASK_TYPE_TRANSFER_CANCEL_ACTIVITY_NEXUS:
		return "TransferCancelActivityNexus"
	default:
		return strconv.Itoa(int(x))
	}
