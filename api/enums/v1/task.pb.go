...
const (
	...
	// Workspace transfer tasks for cross-shard workspace lifecycle operations.
	TASK_TYPE_TRANSFER_WORKSPACE_CREATE_AND_ACQUIRE TaskType = 34
	TASK_TYPE_TRANSFER_WORKSPACE_SYNC_AND_RELEASE   TaskType = 35
	TASK_TYPE_TRANSFER_WORKSPACE_FORK               TaskType = 36
)
...
var (
	TaskType_name = map[int32]string{
		...
		33: "TASK_TYPE_CHASM",
		34: "TASK_TYPE_TRANSFER_WORKSPACE_CREATE_AND_ACQUIRE",
		35: "TASK_TYPE_TRANSFER_WORKSPACE_SYNC_AND_RELEASE",
		36: "TASK_TYPE_TRANSFER_WORKSPACE_FORK",
	}
	TaskType_value = map[string]int32{
		...
		"TASK_TYPE_CHASM":                                 33,
		"TASK_TYPE_TRANSFER_WORKSPACE_CREATE_AND_ACQUIRE": 34,
		"TASK_TYPE_TRANSFER_WORKSPACE_SYNC_AND_RELEASE":   35,
		"TASK_TYPE_TRANSFER_WORKSPACE_FORK":               36,
	}
)
...
func (x TaskType) String() string {
	...
	case TASK_TYPE_CHASM:
		return "Chasm"
	case TASK_TYPE_TRANSFER_WORKSPACE_CREATE_AND_ACQUIRE:
		return "TransferWorkspaceCreateAndAcquire"
	case TASK_TYPE_TRANSFER_WORKSPACE_SYNC_AND_RELEASE:
		return "TransferWorkspaceSyncAndRelease"
	case TASK_TYPE_TRANSFER_WORKSPACE_FORK:
		return "TransferWorkspaceFork"
	default:
		return strconv.Itoa(int(x))
	}
...
const file_temporal_server_api_enums_v1_task_proto_rawDesc = "" +
	...
	"\x16TASK_SOURCE_DB_BACKLOG\x10\x02*\xc5\n" +
	"\n" +
	"\bTaskType\x12\x19\n" +
	...
	"\x0fTASK_TYPE_CHASM\x10!\x123\n" +
	"/TASK_TYPE_TRANSFER_WORKSPACE_CREATE_AND_ACQUIRE\x10\"\x121\n" +
	"-TASK_TYPE_TRANSFER_WORKSPACE_SYNC_AND_RELEASE\x10#\x12%\n" +
	"!TASK_TYPE_TRANSFER_WORKSPACE_FORK\x10$\"\x04\b\t\x10\t\"\x04\b\v\x10\v\"\x04\b\x17\x10\x17*\\\n" +
