...
const (
	...
	// A task to notify activities via Nexus. Also see ActivityNotificationType.
	TASK_TYPE_NOTIFY_ACTIVITY TaskType = 34
)
...
func (x TaskType) String() string {
	...
	case TASK_TYPE_CHASM:
		return "Chasm"
	case TASK_TYPE_NOTIFY_ACTIVITY:
...
const file_temporal_server_api_enums_v1_task_proto_rawDesc = "" +
	...
	"\x19TASK_TYPE_NOTIFY_ACTIVITY\x10\"\"\x04\b\t\x10\t\"\x04\b\v\x10\v\"\x04\b\x17\x10\x17*m\n" +
	"\x18ActivityNotificationType\x12*\n" +
	"&ACTIVITY_NOTIFICATION_TYPE_UNSPECIFIED\x10\x00\x12%\n" +
	"!ACTIVITY_NOTIFICATION_TYPE_CANCEL\x10\x01*\\\n" +
...
var file_temporal_server_api_enums_v1_task_proto_goTypes = []any{
	...
	(ActivityNotificationType)(0), // 2: temporal.server.api.enums.v1.ActivityNotificationType
