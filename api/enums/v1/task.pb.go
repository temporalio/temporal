...
const file_temporal_server_api_enums_v1_task_proto_rawDesc = "" +
	...
	"\x16TASK_SOURCE_DB_BACKLOG\x10\x02*\xa5\n" +
	"\n" +
	"\bTaskType\x12\x19\n" +
	...
	"\x19TASK_TYPE_WORKER_COMMANDS\x10#\"\x04\b\t\x10\t\"\x04\b\v\x10\v\"\x04\b\x17\x10\x17\"\x04\b$\x10$*\x1cTASK_TYPE_TIMESKIPPING_TIMER*\\\n" +
