...
const (
	...
	// A task to send commands to activities via Nexus. Also see ActivityCommandType.
	TASK_TYPE_ACTIVITY_COMMAND TaskType = 34
)
...
func (x TaskType) String() string {
	...
	case TASK_TYPE_TRANSFER_RESET_WORKFLOW:
		...
		// ActivityCommandType specifies the type of command to send to activities.
	...
	case TASK_TYPE_WORKFLOW_RUN_TIMEOUT:
		...
		// Enum value maps for ActivityCommandType.
	...
	case TASK_TYPE_REPLICATION_SYNC_HSM:
		...
		// Deprecated: Use ActivityCommandType.Descriptor instead.
	...
	case TASK_TYPE_ACTIVITY_COMMAND:
...
type ActivityCommandType int32

const (
	ACTIVITY_COMMAND_TYPE_UNSPECIFIED ActivityCommandType = 0
	ACTIVITY_COMMAND_TYPE_CANCEL      ActivityCommandType = 1
)

var (
	ActivityCommandType_name = map[int32]string{
		0: "ACTIVITY_COMMAND_TYPE_UNSPECIFIED",
		1: "ACTIVITY_COMMAND_TYPE_CANCEL",
	}
	ActivityCommandType_value = map[string]int32{
		"ACTIVITY_COMMAND_TYPE_UNSPECIFIED": 0,
		"ACTIVITY_COMMAND_TYPE_CANCEL":      1,
	}
)

func (x ActivityCommandType) Enum() *ActivityCommandType {
	p := new(ActivityCommandType)
	*p = x
	return p
}

func (x ActivityCommandType) String() string {
	switch x {
	case ACTIVITY_COMMAND_TYPE_UNSPECIFIED:
		return "Unspecified"
	case ACTIVITY_COMMAND_TYPE_CANCEL:
		return "Cancel"
	default:
		return strconv.Itoa(int(x))
	}
...
func (ActivityCommandType) Descriptor() protoreflect.EnumDescriptor {
	return file_temporal_server_api_enums_v1_task_proto_enumTypes[2].Descriptor()
}

func (ActivityCommandType) Type() protoreflect.EnumType {
	return &file_temporal_server_api_enums_v1_task_proto_enumTypes[2]
}

func (x ActivityCommandType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

func (ActivityCommandType) EnumDescriptor() ([]byte, []int) {
...
func (TaskPriority) Descriptor() protoreflect.EnumDescriptor {
	return file_temporal_server_api_enums_v1_task_proto_enumTypes[3].Descriptor()
}

func (TaskPriority) Type() protoreflect.EnumType {
	return &file_temporal_server_api_enums_v1_task_proto_enumTypes[3]
}
...
func (TaskPriority) EnumDescriptor() ([]byte, []int) {
	return file_temporal_server_api_enums_v1_task_proto_rawDescGZIP(), []int{3}
}
...
var file_temporal_server_api_enums_v1_task_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_temporal_server_api_enums_v1_task_proto_goTypes = []any{
	...
	(ActivityCommandType)(0), // 2: temporal.server.api.enums.v1.ActivityCommandType
	(TaskPriority)(0),        // 3: temporal.server.api.enums.v1.TaskPriority
}
