...
type DispatchNexusTaskRequest struct {
	...
	// Verified caller identity the frontend attributed to this request, carried
	// with the task so matching can surface it on PollNexusTaskQueueResponse for
	// the handler worker. Server-set and trusted; never sourced from the inbound
	// request. Unset when caller attribution is not configured.
	CallerInfo    *v113.NexusCallerInfo `protobuf:"bytes,5,opt,name=caller_info,json=callerInfo,proto3" json:"caller_info,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *DispatchNexusTaskRequest) GetCallerInfo() *v113.NexusCallerInfo {
	if x != nil {
		return x.CallerInfo
	}
	return nil
...
var file_temporal_server_api_matchingservice_v1_request_response_proto_goTypes = []any{
	...
	(*v113.NexusCallerInfo)(nil),                       // 135: temporal.api.nexus.v1.NexusCallerInfo
...
var file_temporal_server_api_matchingservice_v1_request_response_proto_depIdxs = []int32{
	...
	135, // 109: temporal.server.api.matchingservice.v1.DispatchNexusTaskRequest.caller_info:type_name -> temporal.api.nexus.v1.NexusCallerInfo
