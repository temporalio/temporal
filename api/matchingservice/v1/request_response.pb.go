...
import (
	...
	v15 "github.com/temporalio/temporal/api/enums/v1"
	v13 "github.com/temporalio/temporal/api/history/v1"
	v11 "go.temporal.io/temporal-proto/common/v1"
	v16 "go.temporal.io/temporal-proto/enums/v1"
...
type PollForDecisionTaskRequest struct {
	...
	PollRequest   *v1.PollForDecisionTaskRequest `protobuf:"bytes,3,opt,name=poll_request,json=pollRequest,proto3" json:"poll_request,omitempty"`
...
func (m *PollForDecisionTaskRequest) GetNamespaceId() string {
	if m != nil {
...
func (m *PollForDecisionTaskRequest) GetPollRequest() *v1.PollForDecisionTaskRequest {
	if m != nil {
...
type PollForDecisionTaskResponse struct {
	...
	DecisionInfo               *v13.TransientDecisionInfo    `protobuf:"bytes,11,opt,name=decision_info,json=decisionInfo,proto3" json:"decision_info,omitempty"`
...
func (m *PollForDecisionTaskResponse) GetWorkflowExecution() *v11.WorkflowExecution {
	if m != nil {
...
func (m *PollForDecisionTaskResponse) GetWorkflowType() *v11.WorkflowType {
	if m != nil {
...
func (m *PollForDecisionTaskResponse) GetQuery() *v12.WorkflowQuery {
	if m != nil {
		return m.Query
	}
	return nil
...
func (m *PollForDecisionTaskResponse) GetDecisionInfo() *v13.TransientDecisionInfo {
	if m != nil {
...
func (m *PollForDecisionTaskResponse) GetWorkflowExecutionTaskQueue() *v14.TaskQueue {
	if m != nil {
...
func (m *PollForDecisionTaskResponse) GetQueries() map[string]*v12.WorkflowQuery {
	if m != nil {
		return m.Queries
	}
	return nil
...
type PollForActivityTaskRequest struct {
	NamespaceId   string                         `protobuf:"bytes,1,opt,name=namespace_id,json=namespaceId,proto3" json:"namespace_id,omitempty"`
	PollerId      string                         `protobuf:"bytes,2,opt,name=poller_id,json=pollerId,proto3" json:"poller_id,omitempty"`
	PollRequest   *v1.PollForActivityTaskRequest `protobuf:"bytes,3,opt,name=poll_request,json=pollRequest,proto3" json:"poll_request,omitempty"`
	ForwardedFrom string                         `protobuf:"bytes,4,opt,name=forwarded_from,json=forwardedFrom,proto3" json:"forwarded_from,omitempty"`
}
...
func (m *PollForActivityTaskRequest) GetNamespaceId() string {
	if m != nil {
		return m.NamespaceId
	}
	return ""
...
func (m *PollForActivityTaskRequest) GetPollRequest() *v1.PollForActivityTaskRequest {
	if m != nil {
		return m.PollRequest
	}
	return nil
...
func (m *PollForActivityTaskResponse) GetWorkflowExecution() *v11.WorkflowExecution {
	if m != nil {
		return m.WorkflowExecution
	}
	return nil
...
func (m *PollForActivityTaskResponse) GetActivityType() *v11.ActivityType {
	if m != nil {
...
func (m *PollForActivityTaskResponse) GetInput() *v11.Payloads {
	if m != nil {
		return m.Input
	}
	return nil
...
func (m *PollForActivityTaskResponse) GetHeartbeatDetails() *v11.Payloads {
	if m != nil {
...
func (m *PollForActivityTaskResponse) GetWorkflowType() *v11.WorkflowType {
	if m != nil {
		return m.WorkflowType
	}
	return nil
...
func (m *PollForActivityTaskResponse) GetHeader() *v11.Header {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *AddDecisionTaskRequest) GetNamespaceId() string {
	if m != nil {
		return m.NamespaceId
	}
	return ""
...
func (m *AddDecisionTaskRequest) GetExecution() *v11.WorkflowExecution {
	if m != nil {
		return m.Execution
	}
	return nil
...
func (m *AddDecisionTaskRequest) GetTaskQueue() *v14.TaskQueue {
	if m != nil {
		return m.TaskQueue
	}
	return nil
...
func (m *AddDecisionTaskRequest) GetScheduleToStartTimeoutSeconds() int32 {
	if m != nil {
...
func (m *AddDecisionTaskRequest) GetSource() v15.TaskSource {
	if m != nil {
		return m.Source
	}
...
type CancelOutstandingPollRequest struct {
	NamespaceId   string            `protobuf:"bytes,1,opt,name=namespace_id,json=namespaceId,proto3" json:"namespace_id,omitempty"`
	TaskQueueType v16.TaskQueueType `protobuf:"varint,2,opt,name=task_queue_type,json=taskQueueType,proto3,enum=temporal.enums.v1.TaskQueueType" json:"task_queue_type,omitempty"`
	TaskQueue     *v14.TaskQueue    `protobuf:"bytes,3,opt,name=task_queue,json=taskQueue,proto3" json:"task_queue,omitempty"`
...
type ListTaskQueuePartitionsResponse struct {
	...
	DecisionTaskQueuePartitions []*v14.TaskQueuePartitionMetadata `protobuf:"bytes,2,rep,name=decision_task_queue_partitions,json=decisionTaskQueuePartitions,proto3" json:"decision_task_queue_partitions,omitempty"`
}
...
func (m *ListTaskQueuePartitionsResponse) GetDecisionTaskQueuePartitions() []*v14.TaskQueuePartitionMetadata {
	if m != nil {
		return m.DecisionTaskQueuePartitions
	}
	return nil
}

func init() {
	proto.RegisterType((*PollForDecisionTaskRequest)(nil), "temporal.server.api.matchingservice.v1.PollForDecisionTaskRequest")
	proto.RegisterType((*PollForDecisionTaskResponse)(nil), "temporal.server.api.matchingservice.v1.PollForDecisionTaskResponse")
	proto.RegisterMapType((map[string]*v12.WorkflowQuery)(nil), "temporal.server.api.matchingservice.v1.PollForDecisionTaskResponse.QueriesEntry")
	proto.RegisterType((*PollForActivityTaskRequest)(nil), "temporal.server.api.matchingservice.v1.PollForActivityTaskRequest")
	proto.RegisterType((*PollForActivityTaskResponse)(nil), "temporal.server.api.matchingservice.v1.PollForActivityTaskResponse")
	proto.RegisterType((*AddDecisionTaskRequest)(nil), "temporal.server.api.matchingservice.v1.AddDecisionTaskRequest")
	proto.RegisterType((*AddDecisionTaskResponse)(nil), "temporal.server.api.matchingservice.v1.AddDecisionTaskResponse")
...
var fileDescriptor_a429a3813476c583 = []byte{
	...
	,
}
...
func (this *ListTaskQueuePartitionsResponse) Equal(that interface{}) bool {
	...
	if len(this.DecisionTaskQueuePartitions) != len(that1.DecisionTaskQueuePartitions) {
		return false
	}
	for i := range this.DecisionTaskQueuePartitions {
		if !this.DecisionTaskQueuePartitions[i].Equal(that1.DecisionTaskQueuePartitions[i]) {
			return false
		}
	}
	return true
...
func (this *PollForDecisionTaskRequest) GoString() string {
	...
	s := make([]string, 0, 8)
	s = append(s, "&matchingservice.PollForDecisionTaskRequest{")
...
func (this *PollForDecisionTaskResponse) GoString() string {
	...
	s := make([]string, 0, 21)
	s = append(s, "&matchingservice.PollForDecisionTaskResponse{")
...
func (this *PollForActivityTaskRequest) GoString() string {
	...
	s := make([]string, 0, 8)
	s = append(s, "&matchingservice.PollForActivityTaskRequest{")
	s = append(s, "NamespaceId: "+fmt.Sprintf("%#v", this.NamespaceId)+",\n")
	s = append(s, "PollerId: "+fmt.Sprintf("%#v", this.PollerId)+",\n")
	if this.PollRequest != nil {
		s = append(s, "PollRequest: "+fmt.Sprintf("%#v", this.PollRequest)+",\n")
...
func (this *PollForActivityTaskResponse) GoString() string {
	...
	s := make([]string, 0, 20)
	s = append(s, "&matchingservice.PollForActivityTaskResponse{")
	s = append(s, "TaskToken: "+fmt.Sprintf("%#v", this.TaskToken)+",\n")
	if this.WorkflowExecution != nil {
		s = append(s, "WorkflowExecution: "+fmt.Sprintf("%#v", this.WorkflowExecution)+",\n")
	}
...
func (this *AddDecisionTaskRequest) GoString() string {
	...
	s := make([]string, 0, 11)
	s = append(s, "&matchingservice.AddDecisionTaskRequest{")
	s = append(s, "NamespaceId: "+fmt.Sprintf("%#v", this.NamespaceId)+",\n")
...
func (this *AddDecisionTaskResponse) GoString() string {
	...
	s := make([]string, 0, 4)
	s = append(s, "&matchingservice.AddDecisionTaskResponse{")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *ListTaskQueuePartitionsResponse) GoString() string {
	...
	if this.DecisionTaskQueuePartitions != nil {
		s = append(s, "DecisionTaskQueuePartitions: "+fmt.Sprintf("%#v", this.DecisionTaskQueuePartitions)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *PollForDecisionTaskRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ForwardedFrom) > 0 {
		...
		i = encodeVarintRequestResponse(dAtA, i, uint64(len(m.ForwardedFrom)))
		i--
		dAtA[i] = 0x22
	}
...
func (m *ListTaskQueuePartitionsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.DecisionTaskQueuePartitions) > 0 {
		for iNdEx := len(m.DecisionTaskQueuePartitions) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.DecisionTaskQueuePartitions[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *ListTaskQueuePartitionsResponse) Size() (n int) {
	...
	if len(m.DecisionTaskQueuePartitions) > 0 {
		for _, e := range m.DecisionTaskQueuePartitions {
			l = e.Size()
			n += 1 + l + sovRequestResponse(uint64(l))
		}
	}
...
func (this *PollForDecisionTaskResponse) String() string {
	...
	s := strings.Join([]string{`&PollForDecisionTaskResponse{`,
		...
		`DecisionInfo:` + strings.Replace(fmt.Sprintf("%v", this.DecisionInfo), "TransientDecisionInfo", "v13.TransientDecisionInfo", 1) + `,`,
...
func (this *ListTaskQueuePartitionsResponse) String() string {
	...
	repeatedStringForDecisionTaskQueuePartitions := "[]*TaskQueuePartitionMetadata{"
	for _, f := range this.DecisionTaskQueuePartitions {
		repeatedStringForDecisionTaskQueuePartitions += strings.Replace(fmt.Sprintf("%v", f), "TaskQueuePartitionMetadata", "v14.TaskQueuePartitionMetadata", 1) + ","
	}
	repeatedStringForDecisionTaskQueuePartitions += "}"
	s := strings.Join([]string{`&ListTaskQueuePartitionsResponse{`,
		...
		`DecisionTaskQueuePartitions:` + repeatedStringForDecisionTaskQueuePartitions + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *PollForDecisionTaskResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			...
			if m.DecisionInfo == nil {
				m.DecisionInfo = &v13.TransientDecisionInfo{}
			}
...
func (m *ListTaskQueuePartitionsResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DecisionTaskQueuePartitions", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DecisionTaskQueuePartitions = append(m.DecisionTaskQueuePartitions, &v14.TaskQueuePartitionMetadata{})
			if err := m.DecisionTaskQueuePartitions[len(m.DecisionTaskQueuePartitions)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
