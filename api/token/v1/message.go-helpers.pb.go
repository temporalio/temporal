...
// Marshal an object of type NexusOperationChasmCompletion to the protobuf v3 wire format
func (val *NexusOperationChasmCompletion) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type NexusOperationChasmCompletion from the protobuf v3 wire format
func (val *NexusOperationChasmCompletion) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *NexusOperationChasmCompletion) Size() int {
	return proto.Size(val)
}

// Equal returns whether two NexusOperationChasmCompletion values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *NexusOperationChasmCompletion) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *NexusOperationChasmCompletion
	switch t := that.(type) {
	case *NexusOperationChasmCompletion:
		that1 = t
	case NexusOperationChasmCompletion:
		that1 = &t
	default:
