...
// Marshal an object of type LocalExecutionInfo to the protobuf v3 wire format
func (val *LocalExecutionInfo) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type LocalExecutionInfo from the protobuf v3 wire format
func (val *LocalExecutionInfo) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *LocalExecutionInfo) Size() int {
	return proto.Size(val)
}

// Equal returns whether two LocalExecutionInfo values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *LocalExecutionInfo) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *LocalExecutionInfo
	switch t := that.(type) {
	case *LocalExecutionInfo:
		that1 = t
	case LocalExecutionInfo:
		that1 = &t
	default:
