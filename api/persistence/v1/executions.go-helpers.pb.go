...
// Marshal an object of type TimeSkippedDetails to the protobuf v3 wire format
func (val *TimeSkippedDetails) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type TimeSkippedDetails from the protobuf v3 wire format
func (val *TimeSkippedDetails) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *TimeSkippedDetails) Size() int {
	return proto.Size(val)
}

// Equal returns whether two TimeSkippedDetails values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *TimeSkippedDetails) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *TimeSkippedDetails
	switch t := that.(type) {
	case *TimeSkippedDetails:
		that1 = t
	case TimeSkippedDetails:
		that1 = &t
	default:
