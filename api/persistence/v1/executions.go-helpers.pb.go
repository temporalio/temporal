...
// Marshal an object of type TimeSkipTaskRegenEntry to the protobuf v3 wire format
func (val *TimeSkipTaskRegenEntry) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type TimeSkipTaskRegenEntry from the protobuf v3 wire format
func (val *TimeSkipTaskRegenEntry) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *TimeSkipTaskRegenEntry) Size() int {
	return proto.Size(val)
}

// Equal returns whether two TimeSkipTaskRegenEntry values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *TimeSkipTaskRegenEntry) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *TimeSkipTaskRegenEntry
	switch t := that.(type) {
	case *TimeSkipTaskRegenEntry:
		that1 = t
	case TimeSkipTaskRegenEntry:
		that1 = &t
	default:
