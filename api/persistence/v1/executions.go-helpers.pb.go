...
// Marshal an object of type NotifyActivityTaskInfo to the protobuf v3 wire format
func (val *NotifyActivityTaskInfo) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type NotifyActivityTaskInfo from the protobuf v3 wire format
func (val *NotifyActivityTaskInfo) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *NotifyActivityTaskInfo) Size() int {
	return proto.Size(val)
}

// Equal returns whether two NotifyActivityTaskInfo values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *NotifyActivityTaskInfo) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *NotifyActivityTaskInfo
	switch t := that.(type) {
	case *NotifyActivityTaskInfo:
		that1 = t
	case NotifyActivityTaskInfo:
		that1 = &t
	default:
