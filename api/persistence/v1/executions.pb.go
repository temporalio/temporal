...
type TimeSkippingInfo struct {
	...
	StopReason    v11.TimeSkippingStopReason `protobuf:"varint,7,opt,name=stop_reason,json=stopReason,proto3,enum=temporal.api.enums.v1.TimeSkippingStopReason" json:"stop_reason,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TimeSkippingInfo) GetStopReason() v11.TimeSkippingStopReason {
	if x != nil {
		return x.StopReason
	}
	return v11.TimeSkippingStopReason(0)
}
...
const file_temporal_server_api_persistence_v1_executions_proto_rawDesc = "" +
	...
	"\x1alast_workflow_task_failureJ\x04\b\b\x10\tJ\x04\b\x0e\x10\x0fJ\x04\b\x0f\x10\x10J\x04\b\x10\x10\x11J\x04\bp\x10qJ\x04\b,\x10-J\x04\b-\x10.J\x04\b/\x100J\x04\b0\x101J\x04\b1\x102J\x04\b2\x103\"\xbb\x04\n" +
	...
	"\x12session_skip_count\x18\x06 \x01(\x05R\x10sessionSkipCount\x12N\n" +
	"\vstop_reason\x18\a \x01(\x0e2-.temporal.api.enums.v1.TimeSkippingStopReasonR\n" +
	"stopReasonJ\x04\b\x03\x10\x04R\x1ecurrent_elapsed_duration_bound\"\x89\x02\n" +
...
var file_temporal_server_api_persistence_v1_executions_proto_goTypes = []any{
	...
	(v11.TimeSkippingStopReason)(0),                    // 65: temporal.api.enums.v1.TimeSkippingStopReason
...
var file_temporal_server_api_persistence_v1_executions_proto_depIdxs = []int32{
	...
	65,  // 52: temporal.server.api.persistence.v1.TimeSkippingInfo.stop_reason:type_name -> temporal.api.enums.v1.TimeSkippingStopReason
