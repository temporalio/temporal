...
type OutboundTaskInfo struct {
	...
	//	*OutboundTaskInfo_ActivityCommandInfo
...
func (x *OutboundTaskInfo) GetActivityCommandInfo() *ActivityCommandTaskInfo {
	if x != nil {
		if x, ok := x.TaskDetails.(*OutboundTaskInfo_ActivityCommandInfo); ok {
			return x.ActivityCommandInfo
		}
	}
	return nil
}
...
type OutboundTaskInfo_ActivityCommandInfo struct {
	// If the task is an activity command task.
	ActivityCommandInfo *ActivityCommandTaskInfo `protobuf:"bytes,10,opt,name=activity_command_info,json=activityCommandInfo,proto3,oneof"`
}
...
func (x *ActivityCommandTaskInfo) Reset() {
	*x = ActivityCommandTaskInfo{}
	mi := &file_temporal_server_api_persistence_v1_executions_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ActivityCommandTaskInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ActivityCommandTaskInfo) ProtoMessage() {}

func (x *ActivityCommandTaskInfo) ProtoReflect() protoreflect.Message {
	mi := &file_temporal_server_api_persistence_v1_executions_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ActivityCommandTaskInfo.ProtoReflect.Descriptor instead.
func (*ActivityCommandTaskInfo) Descriptor() ([]byte, []int) {
	return file_temporal_server_api_persistence_v1_executions_proto_rawDescGZIP(), []int{11}
}

func (x *ActivityCommandTaskInfo) GetCommandType() v1.ActivityCommandType {
	if x != nil {
...
var file_temporal_server_api_persistence_v1_executions_proto_goTypes = []any{
	...
	(*ActivityCommandTaskInfo)(nil),        // 11: temporal.server.api.persistence.v1.ActivityCommandTaskInfo
	...
	(v1.ActivityCommandType)(0),                        // 69: temporal.server.api.enums.v1.ActivityCommandType
...
var file_temporal_server_api_persistence_v1_executions_proto_depIdxs = []int32{
	...
	11,  // 76: temporal.server.api.persistence.v1.OutboundTaskInfo.activity_command_info:type_name -> temporal.server.api.persistence.v1.ActivityCommandTaskInfo
	69,  // 77: temporal.server.api.persistence.v1.ActivityCommandTaskInfo.command_type:type_name -> temporal.server.api.enums.v1.ActivityCommandType
...
func file_temporal_server_api_persistence_v1_executions_proto_init() {
	...
	file_temporal_server_api_persistence_v1_executions_proto_msgTypes[10].OneofWrappers = []any{
		...
		(*OutboundTaskInfo_ActivityCommandInfo)(nil),
	}
