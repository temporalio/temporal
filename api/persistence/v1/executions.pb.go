...
const (
	...
	TIME_SKIPPING_DISABLED_REASON_RUNAWAY_PROTECTOR    TimeSkippingDisabledReason = 2
)
...
var (
	TimeSkippingDisabledReason_name = map[int32]string{
		...
		2: "TIME_SKIPPING_DISABLED_REASON_RUNAWAY_PROTECTOR",
	}
	TimeSkippingDisabledReason_value = map[string]int32{
		...
		"TIME_SKIPPING_DISABLED_REASON_RUNAWAY_PROTECTOR":    2,
	}
)
...
func (x TimeSkippingDisabledReason) String() string {
	...
	case TIME_SKIPPING_DISABLED_REASON_RUNAWAY_PROTECTOR:
		return "RunawayProtector"
	default:
...
const file_temporal_server_api_persistence_v1_executions_proto_rawDesc = "" +
	...
	"\x1alast_workflow_task_failureJ\x04\b\b\x10\tJ\x04\b\x0e\x10\x0fJ\x04\b\x0f\x10\x10J\x04\b\x10\x10\x11J\x04\bp\x10qJ\x04\b,\x10-J\x04\b-\x10.J\x04\b/\x100J\x04\b0\x101J\x04\b1\x102J\x04\b2\x103\"\xa6\x04\n" +
	...
	"\x0fdisabled_reason\x18\x06 \x01(\x0e2>.temporal.server.api.persistence.v1.TimeSkippingDisabledReasonR\x0edisabledReasonJ\x04\b\x03\x10\x04R\x1ecurrent_elapsed_duration_bound\"\x89\x02\n" +
	...
	"\n" +
	"request_id\x18\x04 \x01(\tR\trequestId*\xb8\x01\n" +
	"\x1aTimeSkippingDisabledReason\x12-\n" +
	")TIME_SKIPPING_DISABLED_REASON_UNSPECIFIED\x10\x00\x126\n" +
	"2TIME_SKIPPING_DISABLED_REASON_FAST_FORWARD_REACHED\x10\x01\x123\n" +
	"/TIME_SKIPPING_DISABLED_REASON_RUNAWAY_PROTECTOR\x10\x02B6Z4go.temporal.io/server/api/persistence/v1;persistenceb\x06proto3"
