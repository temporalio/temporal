...
type WorkflowExecutionInfo struct {
	...
	PropagatedNexusSerializationContext *v13.PropagatedNexusSerializationContext `protobuf:"bytes,116,opt,name=propagated_nexus_serialization_context,json=propagatedNexusSerializationContext,proto3" json:"propagated_nexus_serialization_context,omitempty"`
	unknownFields                       protoimpl.UnknownFields
	sizeCache                           protoimpl.SizeCache
}
...
func (x *WorkflowExecutionInfo) GetPropagatedNexusSerializationContext() *v13.PropagatedNexusSerializationContext {
	if x != nil {
...
const file_temporal_server_api_persistence_v1_executions_proto_rawDesc = "" +
	...
	"\x12time_skipping_info\x18s \x01(\v24.temporal.server.api.persistence.v1.TimeSkippingInfoR\x10timeSkippingInfo\x12\x90\x01\n" +
	"&propagated_nexus_serialization_context\x18t \x01(\v2;.temporal.api.common.v1.PropagatedNexusSerializationContextR#propagatedNexusSerializationContext\x1ad\n" +
...
var file_temporal_server_api_persistence_v1_executions_proto_goTypes = []any{
	...
	(*v13.PropagatedNexusSerializationContext)(nil),    // 64: temporal.api.common.v1.PropagatedNexusSerializationContext
...
var file_temporal_server_api_persistence_v1_executions_proto_depIdxs = []int32{
	...
	64,  // 48: temporal.server.api.persistence.v1.WorkflowExecutionInfo.propagated_nexus_serialization_context:type_name -> temporal.api.common.v1.PropagatedNexusSerializationContext
	...
	56,  // 54: temporal.server.api.persistence.v1.FastForwardInfo.last_update_versioned_transition:type_name -> temporal.server.api.persistence.v1.VersionedTransition
