...
// Marshal an object of type ChasmNexusCompletionInfo to the protobuf v3 wire format
func (val *ChasmNexusCompletionInfo) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type ChasmNexusCompletionInfo from the protobuf v3 wire format
func (val *ChasmNexusCompletionInfo) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *ChasmNexusCompletionInfo) Size() int {
	return proto.Size(val)
}

// Equal returns whether two ChasmNexusCompletionInfo values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *ChasmNexusCompletionInfo) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *ChasmNexusCompletionInfo
	switch t := that.(type) {
	case *ChasmNexusCompletionInfo:
		that1 = t
	case ChasmNexusCompletionInfo:
		that1 = &t
	default:
