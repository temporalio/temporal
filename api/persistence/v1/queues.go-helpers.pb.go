...
// Marshal an object of type QueueReaderLane to the protobuf v3 wire format
func (val *QueueReaderLane) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type QueueReaderLane from the protobuf v3 wire format
func (val *QueueReaderLane) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *QueueReaderLane) Size() int {
	return proto.Size(val)
}

// Equal returns whether two QueueReaderLane values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *QueueReaderLane) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *QueueReaderLane
	switch t := that.(type) {
	case *QueueReaderLane:
		that1 = t
	case QueueReaderLane:
		that1 = &t
	default:
