...
type Failure struct {
	...
	FailureInfoType string   `protobuf:"bytes,5,opt,name=failure_info_type,json=failureInfoType,proto3" json:"failure_info_type,omitempty"`
}
...
func (m *Failure) GetFailureInfoType() string {
	if m != nil {
		return m.FailureInfoType
	}
	return ""
}
...
var fileDescriptor_ad471f2cfe5ee207 = []byte{
	...
	,
}
...
func (this *Failure) Equal(that interface{}) bool {
	...
	if this.FailureInfoType != that1.FailureInfoType {
		return false
	}
	return true
}
...
func (this *Failure) GoString() string {
	...
	s = append(s, "FailureInfoType: "+fmt.Sprintf("%#v", this.FailureInfoType)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *Failure) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.FailureInfoType) > 0 {
		i -= len(m.FailureInfoType)
		copy(dAtA[i:], m.FailureInfoType)
		i = encodeVarintMessage(dAtA, i, uint64(len(m.FailureInfoType)))
		i--
		dAtA[i] = 0x2a
	}
	if m.Cause != nil {
...
func (this *Failure) String() string {
	...
	s := strings.Join([]string{`&Failure{`,
		...
		`FailureInfoType:` + fmt.Sprintf("%v", this.FailureInfoType) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Failure) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FailureInfoType", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FailureInfoType = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipMessage(dAtA[iNdEx:])
