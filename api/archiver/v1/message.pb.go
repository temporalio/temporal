...
import (
	...
	v12 "go.temporal.io/temporal-proto/common/v1"
...
type ArchiveVisibilityRequest struct {
	...
	ExecutionTimestamp int64                       `protobuf:"varint,7,opt,name=execution_timestamp,json=executionTimestamp,proto3" json:"execution_timestamp,omitempty"`
	CloseTimestamp     int64                       `protobuf:"varint,8,opt,name=close_timestamp,json=closeTimestamp,proto3" json:"close_timestamp,omitempty"`
	Status             v11.WorkflowExecutionStatus `protobuf:"varint,9,opt,name=status,proto3,enum=temporal.enums.v1.WorkflowExecutionStatus" json:"status,omitempty"`
...
func (m *ArchiveVisibilityRequest) GetStartTimestamp() int64 {
	if m != nil {
...
func (m *ArchiveVisibilityRequest) GetExecutionTimestamp() int64 {
	if m != nil {
...
func (m *ArchiveVisibilityRequest) GetCloseTimestamp() int64 {
	if m != nil {
...
var fileDescriptor_7ad6e64b6a1a2278 = []byte{
	...
	,
}
...
func (this *ArchiveVisibilityRequest) Equal(that interface{}) bool {
	...
	if this.ExecutionTimestamp != that1.ExecutionTimestamp {
		return false
	}
	if this.CloseTimestamp != that1.CloseTimestamp {
		return false
	}
...
func (this *ArchiveVisibilityRequest) GoString() string {
	...
	s = append(s, "ExecutionTimestamp: "+fmt.Sprintf("%#v", this.ExecutionTimestamp)+",\n")
	s = append(s, "CloseTimestamp: "+fmt.Sprintf("%#v", this.CloseTimestamp)+",\n")
...
func (m *ArchiveVisibilityRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.CloseTimestamp != 0 {
		i = encodeVarintMessage(dAtA, i, uint64(m.CloseTimestamp))
		i--
		dAtA[i] = 0x40
	}
	if m.ExecutionTimestamp != 0 {
		i = encodeVarintMessage(dAtA, i, uint64(m.ExecutionTimestamp))
		i--
		dAtA[i] = 0x38
	}
	if m.StartTimestamp != 0 {
		i = encodeVarintMessage(dAtA, i, uint64(m.StartTimestamp))
		i--
		dAtA[i] = 0x30
	}
...
func (m *ArchiveVisibilityRequest) Size() (n int) {
	...
	if m.StartTimestamp != 0 {
		n += 1 + sovMessage(uint64(m.StartTimestamp))
	}
	if m.ExecutionTimestamp != 0 {
		n += 1 + sovMessage(uint64(m.ExecutionTimestamp))
	}
	if m.CloseTimestamp != 0 {
		n += 1 + sovMessage(uint64(m.CloseTimestamp))
	}
	if m.Status != 0 {
...
func (this *ArchiveVisibilityRequest) String() string {
	...
	s := strings.Join([]string{`&ArchiveVisibilityRequest{`,
		...
		`ExecutionTimestamp:` + fmt.Sprintf("%v", this.ExecutionTimestamp) + `,`,
		`CloseTimestamp:` + fmt.Sprintf("%v", this.CloseTimestamp) + `,`,
	...
	for iNdEx < l {
		...
		case 8:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CloseTimestamp |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
