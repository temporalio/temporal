...
//
//	mockgen -package adminservicemock -source api/adminservice/v1/service_grpc.pb.go -destination api.new/temporal/server/api/adminservicemock/v1/service_grpc.pb.mock.go
//
