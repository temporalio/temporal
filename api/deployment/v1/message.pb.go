...
const file_temporal_server_api_deployment_v1_message_proto_rawDesc = "" +
	...
	"\x10allow_no_pollers\x18\x06 \x01(\bR\x0eallowNoPollers\"\xe0\x01\n" +
...
var file_temporal_server_api_deployment_v1_message_proto_goTypes = []any{
	...
	(v1.WorkerDeploymentVersionStatus)(0),      // 83: temporal.api.enums.v1.WorkerDeploymentVersionStatus
	(*v11.VersionDrainageInfo)(nil),            // 84: temporal.api.deployment.v1.VersionDrainageInfo
	(*v11.VersionMetadata)(nil),                // 85: temporal.api.deployment.v1.VersionMetadata
	(*v11.RoutingConfig)(nil),                  // 86: temporal.api.deployment.v1.RoutingConfig
	(v1.VersionDrainageStatus)(0),              // 87: temporal.api.enums.v1.VersionDrainageStatus
	(v1.TaskQueueType)(0),                      // 88: temporal.api.enums.v1.TaskQueueType
	(*v11.WorkerDeploymentVersionInfo_VersionTaskQueueInfo)(nil),    // 89: temporal.api.deployment.v1.WorkerDeploymentVersionInfo.VersionTaskQueueInfo
	(*v11.WorkerDeploymentInfo_WorkerDeploymentVersionSummary)(nil), // 90: temporal.api.deployment.v1.WorkerDeploymentInfo.WorkerDeploymentVersionSummary
	(*v11.Deployment)(nil),               // 91: temporal.api.deployment.v1.Deployment
	(*v11.UpdateDeploymentMetadata)(nil), // 92: temporal.api.deployment.v1.UpdateDeploymentMetadata
...
var file_temporal_server_api_deployment_v1_message_proto_depIdxs = []int32{
	...
	83,  // 4: temporal.server.api.deployment.v1.DeploymentVersionData.status:type_name -> temporal.api.enums.v1.WorkerDeploymentVersionStatus
	...
	82,  // 6: temporal.server.api.deployment.v1.VersionLocalState.create_time:type_name -> google.protobuf.Timestamp
	82,  // 7: temporal.server.api.deployment.v1.VersionLocalState.routing_update_time:type_name -> google.protobuf.Timestamp
	82,  // 8: temporal.server.api.deployment.v1.VersionLocalState.current_since_time:type_name -> google.protobuf.Timestamp
	82,  // 9: temporal.server.api.deployment.v1.VersionLocalState.ramping_since_time:type_name -> google.protobuf.Timestamp
	82,  // 10: temporal.server.api.deployment.v1.VersionLocalState.first_activation_time:type_name -> google.protobuf.Timestamp
	82,  // 11: temporal.server.api.deployment.v1.VersionLocalState.last_deactivation_time:type_name -> google.protobuf.Timestamp
	84,  // 12: temporal.server.api.deployment.v1.VersionLocalState.drainage_info:type_name -> temporal.api.deployment.v1.VersionDrainageInfo
	85,  // 13: temporal.server.api.deployment.v1.VersionLocalState.metadata:type_name -> temporal.api.deployment.v1.VersionMetadata
	63,  // 14: temporal.server.api.deployment.v1.VersionLocalState.task_queue_families:type_name -> temporal.server.api.deployment.v1.VersionLocalState.TaskQueueFamiliesEntry
	83,  // 15: temporal.server.api.deployment.v1.VersionLocalState.status:type_name -> temporal.api.enums.v1.WorkerDeploymentVersionStatus
	...
	84,  // 23: temporal.server.api.deployment.v1.WorkerDeploymentVersionSummary.drainage_info:type_name -> temporal.api.deployment.v1.VersionDrainageInfo
	...
	83,  // 29: temporal.server.api.deployment.v1.WorkerDeploymentVersionSummary.status:type_name -> temporal.api.enums.v1.WorkerDeploymentVersionStatus
	...
	84,  // 39: temporal.server.api.deployment.v1.SyncDrainageInfoSignalArgs.drainage_info:type_name -> temporal.api.deployment.v1.VersionDrainageInfo
	...
	85,  // 50: temporal.server.api.deployment.v1.UpdateVersionMetadataResponse.metadata:type_name -> temporal.api.deployment.v1.VersionMetadata
