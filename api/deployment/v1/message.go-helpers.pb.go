...
// Marshal an object of type TaskQueueFamilySummary to the protobuf v3 wire format
func (val *TaskQueueFamilySummary) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type TaskQueueFamilySummary from the protobuf v3 wire format
func (val *TaskQueueFamilySummary) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *TaskQueueFamilySummary) Size() int {
	return proto.Size(val)
}

// Equal returns whether two TaskQueueFamilySummary values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *TaskQueueFamilySummary) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *TaskQueueFamilySummary
	switch t := that.(type) {
	case *TaskQueueFamilySummary:
		that1 = t
	case TaskQueueFamilySummary:
		that1 = &t
	default:
