...
import (
	...
	v113 "github.com/temporalio/temporal/api/adminservice/v1"
	v17 "github.com/temporalio/temporal/api/enums/v1"
	v18 "github.com/temporalio/temporal/api/history/v1"
	v112 "github.com/temporalio/temporal/api/namespace/v1"
	v16 "github.com/temporalio/temporal/api/replication/v1"
	v11 "github.com/temporalio/temporal/api/workflow/v1"
	...
	v110 "go.temporal.io/temporal-proto/history/v1"
	v19 "go.temporal.io/temporal-proto/query/v1"
...
type StartWorkflowExecutionRequest struct {
	...
	WorkflowExecutionExpirationTimestamp int64                             `protobuf:"varint,5,opt,name=workflow_execution_expiration_timestamp,json=workflowExecutionExpirationTimestamp,proto3" json:"workflow_execution_expiration_timestamp,omitempty"`
	ContinueAsNewInitiator               v12.ContinueAsNewInitiator        `protobuf:"varint,6,opt,name=continue_as_new_initiator,json=continueAsNewInitiator,proto3,enum=temporal.enums.v1.ContinueAsNewInitiator" json:"continue_as_new_initiator,omitempty"`
	...
	FirstDecisionTaskBackoffSeconds      int32                             `protobuf:"varint,9,opt,name=first_decision_task_backoff_seconds,json=firstDecisionTaskBackoffSeconds,proto3" json:"first_decision_task_backoff_seconds,omitempty"`
}
...
func (m *StartWorkflowExecutionRequest) GetWorkflowExecutionExpirationTimestamp() int64 {
	if m != nil {
...
func (m *StartWorkflowExecutionRequest) GetFirstDecisionTaskBackoffSeconds() int32 {
	if m != nil {
...
type GetMutableStateResponse struct {
	...
	IsWorkflowRunning                     bool                            `protobuf:"varint,11,opt,name=is_workflow_running,json=isWorkflowRunning,proto3" json:"is_workflow_running,omitempty"`
	StickyTaskQueueScheduleToStartTimeout int32                           `protobuf:"varint,12,opt,name=sticky_task_queue_schedule_to_start_timeout,json=stickyTaskQueueScheduleToStartTimeout,proto3" json:"sticky_task_queue_schedule_to_start_timeout,omitempty"`
	...
	CurrentBranchToken                    []byte                          `protobuf:"bytes,14,opt,name=current_branch_token,json=currentBranchToken,proto3" json:"current_branch_token,omitempty"`
	ReplicationInfo                       map[string]*v16.ReplicationInfo `protobuf:"bytes,15,rep,name=replication_info,json=replicationInfo,proto3" json:"replication_info,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	WorkflowState                         v17.WorkflowExecutionState      `protobuf:"varint,16,opt,name=workflow_state,json=workflowState,proto3,enum=temporal.server.api.enums.v1.WorkflowExecutionState" json:"workflow_state,omitempty"`
	WorkflowStatus                        v12.WorkflowExecutionStatus     `protobuf:"varint,17,opt,name=workflow_status,json=workflowStatus,proto3,enum=temporal.enums.v1.WorkflowExecutionStatus" json:"workflow_status,omitempty"`
	VersionHistories                      *v18.VersionHistories           `protobuf:"bytes,18,opt,name=version_histories,json=versionHistories,proto3" json:"version_histories,omitempty"`
	IsStickyTaskQueueEnabled              bool                            `protobuf:"varint,19,opt,name=is_sticky_task_queue_enabled,json=isStickyTaskQueueEnabled,proto3" json:"is_sticky_task_queue_enabled,omitempty"`
}
...
func (m *GetMutableStateResponse) GetIsWorkflowRunning() bool {
	if m != nil {
...
func (m *GetMutableStateResponse) GetStickyTaskQueueScheduleToStartTimeout() int32 {
	if m != nil {
...
func (m *GetMutableStateResponse) GetReplicationInfo() map[string]*v16.ReplicationInfo {
	if m != nil {
...
type PollMutableStateResponse struct {
	...
	ClientFeatureVersion                  string                          `protobuf:"bytes,9,opt,name=client_feature_version,json=clientFeatureVersion,proto3" json:"client_feature_version,omitempty"`
	ClientImpl                            string                          `protobuf:"bytes,10,opt,name=client_impl,json=clientImpl,proto3" json:"client_impl,omitempty"`
	StickyTaskQueueScheduleToStartTimeout int32                           `protobuf:"varint,11,opt,name=sticky_task_queue_schedule_to_start_timeout,json=stickyTaskQueueScheduleToStartTimeout,proto3" json:"sticky_task_queue_schedule_to_start_timeout,omitempty"`
	...
	ReplicationInfo                       map[string]*v16.ReplicationInfo `protobuf:"bytes,13,rep,name=replication_info,json=replicationInfo,proto3" json:"replication_info,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	...
	WorkflowStatus                        v12.WorkflowExecutionStatus     `protobuf:"varint,16,opt,name=workflow_status,json=workflowStatus,proto3,enum=temporal.enums.v1.WorkflowExecutionStatus" json:"workflow_status,omitempty"`
}
...
func (m *PollMutableStateResponse) GetStickyTaskQueueScheduleToStartTimeout() int32 {
	if m != nil {
		return m.StickyTaskQueueScheduleToStartTimeout
	}
	return 0
...
func (m *PollMutableStateResponse) GetReplicationInfo() map[string]*v16.ReplicationInfo {
	if m != nil {
		return m.ReplicationInfo
	}
	return nil
...
func (m *RecordDecisionTaskStartedRequest) GetNamespaceId() string {
	if m != nil {
		return m.NamespaceId
	}
	return ""
...
func (m *RecordDecisionTaskStartedRequest) GetWorkflowExecution() *v14.WorkflowExecution {
	if m != nil {
...
type RecordDecisionTaskStartedResponse struct {
	...
	DecisionInfo               *v18.TransientDecisionInfo    `protobuf:"bytes,8,opt,name=decision_info,json=decisionInfo,proto3" json:"decision_info,omitempty"`
...
func (m *RecordDecisionTaskStartedResponse) GetWorkflowType() *v14.WorkflowType {
	if m != nil {
		return m.WorkflowType
	}
	return nil
...
func (m *RecordDecisionTaskStartedResponse) GetDecisionInfo() *v18.TransientDecisionInfo {
	if m != nil {
...
func (m *RecordDecisionTaskStartedResponse) GetWorkflowExecutionTaskQueue() *v15.TaskQueue {
	if m != nil {
...
func (m *RecordDecisionTaskStartedResponse) GetScheduledTimestamp() int64 {
	if m != nil {
...
func (m *RecordDecisionTaskStartedResponse) GetStartedTimestamp() int64 {
	if m != nil {
...
func (m *RecordDecisionTaskStartedResponse) GetQueries() map[string]*v19.WorkflowQuery {
	if m != nil {
		return m.Queries
	}
	return nil
...
type RecordActivityTaskStartedResponse struct {
	...
	StartedTimestamp                int64              `protobuf:"varint,2,opt,name=started_timestamp,json=startedTimestamp,proto3" json:"started_timestamp,omitempty"`
	Attempt                         int64              `protobuf:"varint,3,opt,name=attempt,proto3" json:"attempt,omitempty"`
	ScheduledTimestampOfThisAttempt int64              `protobuf:"varint,4,opt,name=scheduled_timestamp_of_this_attempt,json=scheduledTimestampOfThisAttempt,proto3" json:"scheduled_timestamp_of_this_attempt,omitempty"`
...
func (m *RecordActivityTaskStartedResponse) GetStartedTimestamp() int64 {
	if m != nil {
		return m.StartedTimestamp
	}
	return 0
...
func (m *RecordActivityTaskStartedResponse) GetScheduledTimestampOfThisAttempt() int64 {
	if m != nil {
...
type RespondDecisionTaskCompletedRequest struct {
	NamespaceId     string                                  `protobuf:"bytes,1,opt,name=namespace_id,json=namespaceId,proto3" json:"namespace_id,omitempty"`
	CompleteRequest *v1.RespondDecisionTaskCompletedRequest `protobuf:"bytes,2,opt,name=complete_request,json=completeRequest,proto3" json:"complete_request,omitempty"`
}
...
func (m *RespondDecisionTaskCompletedRequest) GetNamespaceId() string {
	if m != nil {
		return m.NamespaceId
	}
	return ""
...
func (m *RespondDecisionTaskCompletedRequest) GetCompleteRequest() *v1.RespondDecisionTaskCompletedRequest {
	if m != nil {
...
type RespondDecisionTaskFailedRequest struct {
	NamespaceId   string                               `protobuf:"bytes,1,opt,name=namespace_id,json=namespaceId,proto3" json:"namespace_id,omitempty"`
	FailedRequest *v1.RespondDecisionTaskFailedRequest `protobuf:"bytes,2,opt,name=failed_request,json=failedRequest,proto3" json:"failed_request,omitempty"`
}
...
func (m *RespondDecisionTaskFailedRequest) GetNamespaceId() string {
	if m != nil {
		return m.NamespaceId
	}
	return ""
...
func (m *RespondDecisionTaskFailedRequest) GetFailedRequest() *v1.RespondDecisionTaskFailedRequest {
	if m != nil {
...
func (m *ScheduleDecisionTaskRequest) GetNamespaceId() string {
	if m != nil {
		return m.NamespaceId
	}
	return ""
...
func (m *ScheduleDecisionTaskRequest) GetWorkflowExecution() *v14.WorkflowExecution {
	if m != nil {
		return m.WorkflowExecution
	}
	return nil
...
type ReplicateEventsRequest struct {
	...
	FirstEventId      int64                           `protobuf:"varint,4,opt,name=first_event_id,json=firstEventId,proto3" json:"first_event_id,omitempty"`
	NextEventId       int64                           `protobuf:"varint,5,opt,name=next_event_id,json=nextEventId,proto3" json:"next_event_id,omitempty"`
	Version           int64                           `protobuf:"varint,6,opt,name=version,proto3" json:"version,omitempty"`
	ReplicationInfo   map[string]*v16.ReplicationInfo `protobuf:"bytes,7,rep,name=replication_info,json=replicationInfo,proto3" json:"replication_info,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	History           *v110.History                   `protobuf:"bytes,8,opt,name=history,proto3" json:"history,omitempty"`
	NewRunHistory     *v110.History                   `protobuf:"bytes,9,opt,name=new_run_history,json=newRunHistory,proto3" json:"new_run_history,omitempty"`
	// this attribute is deprecated
	ForceBufferEvents       bool  `protobuf:"varint,10,opt,name=force_buffer_events,json=forceBufferEvents,proto3" json:"force_buffer_events,omitempty"`
...
func (m *ReplicateEventsRequest) Reset()      { *m = ReplicateEventsRequest{} }
func (*ReplicateEventsRequest) ProtoMessage() {}
func (*ReplicateEventsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_b8c78c1d460a3711, []int{42}
}
func (m *ReplicateEventsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ReplicateEventsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ReplicateEventsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ReplicateEventsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReplicateEventsRequest.Merge(m, src)
}
func (m *ReplicateEventsRequest) XXX_Size() int {
	return m.Size()
}
func (m *ReplicateEventsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ReplicateEventsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ReplicateEventsRequest proto.InternalMessageInfo

func (m *ReplicateEventsRequest) GetSourceCluster() string {
	if m != nil {
...
func (m *ReplicateEventsRequest) GetNamespaceId() string {
	if m != nil {
		return m.NamespaceId
	}
	return ""
...
func (m *ReplicateEventsRequest) GetWorkflowExecution() *v14.WorkflowExecution {
	if m != nil {
		return m.WorkflowExecution
	}
	return nil
...
func (m *ReplicateEventsRequest) GetFirstEventId() int64 {
	if m != nil {
...
func (m *ReplicateEventsRequest) GetNextEventId() int64 {
	if m != nil {
		return m.NextEventId
	}
	return 0
...
func (m *ReplicateEventsRequest) GetVersion() int64 {
	if m != nil {
		return m.Version
	}
	return 0
...
func (m *ReplicateEventsRequest) GetReplicationInfo() map[string]*v16.ReplicationInfo {
	if m != nil {
		return m.ReplicationInfo
	}
	return nil
...
func (m *ReplicateEventsRequest) GetHistory() *v110.History {
	if m != nil {
		return m.History
	}
	return nil
...
func (m *ReplicateEventsRequest) GetNewRunHistory() *v110.History {
	if m != nil {
...
func (m *ReplicateEventsRequest) GetForceBufferEvents() bool {
	if m != nil {
		return m.ForceBufferEvents
	}
	return false
}

func (m *ReplicateEventsRequest) GetEventStoreVersion() int32 {
	if m != nil {
		return m.EventStoreVersion
	}
	return 0
...
func (m *ReplicateEventsRequest) GetNewRunEventStoreVersion() int32 {
	if m != nil {
...
func (m *ReplicateEventsRequest) GetResetWorkflow() bool {
	if m != nil {
...
func (m *ReplicateEventsRequest) GetNewRunNdc() bool {
	if m != nil {
		return m.NewRunNdc
	}
	return false
...
type ReplicateEventsResponse struct {
}

func (m *ReplicateEventsResponse) Reset()      { *m = ReplicateEventsResponse{} }
func (*ReplicateEventsResponse) ProtoMessage() {}
func (*ReplicateEventsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_b8c78c1d460a3711, []int{43}
}
func (m *ReplicateEventsResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ReplicateEventsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ReplicateEventsResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ReplicateEventsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReplicateEventsResponse.Merge(m, src)
}
func (m *ReplicateEventsResponse) XXX_Size() int {
	return m.Size()
}
func (m *ReplicateEventsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_ReplicateEventsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_ReplicateEventsResponse proto.InternalMessageInfo

type ReplicateRawEventsRequest struct {
	NamespaceId             string                          `protobuf:"bytes,1,opt,name=namespace_id,json=namespaceId,proto3" json:"namespace_id,omitempty"`
	WorkflowExecution       *v14.WorkflowExecution          `protobuf:"bytes,2,opt,name=workflow_execution,json=workflowExecution,proto3" json:"workflow_execution,omitempty"`
	ReplicationInfo         map[string]*v16.ReplicationInfo `protobuf:"bytes,3,rep,name=replication_info,json=replicationInfo,proto3" json:"replication_info,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	History                 *v14.DataBlob                   `protobuf:"bytes,4,opt,name=history,proto3" json:"history,omitempty"`
	NewRunHistory           *v14.DataBlob                   `protobuf:"bytes,5,opt,name=new_run_history,json=newRunHistory,proto3" json:"new_run_history,omitempty"`
	EventStoreVersion       int32                           `protobuf:"varint,6,opt,name=event_store_version,json=eventStoreVersion,proto3" json:"event_store_version,omitempty"`
	NewRunEventStoreVersion int32                           `protobuf:"varint,7,opt,name=new_run_event_store_version,json=newRunEventStoreVersion,proto3" json:"new_run_event_store_version,omitempty"`
}

func (m *ReplicateRawEventsRequest) Reset()      { *m = ReplicateRawEventsRequest{} }
func (*ReplicateRawEventsRequest) ProtoMessage() {}
func (*ReplicateRawEventsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_b8c78c1d460a3711, []int{44}
}
func (m *ReplicateRawEventsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ReplicateRawEventsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ReplicateRawEventsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ReplicateRawEventsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReplicateRawEventsRequest.Merge(m, src)
}
func (m *ReplicateRawEventsRequest) XXX_Size() int {
	return m.Size()
}
func (m *ReplicateRawEventsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ReplicateRawEventsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ReplicateRawEventsRequest proto.InternalMessageInfo

func (m *ReplicateRawEventsRequest) GetNamespaceId() string {
	if m != nil {
		return m.NamespaceId
	}
	return ""
...
func (m *ReplicateRawEventsRequest) GetWorkflowExecution() *v14.WorkflowExecution {
	if m != nil {
		return m.WorkflowExecution
	}
	return nil
...
func (m *ReplicateRawEventsRequest) GetReplicationInfo() map[string]*v16.ReplicationInfo {
	if m != nil {
		return m.ReplicationInfo
	}
	return nil
...
func (m *ReplicateRawEventsRequest) GetHistory() *v14.DataBlob {
	if m != nil {
		return m.History
	}
	return nil
...
func (m *ReplicateRawEventsRequest) GetNewRunHistory() *v14.DataBlob {
	if m != nil {
		return m.NewRunHistory
	}
	return nil
...
func (m *ReplicateRawEventsRequest) GetEventStoreVersion() int32 {
	if m != nil {
		return m.EventStoreVersion
	}
	return 0
...
func (m *ReplicateRawEventsRequest) GetNewRunEventStoreVersion() int32 {
	if m != nil {
		return m.NewRunEventStoreVersion
	}
	return 0
...
type ReplicateRawEventsResponse struct {
}

func (m *ReplicateRawEventsResponse) Reset()      { *m = ReplicateRawEventsResponse{} }
func (*ReplicateRawEventsResponse) ProtoMessage() {}
func (*ReplicateRawEventsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_b8c78c1d460a3711, []int{45}
}
func (m *ReplicateRawEventsResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ReplicateRawEventsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ReplicateRawEventsResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ReplicateRawEventsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReplicateRawEventsResponse.Merge(m, src)
}
func (m *ReplicateRawEventsResponse) XXX_Size() int {
	return m.Size()
}
func (m *ReplicateRawEventsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_ReplicateRawEventsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_ReplicateRawEventsResponse proto.InternalMessageInfo
...
func (m *SyncShardStatusRequest) GetTimestamp() int64 {
	if m != nil {
		return m.Timestamp
	}
	return 0
...
func (m *SyncActivityRequest) GetScheduledTime() int64 {
	if m != nil {
...
func (m *SyncActivityRequest) GetStartedTime() int64 {
	if m != nil {
...
func (m *SyncActivityRequest) GetLastHeartbeatTime() int64 {
	if m != nil {
...
type DescribeHistoryHostRequest struct {
	...
	ExecutionForHost *v14.WorkflowExecution `protobuf:"bytes,3,opt,name=execution_for_host,json=executionForHost,proto3" json:"execution_for_host,omitempty"`
}
...
func (m *DescribeHistoryHostRequest) GetExecutionForHost() *v14.WorkflowExecution {
	if m != nil {
...
type GetReplicationMessagesRequest struct {
	Tokens      []*v16.ReplicationToken `protobuf:"bytes,1,rep,name=tokens,proto3" json:"tokens,omitempty"`
...
func (m *GetReplicationMessagesRequest) GetTokens() []*v16.ReplicationToken {
	if m != nil {
		return m.Tokens
	}
	return nil
...
type GetReplicationMessagesResponse struct {
	MessagesByShard map[int32]*v16.ReplicationMessages `protobuf:"bytes,1,rep,name=messages_by_shard,json=messagesByShard,proto3" json:"messages_by_shard,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *GetReplicationMessagesResponse) GetMessagesByShard() map[int32]*v16.ReplicationMessages {
	if m != nil {
...
type GetDLQReplicationMessagesRequest struct {
	TaskInfos []*v16.ReplicationTaskInfo `protobuf:"bytes,1,rep,name=task_infos,json=taskInfos,proto3" json:"task_infos,omitempty"`
}
...
func (m *GetDLQReplicationMessagesRequest) GetTaskInfos() []*v16.ReplicationTaskInfo {
	if m != nil {
		return m.TaskInfos
	}
	return nil
...
type GetDLQReplicationMessagesResponse struct {
	ReplicationTasks []*v16.ReplicationTask `protobuf:"bytes,1,rep,name=replication_tasks,json=replicationTasks,proto3" json:"replication_tasks,omitempty"`
}
...
func (m *GetDLQReplicationMessagesResponse) GetReplicationTasks() []*v16.ReplicationTask {
	if m != nil {
...
type ReapplyEventsRequest struct {
	NamespaceId string                     `protobuf:"bytes,1,opt,name=namespace_id,json=namespaceId,proto3" json:"namespace_id,omitempty"`
	Request     *v113.ReapplyEventsRequest `protobuf:"bytes,2,opt,name=request,proto3" json:"request,omitempty"`
}
...
func (m *ReapplyEventsRequest) GetRequest() *v113.ReapplyEventsRequest {
	if m != nil {
		return m.Request
	}
	return nil
...
func (m *ReadDLQMessagesRequest) GetType() v17.DeadLetterQueueType {
	if m != nil {
		return m.Type
	}
...
type ReadDLQMessagesResponse struct {
	Type             v17.DeadLetterQueueType `protobuf:"varint,1,opt,name=type,proto3,enum=temporal.server.api.enums.v1.DeadLetterQueueType" json:"type,omitempty"`
	ReplicationTasks []*v16.ReplicationTask  `protobuf:"bytes,2,rep,name=replication_tasks,json=replicationTasks,proto3" json:"replication_tasks,omitempty"`
...
func (m *ReadDLQMessagesResponse) GetType() v17.DeadLetterQueueType {
	if m != nil {
		return m.Type
	}
	return v17.DEAD_LETTER_QUEUE_TYPE_UNSPECIFIED
...
func (m *ReadDLQMessagesResponse) GetReplicationTasks() []*v16.ReplicationTask {
	if m != nil {
		return m.ReplicationTasks
	}
	return nil
...
type RefreshWorkflowTasksRequest struct {
	NamespaceId string                            `protobuf:"bytes,1,opt,name=namespace_id,json=namespaceId,proto3" json:"namespace_id,omitempty"`
	Request     *v113.RefreshWorkflowTasksRequest `protobuf:"bytes,2,opt,name=request,proto3" json:"request,omitempty"`
}
...
func (m *RefreshWorkflowTasksRequest) GetRequest() *v113.RefreshWorkflowTasksRequest {
	if m != nil {
		return m.Request
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]*v16.ReplicationInfo)(nil), "temporal.server.api.historyservice.v1.GetMutableStateResponse.ReplicationInfoEntry")
	...
	proto.RegisterMapType((map[string]*v16.ReplicationInfo)(nil), "temporal.server.api.historyservice.v1.PollMutableStateResponse.ReplicationInfoEntry")
	...
	proto.RegisterType((*RecordDecisionTaskStartedRequest)(nil), "temporal.server.api.historyservice.v1.RecordDecisionTaskStartedRequest")
	proto.RegisterType((*RecordDecisionTaskStartedResponse)(nil), "temporal.server.api.historyservice.v1.RecordDecisionTaskStartedResponse")
	proto.RegisterMapType((map[string]*v19.WorkflowQuery)(nil), "temporal.server.api.historyservice.v1.RecordDecisionTaskStartedResponse.QueriesEntry")
	...
	proto.RegisterType((*RespondDecisionTaskCompletedRequest)(nil), "temporal.server.api.historyservice.v1.RespondDecisionTaskCompletedRequest")
	proto.RegisterType((*RespondDecisionTaskCompletedResponse)(nil), "temporal.server.api.historyservice.v1.RespondDecisionTaskCompletedResponse")
	proto.RegisterType((*RespondDecisionTaskFailedRequest)(nil), "temporal.server.api.historyservice.v1.RespondDecisionTaskFailedRequest")
	proto.RegisterType((*RespondDecisionTaskFailedResponse)(nil), "temporal.server.api.historyservice.v1.RespondDecisionTaskFailedResponse")
	...
	proto.RegisterType((*ScheduleDecisionTaskRequest)(nil), "temporal.server.api.historyservice.v1.ScheduleDecisionTaskRequest")
	proto.RegisterType((*ScheduleDecisionTaskResponse)(nil), "temporal.server.api.historyservice.v1.ScheduleDecisionTaskResponse")
	...
	proto.RegisterType((*ReplicateEventsRequest)(nil), "temporal.server.api.historyservice.v1.ReplicateEventsRequest")
	proto.RegisterMapType((map[string]*v16.ReplicationInfo)(nil), "temporal.server.api.historyservice.v1.ReplicateEventsRequest.ReplicationInfoEntry")
	proto.RegisterType((*ReplicateEventsResponse)(nil), "temporal.server.api.historyservice.v1.ReplicateEventsResponse")
	proto.RegisterType((*ReplicateRawEventsRequest)(nil), "temporal.server.api.historyservice.v1.ReplicateRawEventsRequest")
	proto.RegisterMapType((map[string]*v16.ReplicationInfo)(nil), "temporal.server.api.historyservice.v1.ReplicateRawEventsRequest.ReplicationInfoEntry")
	proto.RegisterType((*ReplicateRawEventsResponse)(nil), "temporal.server.api.historyservice.v1.ReplicateRawEventsResponse")
	...
	proto.RegisterMapType((map[int32]*v16.ReplicationMessages)(nil), "temporal.server.api.historyservice.v1.GetReplicationMessagesResponse.MessagesByShardEntry")
	...
	proto.RegisterType((*ReadDLQMessagesRequest)(nil), "temporal.server.api.historyservice.v1.ReadDLQMessagesRequest")
	proto.RegisterType((*ReadDLQMessagesResponse)(nil), "temporal.server.api.historyservice.v1.ReadDLQMessagesResponse")
...
var fileDescriptor_b8c78c1d460a3711 = []byte{
	...
	,
}
...
func (this *StartWorkflowExecutionRequest) Equal(that interface{}) bool {
	...
	if this.WorkflowExecutionExpirationTimestamp != that1.WorkflowExecutionExpirationTimestamp {
		return false
	}
...
func (this *ReplicateEventsRequest) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ReplicateEventsRequest)
	if !ok {
		that2, ok := that.(ReplicateEventsRequest)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.ForceBufferEvents != that1.ForceBufferEvents {
		return false
	}
	if this.EventStoreVersion != that1.EventStoreVersion {
		return false
...
func (this *ReplicateEventsResponse) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ReplicateEventsResponse)
	if !ok {
		that2, ok := that.(ReplicateEventsResponse)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ReplicateRawEventsRequest) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ReplicateRawEventsRequest)
	if !ok {
		that2, ok := that.(ReplicateRawEventsRequest)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ReplicateRawEventsResponse) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ReplicateRawEventsResponse)
	if !ok {
		that2, ok := that.(ReplicateRawEventsResponse)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *StartWorkflowExecutionRequest) GoString() string {
	...
	s = append(s, "WorkflowExecutionExpirationTimestamp: "+fmt.Sprintf("%#v", this.WorkflowExecutionExpirationTimestamp)+",\n")
...
func (this *GetMutableStateResponse) GoString() string {
	...
	mapStringForReplicationInfo := "map[string]*v16.ReplicationInfo{"
...
func (this *RecordDecisionTaskStartedRequest) GoString() string {
	...
	s := make([]string, 0, 10)
	s = append(s, "&historyservice.RecordDecisionTaskStartedRequest{")
	s = append(s, "NamespaceId: "+fmt.Sprintf("%#v", this.NamespaceId)+",\n")
...
func (this *RecordDecisionTaskStartedResponse) GoString() string {
	...
	s := make([]string, 0, 18)
	s = append(s, "&historyservice.RecordDecisionTaskStartedResponse{")
	if this.WorkflowType != nil {
		s = append(s, "WorkflowType: "+fmt.Sprintf("%#v", this.WorkflowType)+",\n")
	}
	s = append(s, "PreviousStartedEventId: "+fmt.Sprintf("%#v", this.PreviousStartedEventId)+",\n")
...
func (this *RespondDecisionTaskCompletedRequest) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&historyservice.RespondDecisionTaskCompletedRequest{")
	s = append(s, "NamespaceId: "+fmt.Sprintf("%#v", this.NamespaceId)+",\n")
...
func (this *RespondDecisionTaskCompletedResponse) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&historyservice.RespondDecisionTaskCompletedResponse{")
...
func (this *RespondDecisionTaskFailedRequest) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&historyservice.RespondDecisionTaskFailedRequest{")
	s = append(s, "NamespaceId: "+fmt.Sprintf("%#v", this.NamespaceId)+",\n")
...
func (this *RespondDecisionTaskFailedResponse) GoString() string {
	...
	s := make([]string, 0, 4)
	s = append(s, "&historyservice.RespondDecisionTaskFailedResponse{")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *ScheduleDecisionTaskRequest) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&historyservice.ScheduleDecisionTaskRequest{")
	s = append(s, "NamespaceId: "+fmt.Sprintf("%#v", this.NamespaceId)+",\n")
	if this.WorkflowExecution != nil {
		s = append(s, "WorkflowExecution: "+fmt.Sprintf("%#v", this.WorkflowExecution)+",\n")
	}
...
func (this *ScheduleDecisionTaskResponse) GoString() string {
	...
	s := make([]string, 0, 4)
	s = append(s, "&historyservice.ScheduleDecisionTaskResponse{")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *ReplicateEventsRequest) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 18)
	s = append(s, "&historyservice.ReplicateEventsRequest{")
	...
	s = append(s, "ForceBufferEvents: "+fmt.Sprintf("%#v", this.ForceBufferEvents)+",\n")
	s = append(s, "EventStoreVersion: "+fmt.Sprintf("%#v", this.EventStoreVersion)+",\n")
...
func (this *ReplicateEventsResponse) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 4)
	s = append(s, "&historyservice.ReplicateEventsResponse{")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *ReplicateRawEventsRequest) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 11)
	s = append(s, "&historyservice.ReplicateRawEventsRequest{")
	s = append(s, "NamespaceId: "+fmt.Sprintf("%#v", this.NamespaceId)+",\n")
	if this.WorkflowExecution != nil {
		s = append(s, "WorkflowExecution: "+fmt.Sprintf("%#v", this.WorkflowExecution)+",\n")
	}
...
func (this *ReplicateRawEventsResponse) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 4)
	s = append(s, "&historyservice.ReplicateRawEventsResponse{")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *GetReplicationMessagesResponse) GoString() string {
	...
	mapStringForMessagesByShard := "map[int32]*v16.ReplicationMessages{"
...
func (this *ReadDLQMessagesRequest) GoString() string {
	...
	s := make([]string, 0, 10)
	s = append(s, "&historyservice.ReadDLQMessagesRequest{")
...
func (this *ReadDLQMessagesResponse) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&historyservice.ReadDLQMessagesResponse{")
	s = append(s, "Type: "+fmt.Sprintf("%#v", this.Type)+",\n")
	if this.ReplicationTasks != nil {
		s = append(s, "ReplicationTasks: "+fmt.Sprintf("%#v", this.ReplicationTasks)+",\n")
	}
...
func (m *StartWorkflowExecutionRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.FirstDecisionTaskBackoffSeconds != 0 {
		i = encodeVarintRequestResponse(dAtA, i, uint64(m.FirstDecisionTaskBackoffSeconds))
		i--
		dAtA[i] = 0x48
	}
	...
	if m.WorkflowExecutionExpirationTimestamp != 0 {
		i = encodeVarintRequestResponse(dAtA, i, uint64(m.WorkflowExecutionExpirationTimestamp))
		i--
		dAtA[i] = 0x28
	}
	if m.Attempt != 0 {
...
func (m *GetMutableStateResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.StickyTaskQueueScheduleToStartTimeout != 0 {
		i = encodeVarintRequestResponse(dAtA, i, uint64(m.StickyTaskQueueScheduleToStartTimeout))
		i--
		dAtA[i] = 0x60
	}
	...
	if len(m.ClientImpl) > 0 {
		...
		i = encodeVarintRequestResponse(dAtA, i, uint64(len(m.ClientImpl)))
		i--
		dAtA[i] = 0x52
	}
	if len(m.ClientFeatureVersion) > 0 {
		...
		i = encodeVarintRequestResponse(dAtA, i, uint64(len(m.ClientFeatureVersion)))
		i--
		dAtA[i] = 0x4a
	}
	if len(m.ClientLibraryVersion) > 0 {
		...
		i = encodeVarintRequestResponse(dAtA, i, uint64(len(m.ClientLibraryVersion)))
		i--
		dAtA[i] = 0x42
	}
...
func (m *ReplicateEventsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ReplicateEventsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReplicateEventsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.NewRunEventStoreVersion != 0 {
		i = encodeVarintRequestResponse(dAtA, i, uint64(m.NewRunEventStoreVersion))
		i--
		dAtA[i] = 0x60
	}
	if m.EventStoreVersion != 0 {
...
func (m *ReplicateEventsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ReplicateEventsResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReplicateEventsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ReplicateRawEventsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ReplicateRawEventsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReplicateRawEventsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ReplicateRawEventsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ReplicateRawEventsResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReplicateRawEventsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *SyncShardStatusRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Timestamp != 0 {
		i = encodeVarintRequestResponse(dAtA, i, uint64(m.Timestamp))
		i--
		dAtA[i] = 0x18
	}
	if m.ShardId != 0 {
...
func (m *SyncActivityRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.LastHeartbeatTime != 0 {
		i = encodeVarintRequestResponse(dAtA, i, uint64(m.LastHeartbeatTime))
		i--
		dAtA[i] = 0x48
	}
	if m.StartedTime != 0 {
		i = encodeVarintRequestResponse(dAtA, i, uint64(m.StartedTime))
		i--
		dAtA[i] = 0x40
	}
	if m.StartedId != 0 {
	...
	if m.ScheduledTime != 0 {
		i = encodeVarintRequestResponse(dAtA, i, uint64(m.ScheduledTime))
		i--
		dAtA[i] = 0x30
	}
	if m.ScheduledId != 0 {
...
func (m *DescribeHistoryHostResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ShardIds) > 0 {
		dAtA71 := make([]byte, len(m.ShardIds)*10)
		var j70 int
		...
		i = encodeVarintRequestResponse(dAtA, i, uint64(j70))
		i--
		dAtA[i] = 0x12
	}
...
func (m *StartWorkflowExecutionRequest) Size() (n int) {
	...
	if m.WorkflowExecutionExpirationTimestamp != 0 {
		n += 1 + sovRequestResponse(uint64(m.WorkflowExecutionExpirationTimestamp))
	}
	if m.ContinueAsNewInitiator != 0 {
	...
	if m.FirstDecisionTaskBackoffSeconds != 0 {
		n += 1 + sovRequestResponse(uint64(m.FirstDecisionTaskBackoffSeconds))
	}
	return n
}
...
func (m *GetMutableStateResponse) Size() (n int) {
	...
	if m.StickyTaskQueueScheduleToStartTimeout != 0 {
		n += 1 + sovRequestResponse(uint64(m.StickyTaskQueueScheduleToStartTimeout))
	}
	if m.EventStoreVersion != 0 {
	...
	if m.WorkflowState != 0 {
		n += 2 + sovRequestResponse(uint64(m.WorkflowState))
	}
	if m.WorkflowStatus != 0 {
...
func (m *ReplicateEventsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.NewRunEventStoreVersion != 0 {
		n += 1 + sovRequestResponse(uint64(m.NewRunEventStoreVersion))
	}
	if m.ResetWorkflow {
		n += 2
	}
...
func (m *ReplicateEventsResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReplicateRawEventsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReplicateRawEventsResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SyncShardStatusRequest) Size() (n int) {
	...
	if m.Timestamp != 0 {
		n += 1 + sovRequestResponse(uint64(m.Timestamp))
	}
	return n
}
...
func (m *SyncActivityRequest) Size() (n int) {
	...
	if m.ScheduledTime != 0 {
		n += 1 + sovRequestResponse(uint64(m.ScheduledTime))
	}
	if m.StartedId != 0 {
		n += 1 + sovRequestResponse(uint64(m.StartedId))
	}
	if m.StartedTime != 0 {
		n += 1 + sovRequestResponse(uint64(m.StartedTime))
	}
	if m.LastHeartbeatTime != 0 {
		n += 1 + sovRequestResponse(uint64(m.LastHeartbeatTime))
	}
	if m.Details != nil {
		l = m.Details.Size()
		n += 1 + l + sovRequestResponse(uint64(l))
...
func (this *StartWorkflowExecutionRequest) String() string {
	...
	s := strings.Join([]string{`&StartWorkflowExecutionRequest{`,
		...
		`WorkflowExecutionExpirationTimestamp:` + fmt.Sprintf("%v", this.WorkflowExecutionExpirationTimestamp) + `,`,
...
func (this *GetMutableStateResponse) String() string {
	...
	s := strings.Join([]string{`&GetMutableStateResponse{`,
		...
		`StickyTaskQueueScheduleToStartTimeout:` + fmt.Sprintf("%v", this.StickyTaskQueueScheduleToStartTimeout) + `,`,
...
func (this *RecordDecisionTaskStartedResponse) String() string {
	...
	s := strings.Join([]string{`&RecordDecisionTaskStartedResponse{`,
		...
		`DecisionInfo:` + strings.Replace(fmt.Sprintf("%v", this.DecisionInfo), "TransientDecisionInfo", "v18.TransientDecisionInfo", 1) + `,`,
...
func (this *RespondDecisionTaskCompletedRequest) String() string {
	...
	s := strings.Join([]string{`&RespondDecisionTaskCompletedRequest{`,
		`NamespaceId:` + fmt.Sprintf("%v", this.NamespaceId) + `,`,
		`CompleteRequest:` + strings.Replace(fmt.Sprintf("%v", this.CompleteRequest), "RespondDecisionTaskCompletedRequest", "v1.RespondDecisionTaskCompletedRequest", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *RespondDecisionTaskFailedRequest) String() string {
	...
	s := strings.Join([]string{`&RespondDecisionTaskFailedRequest{`,
		`NamespaceId:` + fmt.Sprintf("%v", this.NamespaceId) + `,`,
		`FailedRequest:` + strings.Replace(fmt.Sprintf("%v", this.FailedRequest), "RespondDecisionTaskFailedRequest", "v1.RespondDecisionTaskFailedRequest", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *ReplicateEventsRequest) String() string {
	if this == nil {
		return "nil"
	}
	keysForReplicationInfo := make([]string, 0, len(this.ReplicationInfo))
	...
	mapStringForReplicationInfo += "}"
	s := strings.Join([]string{`&ReplicateEventsRequest{`,
		...
		`ReplicationInfo:` + mapStringForReplicationInfo + `,`,
		`History:` + strings.Replace(fmt.Sprintf("%v", this.History), "History", "v110.History", 1) + `,`,
		`NewRunHistory:` + strings.Replace(fmt.Sprintf("%v", this.NewRunHistory), "History", "v110.History", 1) + `,`,
		`ForceBufferEvents:` + fmt.Sprintf("%v", this.ForceBufferEvents) + `,`,
		`EventStoreVersion:` + fmt.Sprintf("%v", this.EventStoreVersion) + `,`,
...
func (this *ReplicateEventsResponse) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ReplicateEventsResponse{`,
		`}`,
	}, "")
	return s
}
func (this *ReplicateRawEventsRequest) String() string {
	if this == nil {
		return "nil"
	}
	keysForReplicationInfo := make([]string, 0, len(this.ReplicationInfo))
	...
	mapStringForReplicationInfo += "}"
	s := strings.Join([]string{`&ReplicateRawEventsRequest{`,
		`NamespaceId:` + fmt.Sprintf("%v", this.NamespaceId) + `,`,
		`WorkflowExecution:` + strings.Replace(fmt.Sprintf("%v", this.WorkflowExecution), "WorkflowExecution", "v14.WorkflowExecution", 1) + `,`,
		`ReplicationInfo:` + mapStringForReplicationInfo + `,`,
		`History:` + strings.Replace(fmt.Sprintf("%v", this.History), "DataBlob", "v14.DataBlob", 1) + `,`,
		`NewRunHistory:` + strings.Replace(fmt.Sprintf("%v", this.NewRunHistory), "DataBlob", "v14.DataBlob", 1) + `,`,
		`EventStoreVersion:` + fmt.Sprintf("%v", this.EventStoreVersion) + `,`,
		`NewRunEventStoreVersion:` + fmt.Sprintf("%v", this.NewRunEventStoreVersion) + `,`,
		`}`,
	}, "")
...
func (this *ReplicateRawEventsResponse) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ReplicateRawEventsResponse{`,
		`}`,
	}, "")
	return s
}
...
func (this *DescribeHistoryHostRequest) String() string {
	...
	s := strings.Join([]string{`&DescribeHistoryHostRequest{`,
		...
		`ExecutionForHost:` + strings.Replace(fmt.Sprintf("%v", this.ExecutionForHost), "WorkflowExecution", "v14.WorkflowExecution", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *GetReplicationMessagesRequest) String() string {
	...
	for _, f := range this.Tokens {
		repeatedStringForTokens += strings.Replace(fmt.Sprintf("%v", f), "ReplicationToken", "v16.ReplicationToken", 1) + ","
	}
...
func (this *GetDLQReplicationMessagesRequest) String() string {
	...
	for _, f := range this.TaskInfos {
		repeatedStringForTaskInfos += strings.Replace(fmt.Sprintf("%v", f), "ReplicationTaskInfo", "v16.ReplicationTaskInfo", 1) + ","
	}
...
func (this *GetDLQReplicationMessagesResponse) String() string {
	...
	for _, f := range this.ReplicationTasks {
		repeatedStringForReplicationTasks += strings.Replace(fmt.Sprintf("%v", f), "ReplicationTask", "v16.ReplicationTask", 1) + ","
	}
...
func (this *ReapplyEventsRequest) String() string {
	...
	s := strings.Join([]string{`&ReapplyEventsRequest{`,
		`NamespaceId:` + fmt.Sprintf("%v", this.NamespaceId) + `,`,
		`Request:` + strings.Replace(fmt.Sprintf("%v", this.Request), "ReapplyEventsRequest", "v113.ReapplyEventsRequest", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *RefreshWorkflowTasksRequest) String() string {
	...
	s := strings.Join([]string{`&RefreshWorkflowTasksRequest{`,
		`NamespaceId:` + fmt.Sprintf("%v", this.NamespaceId) + `,`,
		`Request:` + strings.Replace(fmt.Sprintf("%v", this.Request), "RefreshWorkflowTasksRequest", "v113.RefreshWorkflowTasksRequest", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *GetMutableStateResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			...
			m.StickyTaskQueueScheduleToStartTimeout = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowRequestResponse
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StickyTaskQueueScheduleToStartTimeout |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 15:
			...
			if m.ReplicationInfo == nil {
				m.ReplicationInfo = make(map[string]*v16.ReplicationInfo)
			}
			var mapkey string
			var mapvalue *v16.ReplicationInfo
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
...
func (m *RecordDecisionTaskStartedResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			if m.DecisionInfo == nil {
				m.DecisionInfo = &v18.TransientDecisionInfo{}
			}
...
func (m *RespondDecisionTaskCompletedRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.CompleteRequest == nil {
				m.CompleteRequest = &v1.RespondDecisionTaskCompletedRequest{}
			}
...
func (m *RespondDecisionTaskFailedRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.FailedRequest == nil {
				m.FailedRequest = &v1.RespondDecisionTaskFailedRequest{}
			}
...
func (m *ReplicateEventsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ReplicateEventsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ReplicateEventsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ForceBufferEvents", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *ReplicateEventsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ReplicateEventsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ReplicateEventsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *ReplicateRawEventsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ReplicateRawEventsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ReplicateRawEventsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ReplicateRawEventsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ReplicateRawEventsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ReplicateRawEventsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *DescribeHistoryHostRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.ExecutionForHost == nil {
				m.ExecutionForHost = &v14.WorkflowExecution{}
			}
...
func (m *GetReplicationMessagesRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Tokens = append(m.Tokens, &v16.ReplicationToken{})
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.MessagesByShard == nil {
				m.MessagesByShard = make(map[int32]*v16.ReplicationMessages)
			}
			var mapkey int32
			var mapvalue *v16.ReplicationMessages
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
				...
				if fieldNum == 1 {
					...
					mapvalue = &v16.ReplicationMessages{}
					if err := mapvalue.Unmarshal(dAtA[iNdEx:postmsgIndex]); err != nil {
						return err
					}
					iNdEx = postmsgIndex
...
func (m *GetDLQReplicationMessagesRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.TaskInfos = append(m.TaskInfos, &v16.ReplicationTaskInfo{})
...
func (m *GetDLQReplicationMessagesResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.ReplicationTasks = append(m.ReplicationTasks, &v16.ReplicationTask{})
...
func (m *ReapplyEventsRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.Request == nil {
				m.Request = &v113.ReapplyEventsRequest{}
			}
			if err := m.Request.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
...
func (m *RefreshWorkflowTasksRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.Request == nil {
				m.Request = &v113.RefreshWorkflowTasksRequest{}
			}
			if err := m.Request.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
