...
type RecordWorkflowTaskStartedRequest struct {
	...
	TaskDispatchRevisionNumber int64 `protobuf:"varint,11,opt,name=task_dispatch_revision_number,json=taskDispatchRevisionNumber,proto3" json:"task_dispatch_revision_number,omitempty"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
const file_temporal_server_api_historyservice_v1_request_response_proto_rawDesc = "" +
	...
	" \x01(\v26.temporal.server.api.taskqueue.v1.TaskVersionDirectiveR\x10versionDirective\x12A\n" +
	"\x1dtask_dispatch_revision_number\x18\v \x01(\x03R\x1ataskDispatchRevisionNumber:$\x92\xc4\x03 *\x1eworkflow_execution.workflow_idJ\x04\b\x04\x10\x05\"\x94\n" +
	"\n" +
