...
type AdvanceWorkflowExecutionTimePointResponse struct {
	state              protoimpl.MessageState       `protogen:"open.v1"`
	TimeSkippingInfo   *v15.TimeSkippingInfo        `protobuf:"bytes,1,opt,name=time_skipping_info,json=timeSkippingInfo,proto3" json:"time_skipping_info,omitempty"`
	AdvancedTimePoints []*v15.UpcomingTimePointInfo `protobuf:"bytes,2,rep,name=advanced_time_points,json=advancedTimePoints,proto3" json:"advanced_time_points,omitempty"`
	UpcomingTimePoints []*v15.UpcomingTimePointInfo `protobuf:"bytes,3,rep,name=upcoming_time_points,json=upcomingTimePoints,proto3" json:"upcoming_time_points,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *AdvanceWorkflowExecutionTimePointResponse) GetTimeSkippingInfo() *v15.TimeSkippingInfo {
	if x != nil {
		return x.TimeSkippingInfo
	}
	return nil
...
func (x *AdvanceWorkflowExecutionTimePointResponse) GetAdvancedTimePoints() []*v15.UpcomingTimePointInfo {
	if x != nil {
		return x.AdvancedTimePoints
	}
	return nil
}

func (x *AdvanceWorkflowExecutionTimePointResponse) GetUpcomingTimePoints() []*v15.UpcomingTimePointInfo {
	if x != nil {
		return x.UpcomingTimePoints
	}
	return nil
...
var file_temporal_server_api_historyservice_v1_request_response_proto_depIdxs = []int32{
	...
	224, // 244: temporal.server.api.historyservice.v1.AdvanceWorkflowExecutionTimePointResponse.time_skipping_info:type_name -> temporal.api.workflow.v1.TimeSkippingInfo
	223, // 245: temporal.server.api.historyservice.v1.AdvanceWorkflowExecutionTimePointResponse.advanced_time_points:type_name -> temporal.api.workflow.v1.UpcomingTimePointInfo
	223, // 246: temporal.server.api.historyservice.v1.AdvanceWorkflowExecutionTimePointResponse.upcoming_time_points:type_name -> temporal.api.workflow.v1.UpcomingTimePointInfo
	...
	276, // 251: temporal.server.api.historyservice.v1.RecordWorkflowTaskStartedResponse.QueriesEntry.value:type_name -> temporal.api.query.v1.WorkflowQuery
	276, // 252: temporal.server.api.historyservice.v1.RecordWorkflowTaskStartedResponseWithRawHistory.QueriesEntry.value:type_name -> temporal.api.query.v1.WorkflowQuery
	277, // 253: temporal.server.api.historyservice.v1.GetReplicationMessagesResponse.ShardMessagesEntry.value:type_name -> temporal.server.api.replication.v1.ReplicationMessages
	...
	278, // 257: temporal.server.api.historyservice.v1.routing:extendee -> google.protobuf.MessageOptions
