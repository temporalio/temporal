...
const (
	...
	HistoryService_ForceWorkflowTaskTimeout_FullMethodName               = "/temporal.server.api.historyservice.v1.HistoryService/ForceWorkflowTaskTimeout"
)
...
type HistoryServiceClient interface {
	...
	// ForceWorkflowTaskTimeout forces a workflow task to timeout immediately.
	// This is used by tests to avoid waiting for actual timeout durations.
	ForceWorkflowTaskTimeout(ctx context.Context, in *ForceWorkflowTaskTimeoutRequest, opts ...grpc.CallOption) (*ForceWorkflowTaskTimeoutResponse, error)
}
...
func (c *historyServiceClient) ForceWorkflowTaskTimeout(ctx context.Context, in *ForceWorkflowTaskTimeoutRequest, opts ...grpc.CallOption) (*ForceWorkflowTaskTimeoutResponse, error) {
	out := new(ForceWorkflowTaskTimeoutResponse)
	err := c.cc.Invoke(ctx, HistoryService_ForceWorkflowTaskTimeout_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HistoryServiceServer interface {
	...
	// ForceWorkflowTaskTimeout forces a workflow task to timeout immediately.
	// This is used by tests to avoid waiting for actual timeout durations.
	ForceWorkflowTaskTimeout(context.Context, *ForceWorkflowTaskTimeoutRequest) (*ForceWorkflowTaskTimeoutResponse, error)
...
func (UnimplementedHistoryServiceServer) ForceWorkflowTaskTimeout(context.Context, *ForceWorkflowTaskTimeoutRequest) (*ForceWorkflowTaskTimeoutResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ForceWorkflowTaskTimeout not implemented")
}
...
func _HistoryService_ForceWorkflowTaskTimeout_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ForceWorkflowTaskTimeoutRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HistoryServiceServer).ForceWorkflowTaskTimeout(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HistoryService_ForceWorkflowTaskTimeout_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HistoryServiceServer).ForceWorkflowTaskTimeout(ctx, req.(*ForceWorkflowTaskTimeoutRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HistoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ForceWorkflowTaskTimeout",
			Handler:    _HistoryService_ForceWorkflowTaskTimeout_Handler,
		},
	},
