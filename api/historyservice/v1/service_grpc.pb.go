...
const (
	...
	HistoryService_AdvanceWorkflowExecutionTimePoint_FullMethodName      = "/temporal.server.api.historyservice.v1.HistoryService/AdvanceWorkflowExecutionTimePoint"
)
...
type HistoryServiceClient interface {
	...
	// AdvanceWorkflowExecutionTimePoint advances the virtual time of a time-skipping-enabled
	// workflow execution to the next time point and fires it.
...
func (c *historyServiceClient) AdvanceWorkflowExecutionTimePoint(ctx context.Context, in *AdvanceWorkflowExecutionTimePointRequest, opts ...grpc.CallOption) (*AdvanceWorkflowExecutionTimePointResponse, error) {
	out := new(AdvanceWorkflowExecutionTimePointResponse)
	err := c.cc.Invoke(ctx, HistoryService_AdvanceWorkflowExecutionTimePoint_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedHistoryServiceServer) AdvanceWorkflowExecutionTimePoint(context.Context, *AdvanceWorkflowExecutionTimePointRequest) (*AdvanceWorkflowExecutionTimePointResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AdvanceWorkflowExecutionTimePoint not implemented")
}
...
func _HistoryService_AdvanceWorkflowExecutionTimePoint_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AdvanceWorkflowExecutionTimePointRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HistoryServiceServer).AdvanceWorkflowExecutionTimePoint(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HistoryService_AdvanceWorkflowExecutionTimePoint_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HistoryServiceServer).AdvanceWorkflowExecutionTimePoint(ctx, req.(*AdvanceWorkflowExecutionTimePointRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HistoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _HistoryService_AdvanceWorkflowExecutionTimePoint_Handler,
		},
	},
