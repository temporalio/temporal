...
var file_temporal_server_api_replication_v1_message_proto_goTypes = []any{
	...
	nil,                                             // 24: temporal.server.api.replication.v1.NamespaceTaskAttributes.ClusterReplicationRampsEntry
	...
	(*v12.NamespaceReplicationRamp)(nil),            // 48: temporal.server.api.persistence.v1.NamespaceReplicationRamp
}
var file_temporal_server_api_replication_v1_message_proto_depIdxs = []int32{
	...
	32, // 29: temporal.server.api.replication.v1.ReplicationTaskInfo.task_type:type_name -> temporal.server.api.enums.v1.TaskType
	28, // 30: temporal.server.api.replication.v1.ReplicationTaskInfo.priority:type_name -> temporal.server.api.enums.v1.TaskPriority
	33, // 31: temporal.server.api.replication.v1.NamespaceTaskAttributes.namespace_operation:type_name -> temporal.server.api.enums.v1.NamespaceOperation
	34, // 32: temporal.server.api.replication.v1.NamespaceTaskAttributes.info:type_name -> temporal.api.namespace.v1.NamespaceInfo
	35, // 33: temporal.server.api.replication.v1.NamespaceTaskAttributes.config:type_name -> temporal.api.namespace.v1.NamespaceConfig
	36, // 34: temporal.server.api.replication.v1.NamespaceTaskAttributes.replication_config:type_name -> temporal.api.replication.v1.NamespaceReplicationConfig
	37, // 35: temporal.server.api.replication.v1.NamespaceTaskAttributes.failover_history:type_name -> temporal.api.replication.v1.FailoverStatus
	24, // 36: temporal.server.api.replication.v1.NamespaceTaskAttributes.cluster_replication_ramps:type_name -> temporal.server.api.replication.v1.NamespaceTaskAttributes.ClusterReplicationRampsEntry
	...
	4,  // 71: temporal.server.api.replication.v1.SyncReplicationState.IsolatedLaneStatesEntry.value:type_name -> temporal.server.api.replication.v1.ReplicationState
	48, // 72: temporal.server.api.replication.v1.NamespaceTaskAttributes.ClusterReplicationRampsEntry.value:type_name -> temporal.server.api.persistence.v1.NamespaceReplicationRamp
