...
// UpdateAbortedByServerFailure is used as error detail for AbortedByServer errors
// that cross service boundaries via gRPC, allowing them to be reconstructed
// as the correct Go type on the receiving side.
type UpdateAbortedByServerFailure struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *UpdateAbortedByServerFailure) Reset() {
	*x = UpdateAbortedByServerFailure{}
	mi := &file_temporal_server_api_errordetails_v1_message_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UpdateAbortedByServerFailure) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateAbortedByServerFailure) ProtoMessage() {}

func (x *UpdateAbortedByServerFailure) ProtoReflect() protoreflect.Message {
	mi := &file_temporal_server_api_errordetails_v1_message_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateAbortedByServerFailure.ProtoReflect.Descriptor instead.
func (*UpdateAbortedByServerFailure) Descriptor() ([]byte, []int) {
...
const file_temporal_server_api_errordetails_v1_message_proto_rawDesc = "" +
	...
	"$ActivityStartDuringTransitionFailure\"\x1e\n" +
	"\x1cUpdateAbortedByServerFailureB8Z6go.temporal.io/server/api/errordetails/v1;errordetailsb\x06proto3"
...
var file_temporal_server_api_errordetails_v1_message_proto_goTypes = []any{
	...
	(*UpdateAbortedByServerFailure)(nil),         // 9: temporal.server.api.errordetails.v1.UpdateAbortedByServerFailure
