...
// Marshal an object of type UpdateAbortedByServerFailure to the protobuf v3 wire format
func (val *UpdateAbortedByServerFailure) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type UpdateAbortedByServerFailure from the protobuf v3 wire format
func (val *UpdateAbortedByServerFailure) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *UpdateAbortedByServerFailure) Size() int {
	return proto.Size(val)
}

// Equal returns whether two UpdateAbortedByServerFailure values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *UpdateAbortedByServerFailure) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *UpdateAbortedByServerFailure
	switch t := that.(type) {
	case *UpdateAbortedByServerFailure:
		that1 = t
	case UpdateAbortedByServerFailure:
		that1 = &t
	default:
