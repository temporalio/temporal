...
type Config struct {
	...
	EnableActivityCancellationViaControlQueue dynamicconfig.BoolPropertyFn
...
func NewConfig(
	...
	cfg := &Config{
		...
		EnableActivityCancellationViaControlQueue: dynamicconfig.EnableActivityCancellationViaControlQueue.Get(dc),
