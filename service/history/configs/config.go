...
type Config struct {
	...
	ReplicationStreamReceiverPauseRead                  dynamicconfig.BoolPropertyFnWithShardIDFilter
...
func NewConfig(
	...
	cfg := &Config{
		...
		ReplicationStreamReceiverPauseRead:                  dynamicconfig.ReplicationStreamReceiverPauseRead.Get(dc),
