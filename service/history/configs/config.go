...
type Config struct {
	...
	EnableCHASMActivityPrototype          dynamicconfig.BoolPropertyFnWithNamespaceFilter
...
func NewConfig(
	...
	cfg := &Config{
		...
		EnableCHASMActivityPrototype: dynamicconfig.EnableCHASMActivityPrototype.Get(dc),
