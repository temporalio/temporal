...
type Config struct {
	...
	ReplicationTaskGenerationHighPriorityLockAttempts    dynamicconfig.IntPropertyFn
...
func NewConfig(
	...
	cfg := &Config{
		...
		ReplicationTaskGenerationHighPriorityLockAttempts:   dynamicconfig.ReplicationTaskGenerationHighPriorityLockAttempts.Get(dc),
