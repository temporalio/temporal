...
// Source: service/history/queues/scheduler.go
//
// Generated by this command:
//
//	mockgen -package queues -source service/history/queues/scheduler.go -destination service/history/queues/scheduler_mock.go
//
