...
// and returns the persistence proto plus the workflow key. The caller can mutate the
// returned ExecutionInfo (e.g. add TimeSkippingInfo / mark workflow completed) before
