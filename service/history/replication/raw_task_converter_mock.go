...
func (m *MockSourceTaskConverter) Convert(task tasks.Task, targetClusterID int32, priority enums.TaskPriority, workflowLockPriority locks.Priority) (*repication.ReplicationTask, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Convert", task, targetClusterID, priority, workflowLockPriority)
...
func (mr *MockSourceTaskConverterMockRecorder) Convert(task, targetClusterID, priority, workflowLockPriority any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Convert", reflect.TypeOf((*MockSourceTaskConverter)(nil).Convert), task, targetClusterID, priority, workflowLockPriority)
}
