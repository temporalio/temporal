...
// Source: service/history/replication/raw_task_converter.go
//
// Generated by this command:
//
//	mockgen -package replication -source service/history/replication/raw_task_converter.go -destination service/history/replication/raw_task_converter_mock.go
//
...
func (m *MockSourceTaskConverter) Convert(task tasks.Task, targetClusterID int32, priority enums.TaskPriority, lockPriority locks.Priority) (*repication.ReplicationTask, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Convert", task, targetClusterID, priority, lockPriority)
...
func (mr *MockSourceTaskConverterMockRecorder) Convert(task, targetClusterID, priority, lockPriority any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Convert", reflect.TypeOf((*MockSourceTaskConverter)(nil).Convert), task, targetClusterID, priority, lockPriority)
}
