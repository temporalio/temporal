...
func (e *ExecutableVerifyVersionedTransitionTask) Execute() (retErr error) {
	...
	if emitLifecycle {
		emitReplicationExecuting(e.ProcessToolBox, e.ReplicationTask(), e.WorkflowKey, wideevents.ReplTaskVerifyVersionedTransition, int32(e.Attempt()), e.SourceClusterName())
	}
