...
// Source: service/history/replication/ack_manager.go
//
// Generated by this command:
//
//	mockgen -package replication -source service/history/replication/ack_manager.go -destination service/history/replication/ack_manager_mock.go
//
...
func (m *MockAckManager) ConvertTaskByCluster(ctx context.Context, task tasks.Task, targetClusterID int32, lockPriority locks.Priority) (*repication.ReplicationTask, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ConvertTaskByCluster", ctx, task, targetClusterID, lockPriority)
	ret0, _ := ret[0].(*repication.ReplicationTask)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockAckManagerMockRecorder) ConvertTaskByCluster(ctx, task, targetClusterID, lockPriority any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ConvertTaskByCluster", reflect.TypeOf((*MockAckManager)(nil).ConvertTaskByCluster), ctx, task, targetClusterID, lockPriority)
}
