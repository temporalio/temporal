package updateactivityexecutionoptions
...
func Invoke(
	...
	// updateRequest := request.GetFrontendRequest()
...
func processActivityOptionsRequest(
	...
	updateRequest *workflowservice.UpdateActivityExecutionOptionsRequest,
	namespaceID string,
	...
	// fill the response
	response := &historyservice.UpdateActivityExecutionOptionsResponse{
...
func getActivityIDs(updateRequest *workflowservice.UpdateActivityExecutionOptionsRequest, ms historyi.MutableState) []string {
	var activityIDs []string
	// switch a := updateRequest.GetActivity().(type) {
	// case *workflowservice.UpdateActivityExecutionOptionsRequest_Id:
	// 	activityIDs = append(activityIDs, a.Id)
	// case *workflowservice.UpdateActivityExecutionOptionsRequest_Type:
	// 	activityType := a.Type
