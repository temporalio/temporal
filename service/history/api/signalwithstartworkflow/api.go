...
func Invoke(
	...
	if started {
		api.ReactivateVersionWorkflowIfPinned(ctx, shard, namespaceID, request.GetVersioningOverride(), reactivationSignalCache, reactivationSignaler, shard.GetConfig().EnableVersionReactivationSignals())
	}
