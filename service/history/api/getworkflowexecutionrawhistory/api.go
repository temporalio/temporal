...
func (deps *Deps) Invoke(
	...
	metricsHandler := interceptor.GetMetricsHandlerFromContext(ctx, deps.Logger).WithTags(metrics.OperationTag(metrics.HistoryGetWorkflowExecutionRawHistoryScope))
