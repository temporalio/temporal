...
func (m *MockChasmTree) ExecuteSideEffectDiscardTask(ctx context.Context, registry *chasm.Registry, executionKey chasm.ExecutionKey, task *tasks.ChasmTask, validate func(chasm.NodeBackend, chasm.Context, chasm.Component) error) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ExecuteSideEffectDiscardTask", ctx, registry, executionKey, task, validate)
	ret0, _ := ret[0].(error)
	return ret0
}

// ExecuteSideEffectDiscardTask indicates an expected call of ExecuteSideEffectDiscardTask.
func (mr *MockChasmTreeMockRecorder) ExecuteSideEffectDiscardTask(ctx, registry, executionKey, task, validate interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ExecuteSideEffectDiscardTask", reflect.TypeOf((*MockChasmTree)(nil).ExecuteSideEffectDiscardTask), ctx, registry, executionKey, task, validate)
}
...
func (mr *MockChasmTreeMockRecorder) ExecuteSideEffectTask(ctx, registry, executionKey, task, validate interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
