...
type (
	...
	Engine interface {
		...
		ForceWorkflowTaskTimeout(ctx context.Context, request *historyservice.ForceWorkflowTaskTimeoutRequest) (*historyservice.ForceWorkflowTaskTimeoutResponse, error)
