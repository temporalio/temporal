...
type (
	...
	Engine interface {
		...
		RenewLocalExecutionLease(ctx context.Context, request *historyservice.RenewLocalExecutionLeaseRequest) (*historyservice.RenewLocalExecutionLeaseResponse, error)
