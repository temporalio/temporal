...
type (
	...
	Engine interface {
		...
		ForceRescheduleActivity(ctx context.Context, request *historyservice.ForceRescheduleActivityRequest) (*historyservice.ForceRescheduleActivityResponse, error)
