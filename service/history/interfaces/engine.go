...
type (
	...
	Engine interface {
		...
		ReplicateVersionedTransition(ctx context.Context, artifact *replicationspb.VersionedTransitionArtifact, sourceClusterName string, limits WorkflowTaskCompletionLimits) error
