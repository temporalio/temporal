...
type (
	...
	MutableState interface {
		...
		AddWorkflowExecutionStartedEventWithOptions(*commonpb.WorkflowExecution, *historyservice.StartWorkflowExecutionRequest, *workflowpb.ResetPoints, string, string, *historypb.WorkflowExecutionStartedEventAttributes_SourceWorkflowVersioningInfo, *historypb.WorkflowExecutionStartedEventAttributes_SourceWorkflowVersioningInfo) (*historypb.HistoryEvent, error)
