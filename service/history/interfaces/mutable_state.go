...
type (
	...
	MutableState interface {
		...
		ApplyWorkflowTaskStartedEvent(*WorkflowTaskInfo, int64, int64, int64, string, time.Time, bool, int64, *commonpb.WorkerVersionStamp, int64, []enumspb.SuggestContinueAsNewReason, bool, *deploymentpb.WorkerDeploymentVersion) (*WorkflowTaskInfo, error)
