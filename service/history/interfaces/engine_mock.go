...
// Source: service/history/interfaces/engine.go
//
// Generated by this command:
//
//	mockgen -package interfaces -source service/history/interfaces/engine.go -aux_files interfaces=service/history/interfaces/replication_stream.go -imports historyservice=go.temporal.io/server/api/historyservice/v1 -destination service/history/interfaces/engine_mock.go
//
...
func (m *MockEngine) UpdateLocalExecutionState(ctx context.Context, request *historyservice.UpdateLocalExecutionStateRequest) (*historyservice.UpdateLocalExecutionStateResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateLocalExecutionState", ctx, request)
...
func (mr *MockEngineMockRecorder) UpdateLocalExecutionState(ctx, request any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateLocalExecutionState", reflect.TypeOf((*MockEngine)(nil).UpdateLocalExecutionState), ctx, request)
}
