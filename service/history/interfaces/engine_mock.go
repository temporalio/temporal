...
func (m *MockEngine) ConvertReplicationTask(ctx context.Context, task tasks.Task, clusterID int32, lockPriority locks.Priority) (*repication.ReplicationTask, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ConvertReplicationTask", ctx, task, clusterID, lockPriority)
...
func (mr *MockEngineMockRecorder) ConvertReplicationTask(ctx, task, clusterID, lockPriority any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ConvertReplicationTask", reflect.TypeOf((*MockEngine)(nil).ConvertReplicationTask), ctx, task, clusterID, lockPriority)
}
