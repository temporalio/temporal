...
//
//	mockgen -package interfaces -source service/history/interfaces/engine.go -destination service/history/interfaces/engine_mock.go
//
...
func (m *MockEngine) ForceWorkflowTaskTimeout(ctx context.Context, request *historyservice.ForceWorkflowTaskTimeoutRequest) (*historyservice.ForceWorkflowTaskTimeoutResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ForceWorkflowTaskTimeout", ctx, request)
...
func (mr *MockEngineMockRecorder) ForceWorkflowTaskTimeout(ctx, request any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ForceWorkflowTaskTimeout", reflect.TypeOf((*MockEngine)(nil).ForceWorkflowTaskTimeout), ctx, request)
}
