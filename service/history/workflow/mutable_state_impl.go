...
func (ms *MutableStateImpl) AddCancelActivityNexusTasks(scheduledEventIDs []int64, controlQueue string) error {
	return ms.taskGenerator.GenerateCancelActivityNexusTasks(scheduledEventIDs, controlQueue)
}
