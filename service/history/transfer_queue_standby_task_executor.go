...
func (t *transferQueueStandbyTaskExecutor) processParentClosePolicyTask(
	...
	// has been terminated/cancelled. Since the parent workflow is already closed
	// (that's why this task was generated), we process with closed workflow.
...
func (t *transferQueueStandbyTaskExecutor) verifyChildPolicyApplied(
	...
	case *serviceerror.NotFound, *serviceerror.NamespaceNotFound:
		// Child workflow or namespace is deleted - nothing to do.
		return nil, nil
	case *serviceerror.Unimplemented:
		// Cross-cluster call not implemented, skip verification.
		return nil, nil
	default:
