...
func (s *ContextImpl) renewRangeLocked(isStealing bool) error {
	...
	updatedShardInfo := trimShardInfo(s.clusterMetadata.GetAllClusterInfo(), s.copyShardInfo(s.shardInfo))
	...
	s.shardInfo = trimShardInfo(s.clusterMetadata.GetAllClusterInfo(), s.copyShardInfo(updatedShardInfo))
...
func (s *ContextImpl) emitShardInfoMetricsLogs() {
	...
	queueStates := trimShardInfo(s.clusterMetadata.GetAllClusterInfo(), s.copyShardInfo(s.shardInfo)).QueueStates
