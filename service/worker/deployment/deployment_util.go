...
func escapeChar(s string) string {
	s = strings.ReplaceAll(s, DeploymentWorkflowIDEscape, DeploymentWorkflowIDEscape+DeploymentWorkflowIDEscape)
	s = strings.ReplaceAll(s, DeploymentWorkflowIDDelimeter, DeploymentWorkflowIDEscape+DeploymentWorkflowIDDelimeter)
	return s
}
