...
func NewConfig(
	...
	config := &Config{
		...
		ScannerCfg: &scanner.Config{
			...
			ScheduleInvariantsScannerOverdueNextActionTimeEnabled:      dynamicconfig.ScheduleInvariantsScannerOverdueNextActionTimeEnabled.Get(dc),
			...
			ScheduleInvariantsScannerScanInterval:                      dynamicconfig.ScheduleInvariantsScannerScanInterval.Get(dc),
			ScheduleInvariantsScannerStuckOpenIdleTimeBufferMultiplier: dynamicconfig.ScheduleInvariantsScannerStuckOpenIdleTimeBufferMultiplier.Get(dc),
		},
