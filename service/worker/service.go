...
func NewConfig(
	...
	config := &Config{
		...
		ScannerCfg: &scanner.Config{
			...
			HistoryScannerPerShardQPS:               dynamicconfig.HistoryScannerPerShardQPS.Get(dc),
			TaskQueueScannerPerHostQPS:              dynamicconfig.TaskQueueScannerPerHostQPS.Get(dc),
			TaskQueueScannerPerShardQPS:             dynamicconfig.TaskQueueScannerPerShardQPS.Get(dc),
			BuildIdScavengerPerHostQPS:              dynamicconfig.BuildIdScavengerPerHostQPS.Get(dc),
			BuildIdScavengerPerShardQPS:             dynamicconfig.BuildIdScavengerPerShardQPS.Get(dc),
