...
```
cadence --do sample namespace register --gd true --ac active --cl active standby
```
...
Failover to standby:
```
cadence --do sample namespace update --ac standby
```
Failback to active:
```
cadence --do sample namespace update --ac active
```
