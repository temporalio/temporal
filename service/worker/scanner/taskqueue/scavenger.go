...
func NewScavenger(db p.TaskManager, metricsHandler metrics.Handler, logger log.Logger, perHostQPS dynamicconfig.IntPropertyFn, perShardQPS dynamicconfig.IntPropertyFn, maxQPS dynamicconfig.IntPropertyFn) *Scavenger {
