...
type (
	...
	Activities struct {
		...
		persistencePerShardQPS               dynamicconfig.IntPropertyFn
...
func NewActivities(
	...
	return &Activities{
		...
		persistencePerShardQPS:               persistencePerShardQPS,
