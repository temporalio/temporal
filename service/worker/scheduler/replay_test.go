...
// TestEveryRecordedVersionIsMapped checks every version through the current recorded default maps
// to a server release whose snapshot is present. Raising the default requires adding its fixture.
func TestEveryRecordedVersionIsMapped(t *testing.T) {
