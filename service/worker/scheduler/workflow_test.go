...
// a custom version ceiling), sharing the same setup and StartScheduleArgs.
...
func (s *workflowSuite) TestMigrateDynamicConfig() {
	...
	s.env.SetStartTime(baseStartTime)
	s.env.ExecuteWorkflow(func(ctx workflow.Context, args *schedulespb.StartScheduleArgs) error {
		return schedulerWorkflowWithSpecBuilder(ctx, args, newSpecBuilderForTest(0, 0), func() bool { return true }, func() bool { return true }, func() int { return -1 })
	}, &schedulespb.StartScheduleArgs{
		Schedule: &schedulepb.Schedule{
			Spec: &schedulepb.ScheduleSpec{
				Interval: []*schedulepb.IntervalSpec{{
...
func (s *workflowSuite) TestMigrateDynamicConfigFlipsMidRun() {
	...
	s.env.SetStartTime(baseStartTime)
	s.env.ExecuteWorkflow(func(ctx workflow.Context, args *schedulespb.StartScheduleArgs) error {
		return schedulerWorkflowWithSpecBuilder(ctx, args, newSpecBuilderForTest(0, 0), func() bool { return enabled }, func() bool { return true }, func() int { return -1 })
	}, &schedulespb.StartScheduleArgs{
		Schedule: &schedulepb.Schedule{
			Spec: &schedulepb.ScheduleSpec{
				Interval: []*schedulepb.IntervalSpec{{
