...
// Source: service/matching/physical_task_queue_manager_interface.go
//
// Generated by this command:
//
//	mockgen -package matching -source service/matching/physical_task_queue_manager_interface.go -destination service/matching/physical_task_queue_manager_mock.go
//
...
func (m *MockphysicalTaskQueueManager) MakePollerScalingDecision(ctx context.Context, pollMetadata *pollMetadata, taskSource enums0.TaskSource) *taskqueue.PollerScalingDecision {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "MakePollerScalingDecision", ctx, pollMetadata, taskSource)
...
func (mr *MockphysicalTaskQueueManagerMockRecorder) MakePollerScalingDecision(ctx, pollMetadata, taskSource any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MakePollerScalingDecision", reflect.TypeOf((*MockphysicalTaskQueueManager)(nil).MakePollerScalingDecision), ctx, pollMetadata, taskSource)
}
