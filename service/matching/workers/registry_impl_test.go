...
func TestUpdateAndListNamespace(t *testing.T) {
	...
	m.upsertHeartbeats("ns1", "ns1", nil /* principal */, []*workerpb.WorkerHeartbeat{hb1, hb2})
...
func TestShutdownStatusRemovesWorker(t *testing.T) {
	...
	m.upsertHeartbeats("ns1", "ns1", nil /* principal */, []*workerpb.WorkerHeartbeat{hbShutdown})
...
func TestShutdownStatusForNonExistentWorker(t *testing.T) {
	...
	m.upsertHeartbeats("ns1", "ns1", nil /* principal */, []*workerpb.WorkerHeartbeat{hb})
...
func TestListNamespacePredicate(t *testing.T) {
	...
	for i := 1; i <= 5; i++ {
		...
		m.upsertHeartbeats("ns", "ns", nil /* principal */, []*workerpb.WorkerHeartbeat{hb})
	}
...
func TestFilterWorkersExcludesSystemWorkers(t *testing.T) {
	...
	m.upsertHeartbeats("ns", "ns", nil /* principal */, []*workerpb.WorkerHeartbeat{
...
func TestIsSystemWorker(t *testing.T) {
	t.Run("principal with type temporal marks as system worker", func(t *testing.T) {
		...
		m.upsertHeartbeats("ns", "ns", principal, []*workerpb.WorkerHeartbeat{
...
func TestEvictByTTL(t *testing.T) {
	...
	b := m.getBucket("ns")
	e := b.namespaces["ns"].workers[hb.WorkerInstanceKey]
...
func TestMultipleNamespaces(t *testing.T) {
	...
	m.upsertHeartbeats("namespace1", "namespace1", nil /* principal */, ns1Workers)
	...
	m.upsertHeartbeats("namespace2", "namespace2", nil /* principal */, ns2Workers)
...
func BenchmarkUpdate(b *testing.B) {
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		m.upsertHeartbeats("benchNs", "benchNs", nil /* principal */, []*workerpb.WorkerHeartbeat{hb})
	}
}
...
func BenchmarkRandomUpdate(b *testing.B) {
	...
	for _, ns := range namespaces {
		for i := range totalHeartbeats {
			...
			hb := &workerpb.WorkerHeartbeat{WorkerInstanceKey: key, CurrentStickyCacheSize: int32(i)}
			m.upsertHeartbeats(ns, namespace.Name(ns), nil /* principal */, []*workerpb.WorkerHeartbeat{hb})
	...
	for i := 0; i < b.N; i++ {
		...
		m.upsertHeartbeats(p.ns, namespace.Name(p.ns), nil /* principal */, []*workerpb.WorkerHeartbeat{p.hb})
	}
}
