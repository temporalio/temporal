...
func (wh *WorkflowHandler) scheduleSentinelsEnabled(namespace string) bool {
	return wh.config.EnableChasm(namespace) && wh.config.EnableCHASMSchedulerSentinels(namespace)
}
