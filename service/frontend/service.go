...
type Config struct {
	...
	TimeSkippingMaxFastForward              dynamicconfig.DurationPropertyFnWithNamespaceFilter
...
func NewConfig(
	...
	return &Config{
		...
		TimeSkippingMaxFastForward:              dynamicconfig.TimeSkippingMaxFastForward.Get(dc),
