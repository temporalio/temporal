...
type Config struct {
	...
	EnableExperimentalAPIExample   dynamicconfig.BoolPropertyFnWithNamespaceFilter
...
func NewConfig(
	...
	return &Config{
		...
		EnableExperimentalAPIExample:   dynamicconfig.FrontendEnableExperimentalAPIExample.Get(dc),
