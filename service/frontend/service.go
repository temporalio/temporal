...
type Config struct {
	...
	WorkflowTimeSkippingDefaultMaxSkipCount dynamicconfig.IntPropertyFnWithNamespaceFilter
...
func NewConfig(
	...
	return &Config{
		...
		WorkflowTimeSkippingDefaultMaxSkipCount: dynamicconfig.WorkflowTimeSkippingDefaultMaxSkipCount.Get(dc),
