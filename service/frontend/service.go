...
type Config struct {
	...
	ScheduleV2TimeSkippingEnabled           dynamicconfig.BoolPropertyFnWithNamespaceFilter
...
func NewConfig(
	...
	return &Config{
		...
		ScheduleV2TimeSkippingEnabled:           dynamicconfig.ScheduleV2TimeSkippingEnabled.Get(dc),
