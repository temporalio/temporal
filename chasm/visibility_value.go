...
func (v VisibilityValueInt) MustEncode() *commonpb.Payload {
	...
	defs.SetMetadataType(p, enumspb.INDEXED_VALUE_TYPE_INT)
	return p
}
...
func (v VisibilityValueString) MustEncode() *commonpb.Payload {
	...
	defs.SetMetadataType(p, enumspb.INDEXED_VALUE_TYPE_KEYWORD)
	return p
}
...
func (v VisibilityValueBool) MustEncode() *commonpb.Payload {
	...
	defs.SetMetadataType(p, enumspb.INDEXED_VALUE_TYPE_BOOL)
	return p
}
...
func (v VisibilityValueFloat64) MustEncode() *commonpb.Payload {
	...
	defs.SetMetadataType(p, enumspb.INDEXED_VALUE_TYPE_DOUBLE)
	return p
}
...
func (v VisibilityValueTime) MustEncode() *commonpb.Payload {
	...
	defs.SetMetadataType(p, enumspb.INDEXED_VALUE_TYPE_DATETIME)
	return p
}
...
func (v VisibilityValueStringSlice) MustEncode() *commonpb.Payload {
	...
	defs.SetMetadataType(p, enumspb.INDEXED_VALUE_TYPE_KEYWORD_LIST)
	return p
}
