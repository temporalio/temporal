...
func TestActivityIsDispatchTaskValid(t *testing.T) {
	...
	testCases := []struct {
		...
		{name: "scheduled current attempt", status: activitypb.ACTIVITY_EXECUTION_STATUS_SCHEDULED, stamp: currentStamp, valid: true},
		{name: "scheduled obsolete attempt", status: activitypb.ACTIVITY_EXECUTION_STATUS_SCHEDULED, stamp: currentStamp - 1, valid: false},
		{name: "scheduled future attempt", status: activitypb.ACTIVITY_EXECUTION_STATUS_SCHEDULED, stamp: currentStamp + 1, valid: false},
		{name: "started", status: activitypb.ACTIVITY_EXECUTION_STATUS_STARTED, stamp: currentStamp, valid: false},
		{name: "paused", status: activitypb.ACTIVITY_EXECUTION_STATUS_PAUSED, stamp: currentStamp, valid: false},
		{name: "completed", status: activitypb.ACTIVITY_EXECUTION_STATUS_COMPLETED, stamp: currentStamp, valid: false},
	}
