...
type ActivityAttemptState struct {
	...
	LastCompleteTime *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=last_complete_time,json=lastCompleteTime,proto3" json:"last_complete_time,omitempty"`
...
func (x *ActivityAttemptState) GetLastCompleteTime() *timestamppb.Timestamp {
	if x != nil {
		return x.LastCompleteTime
	}
	return nil
}
...
const file_temporal_server_chasm_lib_activity_proto_v1_activity_state_proto_rawDesc = "" +
	...
	"\x06reason\x18\x04 \x01(\tR\x06reason\"\xba\x05\n" +
	...
	"\x11last_started_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\x0flastStartedTime\x12H\n" +
	"\x12last_complete_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\x10lastCompleteTime\x12\x86\x01\n" +
...
var file_temporal_server_chasm_lib_activity_proto_v1_activity_state_proto_depIdxs = []int32{
	...
	14, // 14: temporal.server.chasm.lib.activity.proto.v1.ActivityAttemptState.last_complete_time:type_name -> google.protobuf.Timestamp
