...
type ActivityState struct {
	...
	// completion via a worker callback). Set by server-internal callers only; surfaced read-only on
	// PollActivityTaskQueueResponse.
	InvocationSource *v12.ActivityInvocationSource `protobuf:"bytes,14,opt,name=invocation_source,json=invocationSource,proto3" json:"invocation_source,omitempty"`
...
func (x *ActivityState) GetInvocationSource() *v12.ActivityInvocationSource {
	if x != nil {
...
const file_temporal_server_chasm_lib_activity_proto_v1_activity_state_proto_rawDesc = "" +
	"\n" +
	"@temporal/server/chasm/lib/activity/proto/v1/activity_state.proto\x12+temporal.server.chasm.lib.activity.proto.v1\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a$temporal/api/common/v1/message.proto\x1a(temporal/api/deployment/v1/message.proto\x1a%temporal/api/failure/v1/message.proto\x1a'temporal/api/sdk/v1/user_metadata.proto\x1a'temporal/api/taskqueue/v1/message.proto\x1a&temporal/api/activity/v1/message.proto\"\xf8\b\n" +
	"\rActivityState\x12I\n" +
	...
	"startDelay\x12_\n" +
	"\x11invocation_source\x18\x0e \x01(\v22.temporal.api.activity.v1.ActivityInvocationSourceR\x10invocationSource\"\xa7\x01\n" +
...
var file_temporal_server_chasm_lib_activity_proto_v1_activity_state_proto_goTypes = []any{
	...
	(*v12.ActivityInvocationSource)(nil),            // 17: temporal.api.activity.v1.ActivityInvocationSource
...
var file_temporal_server_chasm_lib_activity_proto_v1_activity_state_proto_depIdxs = []int32{
	...
	17, // 13: temporal.server.chasm.lib.activity.proto.v1.ActivityState.invocation_source:type_name -> temporal.api.activity.v1.ActivityInvocationSource
	15, // 14: temporal.server.chasm.lib.activity.proto.v1.ActivityCancelState.request_time:type_name -> google.protobuf.Timestamp
	13, // 15: temporal.server.chasm.lib.activity.proto.v1.ActivityAttemptState.current_retry_interval:type_name -> google.protobuf.Duration
	15, // 16: temporal.server.chasm.lib.activity.proto.v1.ActivityAttemptState.started_time:type_name -> google.protobuf.Timestamp
	15, // 17: temporal.server.chasm.lib.activity.proto.v1.ActivityAttemptState.complete_time:type_name -> google.protobuf.Timestamp
	8,  // 18: temporal.server.chasm.lib.activity.proto.v1.ActivityAttemptState.last_failure_details:type_name -> temporal.server.chasm.lib.activity.proto.v1.ActivityAttemptState.LastFailureDetails
	...
	15, // 21: temporal.server.chasm.lib.activity.proto.v1.ActivityHeartbeatState.recorded_time:type_name -> google.protobuf.Timestamp
