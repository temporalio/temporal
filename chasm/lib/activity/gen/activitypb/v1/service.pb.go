...
const file_temporal_server_chasm_lib_activity_proto_v1_service_proto_rawDesc = "" +
	...
	"\x1aTerminateActivityExecution\x12N.temporal.server.chasm.lib.activity.proto.v1.TerminateActivityExecutionRequest\x1aO.temporal.server.chasm.lib.activity.proto.v1.TerminateActivityExecutionResponse\"\"\x92\xc4\x03\x1e\x1a\x1cfrontend_request.activity_idBDZBgo.temporal.io/server/chasm/lib/activity/gen/activitypb;activitypbb\x06proto3"
...
var file_temporal_server_chasm_lib_activity_proto_v1_service_proto_goTypes = []any{
	...
	(*PollActivityExecutionResponse)(nil),      // 4: temporal.server.chasm.lib.activity.proto.v1.PollActivityExecutionResponse
...
var file_temporal_server_chasm_lib_activity_proto_v1_service_proto_depIdxs = []int32{
	...
	4, // 4: temporal.server.chasm.lib.activity.proto.v1.ActivityService.PollActivityExecution:output_type -> temporal.server.chasm.lib.activity.proto.v1.PollActivityExecutionResponse
	5, // 5: temporal.server.chasm.lib.activity.proto.v1.ActivityService.TerminateActivityExecution:output_type -> temporal.server.chasm.lib.activity.proto.v1.TerminateActivityExecutionResponse
