...
// Marshal an object of type CancelCommandDispatchTask to the protobuf v3 wire format
func (val *CancelCommandDispatchTask) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type CancelCommandDispatchTask from the protobuf v3 wire format
func (val *CancelCommandDispatchTask) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *CancelCommandDispatchTask) Size() int {
	return proto.Size(val)
}

// Equal returns whether two CancelCommandDispatchTask values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *CancelCommandDispatchTask) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *CancelCommandDispatchTask
	switch t := that.(type) {
	case *CancelCommandDispatchTask:
		that1 = t
	case CancelCommandDispatchTask:
		that1 = &t
	default:
