...
type ActivityStartExecuteTask struct {
	...
	// ActivityState activity_state = 1;
...
func (x *ActivityStartExecuteTask) GetTest() string {
	if x != nil {
		return x.Test
	}
	return ""
...
const file_temporal_server_chasm_lib_activity_proto_v1_tasks_proto_rawDesc = "" +
	...
	"\x18ActivityStartExecuteTask\x12\x12\n" +
	"\x04test\x18\x01 \x01(\tR\x04testBDZBgo.temporal.io/server/chasm/lib/activity/gen/activitypb;activitypbb\x06proto3"
