...
const file_temporal_server_chasm_lib_activity_proto_v1_tasks_proto_rawDesc = "" +
	"\n" +
	"7temporal/server/chasm/lib/activity/proto/v1/tasks.proto\x12+temporal.server.chasm.lib.activity.proto.v1\"\x1a\n" +
	"\x18ActivityStartExecuteTaskBDZBgo.temporal.io/server/chasm/lib/activity/gen/activitypb;activitypbb\x06proto3"
