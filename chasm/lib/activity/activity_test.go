...
// TestMultipleCallbacks confirms each callback gets its own outcome, rather than one being applied
// to all of them. Outcome itself is covered by the callback package.
