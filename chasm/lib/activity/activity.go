...
// with (Reset(RestoreOriginalOptions)) and re-arms the ScheduleToClose timer at the resulting
// deadline. start_delay is restored only if the activity has never started, since it governs the
// first dispatch alone.
