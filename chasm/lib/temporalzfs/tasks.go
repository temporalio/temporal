...
func (e *chunkGCTaskExecutor) Execute(
	...
	fs *Filesystem,
	_ chasm.TaskAttributes,
	task *temporalzfspb.ChunkGCTask,
) error {
...
func (e *manifestCompactTaskExecutor) Validate(
	...
	fs *Filesystem,
	_ chasm.TaskAttributes,
	_ *temporalzfspb.ManifestCompactTask,
) (bool, error) {
	return fs.Status == temporalzfspb.FILESYSTEM_STATUS_RUNNING, nil
}
...
func (e *quotaCheckTaskExecutor) Validate(
	...
	fs *Filesystem,
	_ chasm.TaskAttributes,
	_ *temporalzfspb.QuotaCheckTask,
) (bool, error) {
	return fs.Status == temporalzfspb.FILESYSTEM_STATUS_RUNNING, nil
}
...
func (e *ownerCheckTaskExecutor) Validate(
	...
	fs *Filesystem,
	_ chasm.TaskAttributes,
	_ *temporalzfspb.OwnerCheckTask,
) (bool, error) {
	return fs.Status == temporalzfspb.FILESYSTEM_STATUS_RUNNING && len(fs.OwnerWorkflowIds) > 0, nil
}
...
func (e *ownerCheckTaskExecutor) Execute(
	...
	fs *Filesystem,
	_ chasm.TaskAttributes,
	task *temporalzfspb.OwnerCheckTask,
) error {
	key := ctx.ExecutionKey()
...
func (e *dataCleanupTaskExecutor) Validate(
	...
	fs *Filesystem,
	_ chasm.TaskAttributes,
	_ *temporalzfspb.DataCleanupTask,
) (bool, error) {
	return fs.Status == temporalzfspb.FILESYSTEM_STATUS_DELETED, nil
}
...
func (e *dataCleanupTaskExecutor) Execute(
	...
	_ chasm.TaskAttributes,
	task *temporalzfspb.DataCleanupTask,
) error {
