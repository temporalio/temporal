...
// Marshal an object of type SchedulerMigrateToV1Task to the protobuf v3 wire format
func (val *SchedulerMigrateToV1Task) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type SchedulerMigrateToV1Task from the protobuf v3 wire format
func (val *SchedulerMigrateToV1Task) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *SchedulerMigrateToV1Task) Size() int {
	return proto.Size(val)
}

// Equal returns whether two SchedulerMigrateToV1Task values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *SchedulerMigrateToV1Task) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *SchedulerMigrateToV1Task
	switch t := that.(type) {
	case *SchedulerMigrateToV1Task:
		that1 = t
	case SchedulerMigrateToV1Task:
		that1 = &t
	default:
