...
const file_temporal_server_chasm_lib_scheduler_proto_v1_service_proto_rawDesc = "" +
	"\n" +
	":temporal/server/chasm/lib/scheduler/proto/v1/service.proto\x12,temporal.server.chasm.lib.scheduler.proto.v1\x1aCtemporal/server/chasm/lib/scheduler/proto/v1/request_response.proto\x1a.temporal/server/api/routing/v1/extension.proto2\x8c\v\n" +
	...
	"\x19ListScheduleMatchingTimes\x12N.temporal.server.chasm.lib.scheduler.proto.v1.ListScheduleMatchingTimesRequest\x1aO.temporal.server.chasm.lib.scheduler.proto.v1.ListScheduleMatchingTimesResponse\"\"\x92\xc4\x03\x1e\x1a\x1cfrontend_request.schedule_id\x12\xc7\x01\n" +
	"\x0fMigrateSchedule\x12D.temporal.server.chasm.lib.scheduler.proto.v1.MigrateScheduleRequest\x1aE.temporal.server.chasm.lib.scheduler.proto.v1.MigrateScheduleResponse\"'\x92\xc4\x03#\x1a!state.scheduler_state.schedule_idBGZEgo.temporal.io/server/chasm/lib/scheduler/gen/schedulerpb;schedulerpbb\x06proto3"
