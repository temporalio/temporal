...
const file_temporal_server_chasm_lib_scheduler_proto_v1_service_proto_rawDesc = "" +
	"\n" +
	":temporal/server/chasm/lib/scheduler/proto/v1/service.proto\x12,temporal.server.chasm.lib.scheduler.proto.v1\x1aCtemporal/server/chasm/lib/scheduler/proto/v1/request_response.proto\x1a.temporal/server/api/routing/v1/extension.proto\x1a0temporal/server/api/common/v1/api_category.proto2\xfc\f\n" +
	...
	"\x0eCreateSentinel\x12C.temporal.server.chasm.lib.scheduler.proto.v1.CreateSentinelRequest\x1aD.temporal.server.chasm.lib.scheduler.proto.v1.CreateSentinelResponse\"\x11\x92\xc4\x03\r\x1a\vschedule_idBGZEgo.temporal.io/server/chasm/lib/scheduler/gen/schedulerpb;schedulerpbb\x06proto3"
...
var file_temporal_server_chasm_lib_scheduler_proto_v1_service_proto_depIdxs = []int32{
	...
	15, // 15: temporal.server.chasm.lib.scheduler.proto.v1.SchedulerService.CreateSentinel:output_type -> temporal.server.chasm.lib.scheduler.proto.v1.CreateSentinelResponse
