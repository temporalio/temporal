...
var File_temporal_server_chasm_lib_temporalfs_proto_v1_service_proto protoreflect.FileDescriptor
...
var file_temporal_server_chasm_lib_temporalfs_proto_v1_service_proto_goTypes = []any{
	...
	(*GetFilesystemInfoRequest)(nil),  // 1: temporal.server.chasm.lib.temporalfs.proto.v1.GetFilesystemInfoRequest
	(*ArchiveFilesystemRequest)(nil),  // 2: temporal.server.chasm.lib.temporalfs.proto.v1.ArchiveFilesystemRequest
	(*LookupRequest)(nil),             // 3: temporal.server.chasm.lib.temporalfs.proto.v1.LookupRequest
	(*GetattrRequest)(nil),            // 4: temporal.server.chasm.lib.temporalfs.proto.v1.GetattrRequest
	(*SetattrRequest)(nil),            // 5: temporal.server.chasm.lib.temporalfs.proto.v1.SetattrRequest
	(*ReadChunksRequest)(nil),         // 6: temporal.server.chasm.lib.temporalfs.proto.v1.ReadChunksRequest
	(*WriteChunksRequest)(nil),        // 7: temporal.server.chasm.lib.temporalfs.proto.v1.WriteChunksRequest
	(*TruncateRequest)(nil),           // 8: temporal.server.chasm.lib.temporalfs.proto.v1.TruncateRequest
	(*MkdirRequest)(nil),              // 9: temporal.server.chasm.lib.temporalfs.proto.v1.MkdirRequest
	(*UnlinkRequest)(nil),             // 10: temporal.server.chasm.lib.temporalfs.proto.v1.UnlinkRequest
	(*RmdirRequest)(nil),              // 11: temporal.server.chasm.lib.temporalfs.proto.v1.RmdirRequest
	(*RenameRequest)(nil),             // 12: temporal.server.chasm.lib.temporalfs.proto.v1.RenameRequest
	(*ReadDirRequest)(nil),            // 13: temporal.server.chasm.lib.temporalfs.proto.v1.ReadDirRequest
	(*LinkRequest)(nil),               // 14: temporal.server.chasm.lib.temporalfs.proto.v1.LinkRequest
	(*SymlinkRequest)(nil),            // 15: temporal.server.chasm.lib.temporalfs.proto.v1.SymlinkRequest
	(*ReadlinkRequest)(nil),           // 16: temporal.server.chasm.lib.temporalfs.proto.v1.ReadlinkRequest
	(*CreateFileRequest)(nil),         // 17: temporal.server.chasm.lib.temporalfs.proto.v1.CreateFileRequest
...
var file_temporal_server_chasm_lib_temporalfs_proto_v1_service_proto_depIdxs = []int32{
	...
	1,  // 1: temporal.server.chasm.lib.temporalfs.proto.v1.TemporalFSService.GetFilesystemInfo:input_type -> temporal.server.chasm.lib.temporalfs.proto.v1.GetFilesystemInfoRequest
	2,  // 2: temporal.server.chasm.lib.temporalfs.proto.v1.TemporalFSService.ArchiveFilesystem:input_type -> temporal.server.chasm.lib.temporalfs.proto.v1.ArchiveFilesystemRequest
	3,  // 3: temporal.server.chasm.lib.temporalfs.proto.v1.TemporalFSService.Lookup:input_type -> temporal.server.chasm.lib.temporalfs.proto.v1.LookupRequest
	4,  // 4: temporal.server.chasm.lib.temporalfs.proto.v1.TemporalFSService.Getattr:input_type -> temporal.server.chasm.lib.temporalfs.proto.v1.GetattrRequest
	5,  // 5: temporal.server.chasm.lib.temporalfs.proto.v1.TemporalFSService.Setattr:input_type -> temporal.server.chasm.lib.temporalfs.proto.v1.SetattrRequest
	6,  // 6: temporal.server.chasm.lib.temporalfs.proto.v1.TemporalFSService.ReadChunks:input_type -> temporal.server.chasm.lib.temporalfs.proto.v1.ReadChunksRequest
	7,  // 7: temporal.server.chasm.lib.temporalfs.proto.v1.TemporalFSService.WriteChunks:input_type -> temporal.server.chasm.lib.temporalfs.proto.v1.WriteChunksRequest
	8,  // 8: temporal.server.chasm.lib.temporalfs.proto.v1.TemporalFSService.Truncate:input_type -> temporal.server.chasm.lib.temporalfs.proto.v1.TruncateRequest
	9,  // 9: temporal.server.chasm.lib.temporalfs.proto.v1.TemporalFSService.Mkdir:input_type -> temporal.server.chasm.lib.temporalfs.proto.v1.MkdirRequest
	10, // 10: temporal.server.chasm.lib.temporalfs.proto.v1.TemporalFSService.Unlink:input_type -> temporal.server.chasm.lib.temporalfs.proto.v1.UnlinkRequest
	11, // 11: temporal.server.chasm.lib.temporalfs.proto.v1.TemporalFSService.Rmdir:input_type -> temporal.server.chasm.lib.temporalfs.proto.v1.RmdirRequest
	12, // 12: temporal.server.chasm.lib.temporalfs.proto.v1.TemporalFSService.Rename:input_type -> temporal.server.chasm.lib.temporalfs.proto.v1.RenameRequest
	13, // 13: temporal.server.chasm.lib.temporalfs.proto.v1.TemporalFSService.ReadDir:input_type -> temporal.server.chasm.lib.temporalfs.proto.v1.ReadDirRequest
	14, // 14: temporal.server.chasm.lib.temporalfs.proto.v1.TemporalFSService.Link:input_type -> temporal.server.chasm.lib.temporalfs.proto.v1.LinkRequest
	15, // 15: temporal.server.chasm.lib.temporalfs.proto.v1.TemporalFSService.Symlink:input_type -> temporal.server.chasm.lib.temporalfs.proto.v1.SymlinkRequest
	16, // 16: temporal.server.chasm.lib.temporalfs.proto.v1.TemporalFSService.Readlink:input_type -> temporal.server.chasm.lib.temporalfs.proto.v1.ReadlinkRequest
	17, // 17: temporal.server.chasm.lib.temporalfs.proto.v1.TemporalFSService.CreateFile:input_type -> temporal.server.chasm.lib.temporalfs.proto.v1.CreateFileRequest
...
func init() { file_temporal_server_chasm_lib_temporalfs_proto_v1_service_proto_init() }
func file_temporal_server_chasm_lib_temporalfs_proto_v1_service_proto_init() {
	if File_temporal_server_chasm_lib_temporalfs_proto_v1_service_proto != nil {
		return
	}
	file_temporal_server_chasm_lib_temporalfs_proto_v1_request_response_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_temporal_server_chasm_lib_temporalfs_proto_v1_service_proto_rawDesc), len(file_temporal_server_chasm_lib_temporalfs_proto_v1_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_temporal_server_chasm_lib_temporalfs_proto_v1_service_proto_goTypes,
		DependencyIndexes: file_temporal_server_chasm_lib_temporalfs_proto_v1_service_proto_depIdxs,
	}.Build()
	File_temporal_server_chasm_lib_temporalfs_proto_v1_service_proto = out.File
	file_temporal_server_chasm_lib_temporalfs_proto_v1_service_proto_goTypes = nil
	file_temporal_server_chasm_lib_temporalfs_proto_v1_service_proto_depIdxs = nil
}
