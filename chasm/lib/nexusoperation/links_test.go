...
func TestNewStandaloneOperationAttachesLinks(t *testing.T) {
	...
	t.Run("WithLinks", func(t *testing.T) {
		...
		op, err := newStandaloneOperation(ctx, newStartReq(link), newTestCallbackValidator(t, 10), newTestLinkValidator(10, 10))
	...
	t.Run("RejectsAnInvalidLink", func(t *testing.T) {
		...
		_, err := newStandaloneOperation(ctx, newStartReq(invalid), newTestCallbackValidator(t, 10), newTestLinkValidator(10, 10))
