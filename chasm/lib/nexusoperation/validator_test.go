...
// newTestCallbackValidator returns a callback.Validator that accepts any well-formed callback, so
// that tests here exercise this package's validation rather than callback.Validator's.
