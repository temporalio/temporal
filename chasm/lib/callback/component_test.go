...
// TODO(chrsmith): Fix this. Previously there was an `outcome(...)` method that returned the callback's
// outcome, which was a distinct proto type. But now we just have setResusetCallbackInfoResult(...)
//
