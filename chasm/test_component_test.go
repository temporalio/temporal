...
func (tc *TestComponent) Complete(_ MutableContext) {
	tc.ComponentData.SetStatus(enumspb.WORKFLOW_EXECUTION_STATUS_COMPLETED)
}

func (tc *TestComponent) Fail(_ MutableContext) {
	tc.ComponentData.SetStatus(enumspb.WORKFLOW_EXECUTION_STATUS_FAILED)
}
...
func testComponentSerializedNodes() map[string]*persistencespb.ChasmNode {
	serializedNodes := map[string]*persistencespb.ChasmNode{
		...
		"SubComponent1/SubData11": persistencespb.ChasmNode_builder{
			Metadata: persistencespb.ChasmNodeMetadata_builder{
				InitialVersionedTransition: persistencespb.VersionedTransition_builder{
					NamespaceFailoverVersion: 1,
					TransitionCount:          1,
		...
		"SubData1": persistencespb.ChasmNode_builder{
			Metadata: persistencespb.ChasmNodeMetadata_builder{
				InitialVersionedTransition: persistencespb.VersionedTransition_builder{
					NamespaceFailoverVersion: 1,
					TransitionCount:          1,
