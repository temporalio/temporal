...
// by the server implements dynamicconfig.ClientWithConfigValueMap.
func TestServerOptionsProviderDynamicConfigClient(t *testing.T) {
	...
	require.Implements(t, (*dynamicconfig.ClientWithConfigValueMap)(nil), provider.DynamicConfigClient)
}
