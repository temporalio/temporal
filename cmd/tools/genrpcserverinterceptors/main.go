...
func main() {
	...
	for _, grpcServerT := range grpcServers {
		callWithFile(generateWorkflowTagGetters, grpcServerT, *outPathFlag)
	}
}
...
func callWithFile(generator func(io.Writer, reflect.Type), server reflect.Type, outPath string) {
