...
#### 5. Change your workflow and define your next versioned worker

#### 6. Deploy your new versioned worker

#### 7. Send 10% of new tasks to your new versioned worker

#### 8. Monitor workflows running on the new version and confirm success

#### 9. Commit the new version

#### 10. Wait until the previous version is no longer reachable

#### 11. Decommission the previous versioned worker
