...
> Note: it is possible to run Temporal server without docker. If for some reason (for example, performance on macOS)
> you want to run dependencies on the host OS, please follow the [doc](dvelop/run_dependencies_host.md).
