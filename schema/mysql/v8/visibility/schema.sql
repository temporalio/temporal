...
CREATE INDEX by_temporal_fairness_key ON executions_visibility (namespace_id, TemporalFairnessKey, (COALESCE(close_time, CAST('9999-12-31 23:59:59' AS DATETIME))) DESC, start_time DESC, run_id);
