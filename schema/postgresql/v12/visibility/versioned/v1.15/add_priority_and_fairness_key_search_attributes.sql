...
CREATE INDEX by_temporal_fairness_key ON executions_visibility (namespace_id, TemporalFairnessKey, (COALESCE(close_time, '9999-12-31 23:59:59')) DESC, start_time DESC, run_id);
