...
functional-test-coverage: prepare-coverage-test
	...
	go run ./cmd/tools/test-runner2 --max-attempts=$(MAX_TEST_ATTEMPTS) --stuck-test-timeout=999m --junitfile=$(NEW_REPORT) --log-dir=$(TEST_OUTPUT_ROOT) --group-by=test -- \
