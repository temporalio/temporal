...
Use Temporal-CLI with `docker run --network=host --rm temporalio-tctl:53c0d92078337583144a4425007f5ab4dd02484a`

For example to register new domain 'test-domain' with 1 retention day
`docker run --network=host --rm temporalio-tctl:53c0d92078337583144a4425007f5ab4dd02484a --do test-domain domain register -rd 1`
