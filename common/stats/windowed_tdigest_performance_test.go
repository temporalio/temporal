...
cpu: Apple M5 Max
                                                       │   sec/op    │
NewWindow-18                                             519.6µ ± 2%
TenMillionRecordQuery/trimmed-mean-size-10-18             10.81 ± 1%
TenMillionRecordQuery/quantile-size-10-18                 10.69 ± 3%
TenMillionRecordQuery/trimmed-mean-size-100-18            4.887 ± 1%
TenMillionRecordQuery/quantile-size-100-18                4.886 ± 0%
TenMillionRecordQuery/trimmed-mean-size-1000-18           3.590 ± 0%
TenMillionRecordQuery/quantile-size-1000-18               3.592 ± 0%
TenMillionRecordQuery/trimmed-mean-size-10000-18         467.6m ± 1%
TenMillionRecordQuery/quantile-size-10000-18             468.7m ± 0%
Insert/10k-datapoints-retain-all-window-size-10-18       259.7µ ± 1%
Insert/10k-datapoints-retain-all-window-size-100-18      514.7µ ± 1%
Insert/10k-datapoints-retain-all-window-size-1000-18     1.438m ± 1%
Insert/10k-datapoints-retain-all-window-size-10000-18    4.354m ± 1%
Insert/10M-datapoints-retain-all-window-size-10-18        7.240 ± 4%
Insert/10M-datapoints-retain-all-window-size-100-18      528.0m ± 2%
Insert/10M-datapoints-retain-all-window-size-1000-18      1.397 ± 1%
Insert/10M-datapoints-retain-all-window-size-10000-18     4.308 ± 0%
Insert/10M-datapoints-retain-all-window-size-100000-18    5.264 ± 1%
Insert/10M-datapoints-retain-10k-window-size-10-18       216.1m ± 0%
Insert/10M-datapoints-retain-10k-window-size-100-18      473.2m ± 0%
Insert/10M-datapoints-retain-10k-window-size-1000-18      1.394 ± 0%
Insert/10M-datapoints-retain-10k-window-size-10000-18     4.321 ± 0%
geomean                                                  366.2m

                                                       │     B/op     │
NewWindow-18                                             4.751Mi ± 0%
TenMillionRecordQuery/trimmed-mean-size-10-18            809.1Mi ± 0%
TenMillionRecordQuery/quantile-size-10-18                809.0Mi ± 0%
TenMillionRecordQuery/trimmed-mean-size-100-18           321.1Mi ± 0%
TenMillionRecordQuery/quantile-size-100-18               320.7Mi ± 1%
TenMillionRecordQuery/trimmed-mean-size-1000-18          109.1Mi ± 0%
TenMillionRecordQuery/quantile-size-1000-18              109.2Mi ± 0%
TenMillionRecordQuery/trimmed-mean-size-10000-18         14.74Mi ± 0%
TenMillionRecordQuery/quantile-size-10000-18             14.73Mi ± 0%
Insert/10k-datapoints-retain-all-window-size-10-18       12.82Ki ± 1%
Insert/10k-datapoints-retain-all-window-size-100-18      8.738Ki ± 0%
Insert/10k-datapoints-retain-all-window-size-1000-18     6.494Ki ± 0%
...
Insert/10M-datapoints-retain-10k-window-size-10000-18    454.0Mi ± 0%
geomean                                                  27.88Mi
...
TenMillionRecordQuery/trimmed-mean-size-100-18           122.2k ± 0%
TenMillionRecordQuery/quantile-size-100-18               122.2k ± 0%
TenMillionRecordQuery/trimmed-mean-size-1000-18          12.93k ± 0%
TenMillionRecordQuery/quantile-size-1000-18              12.93k ± 0%
TenMillionRecordQuery/trimmed-mean-size-10000-18         1.300k ± 0%
TenMillionRecordQuery/quantile-size-10000-18             1.300k ± 0%
...
Insert/10k-datapoints-retain-all-window-size-10000-18             22.25Ki ± 2%
...
Insert/10M-datapoints-retain-all-window-size-10000-18             21.60Mi ± 0%
Insert/10M-datapoints-retain-all-window-size-100000-18            2.334Mi ± 2%
...
Insert/10M-datapoints-retain-10k-window-size-10000-18             22.26Ki ± 1%
geomean                                                           1.131Mi
*/
	...
	for windowSize := in.startWindowSize; windowSize <= in.maxWindowSize; windowSize *= 10 {
		in.b.Run(fmt.Sprintf("%s-window-size-%d", in.name, windowSize), func(b *testing.B) {
			for range b.N {
				...
				w := stats.(*timeWindowedTDigest)
				for range w.cfg.WindowCount {
					w.advanceWindowSimple(n(1))
				}
				b.StartTimer()
				for _, dp := range datapoints {
					stats.RecordMulti(dp.Value, dp.Time, dp.Count)
