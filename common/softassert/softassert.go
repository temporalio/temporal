...
// ThatSometimes is used to conditionally log a debug message of a noteworthy but non-critical event.
...
// Sometimes is used to log a debug message of a noteworthy but non-critical event.
