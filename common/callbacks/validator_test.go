...
func TestValidateAdditions(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			name:     "under count",
			maxCount: 10,
			existing: ValidateAdditionsOptions{CurrentCount: 3},
			adding:   2,
		},
		{
		...
		},
		{
			...
			maxCount: 2,
			existing: ValidateAdditionsOptions{CurrentCount: 5},
			adding:   0,
		...
		},
		{
			...
			maxCount: 10,
			maxSize:  cbSize * 10,
			existing: ValidateAdditionsOptions{CurrentCallbacksSize: cbSize},
			adding:   2,
		},
		{
		...
		},
		{
			...
			maxCount: 10,
			maxSize:  0,
			existing: ValidateAdditionsOptions{CurrentCallbacksSize: 1 << 30},
			adding:   2,
		},
		{
			...
			maxCount: 1,
			maxSize:  1,
			existing: ValidateAdditionsOptions{CurrentCount: 1, CurrentCallbacksSize: 100},
			adding:   1,
