...
// Source: common/archiver/azure_store/connector/client.go
//
// Generated by this command:
//
//	mockgen -package connector -source common/archiver/azure_store/connector/client.go -destination common/archiver/azure_store/connector/client_mock.go
//
