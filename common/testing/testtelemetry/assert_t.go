...
func (t *AssertT) Errorf(format string, args ...any) {
	...
	t.span.AddEvent("test assertion failed", trace.WithAttributes(
		attribute.String("error.message", cleanMessage(msg)),
...
// cleanMessage removes leading/trailing whitespace and replaces tabs with spaces
// for readability in OTEL event attributes.
