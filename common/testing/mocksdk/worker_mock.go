...
func (m *MockWorker) RegisterDynamicActivity(a any, options internal.DynamicRegisterActivityOptions) {
	m.ctrl.T.Helper()
...
func (m *MockWorker) RegisterDynamicWorkflow(w any, options internal.DynamicRegisterWorkflowOptions) {
	m.ctrl.T.Helper()
