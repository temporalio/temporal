...
//
//	mockgen -package operatorservicemock -destination common/testing/mockapi/operatorservicemock/v1/service_grpc.pb.mock.go go.temporal.io/api/operatorservice/v1 OperatorServiceClient
//
