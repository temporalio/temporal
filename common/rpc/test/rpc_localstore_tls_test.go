...
func (s *localStoreRPCSuite) SetupSuite() {
	...
	s.NoError(err)
	insecureFactory := rpc.NewFactory(cfg, nil, "tester", s.logger, provider, frontendURL, frontendHTTPURL, 0, nil, nil, nil)
...
func (s *localStoreRPCSuite) setupFrontend() {
	...
	s.NoError(err)
	frontendMutualTLSFactory := rpc.NewFactory(cfg, nil, "tester", s.logger, provider, frontendURL, frontendHTTPURL, 0, tlsConfig, nil, nil)
	...
	s.NoError(err)
	frontendServerTLSFactory := rpc.NewFactory(cfg, nil, "tester", s.logger, provider, frontendURL, frontendHTTPURL, 0, nil, nil, nil)
	...
	tlsConfig, err = provider.GetFrontendClientConfig()
	s.NoError(err)
	frontendSystemWorkerMutualTLSFactory := rpc.NewFactory(cfg, nil, "tester", s.logger, provider, frontendURL, frontendHTTPURL, 0, tlsConfig, nil, nil)
	...
	tlsConfig, err = provider.GetFrontendClientConfig()
	s.NoError(err)
	frontendMutualTLSRefreshFactory := rpc.NewFactory(cfg, nil, "tester", s.logger, provider, frontendURL, frontendHTTPURL, 0, tlsConfig, nil, nil)
	...
	s.NoError(err)
	dynamicServerTLSFactory := rpc.NewFactory(cfg, nil, "tester", s.logger, s.dynamicConfigProvider, frontendURL, frontendHTTPURL, 0, tlsConfig, nil, nil)
	...
	tlsConfig, err = provider.GetFrontendClientConfig()
	s.NoError(err)
	frontendRootCAForceTLSFactory := rpc.NewFactory(cfg, nil, "tester", s.logger, provider, frontendURL, frontendHTTPURL, 0, tlsConfig, nil, nil)
	s.NotNil(frontendServerTLSFactory)
	...
	tlsConfig, err = provider.GetFrontendClientConfig()
	s.NoError(err)
	remoteClusterMutualTLSRPCFactory := rpc.NewFactory(cfg, nil, "tester", s.logger, provider, frontendURL, frontendHTTPURL, 0, tlsConfig, nil, nil)
...
func (s *localStoreRPCSuite) setupInternode() {
	...
	tlsConfig, err := provider.GetFrontendClientConfig()
	s.NoError(err)
	internodeMutualTLSFactory := rpc.NewFactory(cfg, nil, "tester", s.logger, provider, frontendURL, frontendHTTPURL, 0, tlsConfig, nil, nil)
	...
	tlsConfig, err = provider.GetFrontendClientConfig()
	s.NoError(err)
	internodeServerTLSFactory := rpc.NewFactory(cfg, nil, "tester", s.logger, provider, frontendURL, frontendHTTPURL, 0, tlsConfig, nil, nil)
	...
	tlsConfig, err = provider.GetFrontendClientConfig()
	s.NoError(err)
	internodeMutualAltTLSFactory := rpc.NewFactory(cfg, nil, "tester", s.logger, provider, frontendURL, frontendHTTPURL, 0, tlsConfig, nil, nil)
	...
	tlsConfig, err = provider.GetFrontendClientConfig()
	s.NoError(err)
	internodeMutualTLSRefreshFactory := rpc.NewFactory(cfg, nil, "tester", s.logger, provider, frontendURL, frontendHTTPURL, 0, tlsConfig, nil, nil)
