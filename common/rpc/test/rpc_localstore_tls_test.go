...
func (s *localStoreRPCSuite) SetupSuite() {
	...
	s.NoError(err)
	insecureFactory := rpc.NewFactory(cfg, "tester", s.logger, provider, frontendURL, frontendHTTPURL, 0, nil, nil, nil, nil)
...
func (s *localStoreRPCSuite) setupFrontend() {
	...
	s.NoError(err)
	frontendServerTLSFactory := rpc.NewFactory(cfg, "tester", s.logger, provider, frontendURL, frontendHTTPURL, 0, nil, nil, nil, nil)
...
func (s *localStoreRPCSuite) setupInternode() {
	...
	tlsConfig, err := provider.GetFrontendClientConfig()
	s.NoError(err)
	internodeMutualTLSFactory := rpc.NewFactory(cfg, "tester", s.logger, provider, frontendURL, frontendHTTPURL, 0, tlsConfig, nil, nil, nil)
	...
	tlsConfig, err = provider.GetFrontendClientConfig()
	s.NoError(err)
	internodeServerTLSFactory := rpc.NewFactory(cfg, "tester", s.logger, provider, frontendURL, frontendHTTPURL, 0, tlsConfig, nil, nil, nil)
	...
	tlsConfig, err = provider.GetFrontendClientConfig()
	s.NoError(err)
	internodeMutualAltTLSFactory := rpc.NewFactory(cfg, "tester", s.logger, provider, frontendURL, frontendHTTPURL, 0, tlsConfig, nil, nil, nil)
	...
	tlsConfig, err = provider.GetFrontendClientConfig()
	s.NoError(err)
	internodeMutualTLSRefreshFactory := rpc.NewFactory(cfg, "tester", s.logger, provider, frontendURL, frontendHTTPURL, 0, tlsConfig, nil, nil, nil)
