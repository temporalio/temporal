...
func (wt *WorkflowTags) extractFromAdminServiceServerMessage(message any) []tag.Tag {
	...
	case *adminservice.StartAdminBatchOperationResponse:
		return nil
	case *adminservice.SyncLocalExecutionRequest:
		return []tag.Tag{
			tag.WorkflowID(r.GetExecution().GetWorkflowId()),
			tag.WorkflowRunID(r.GetExecution().GetRunId()),
		}
	case *adminservice.SyncLocalExecutionResponse:
		return nil
	...
	case *adminservice.SyncWorkflowStateResponse:
		return nil
	case *adminservice.UpdateLocalExecutionStateRequest:
		return []tag.Tag{
			tag.WorkflowID(r.GetExecution().GetWorkflowId()),
			tag.WorkflowRunID(r.GetExecution().GetRunId()),
		}
	case *adminservice.UpdateLocalExecutionStateResponse:
		return nil
	default:
		return nil
	}
