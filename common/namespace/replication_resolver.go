...
type ReplicationResolver interface {
	...
	ReplicationState(workflowID string) enumspb.ReplicationState
...
func (r *defaultReplicationResolver) ReplicationState(workflowID string) enumspb.ReplicationState {
	if r.replicationConfig == nil {
