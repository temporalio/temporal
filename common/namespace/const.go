...
const (
	// MinRetentionGlobal is a hard limit for the minimum retention duration for global
	// namespaces (to allow time for replication).
	MinRetentionGlobal = 1 * 24 * time.Hour

	// MinRetentionLocal is a hard limit for the minimum retention duration for local
