...
// supporting Link_WorkflowEvent, Link_Activity, and Link_Callback variants. Unsupported or malformed
// entries are skipped with a warning since links are non-essential to execution.
