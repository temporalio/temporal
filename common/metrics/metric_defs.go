...
var (
	...
	MembershipReachableMembers                    = NewGaugeDef("membership_reachable_members", WithDescription("Number of hosts currently visible as reachable in the membership ring for this service."))
	MembershipAvailableMembers                    = NewGaugeDef("membership_available_members", WithDescription("Number of reachable hosts currently accepting new requests (not draining) for this service."))
	MembershipDrainingMembers                     = NewGaugeDef("membership_draining_members", WithDescription("Number of reachable hosts currently marked draining for this service."))
