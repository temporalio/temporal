...
var (
	...
	WorkerStorageDriverTypeMetric = NewGaugeDef(
		...
		WithDescription(
			"Set if the worker was configured with a storage driver. storage_driver_type is sanitized according to MatchingStorageDriverMetricsAllowedTypes. Dimensions: namespace, storage_driver_type."),
	)
	// ----------------------------------------------------------------------------------------------------------------
