...
var (
	...
	ActivityPayloadSize                                  = NewCounterDef("activity_payload_size", WithDescription("Size of activity start/complete payloads in bytes."))
	ActivityFailurePayloadSize                           = NewCounterDef("activity_failure_payload_size", WithDescription("Size of activity failure payloads in bytes."))
	ActivityHeartbeatPayloadSize                         = NewCounterDef("activity_heartbeat_payload_size", WithDescription("Size of activity heartbeat payloads in bytes."))
