...
var (
	...
	ActivityTaskPause                                = NewCounterDef("activity_task_pause", WithDescription("Number of activity task pauses."))
	ActivityTaskUnpause                              = NewCounterDef("activity_task_unpause", WithDescription("Number of activity task unpause."))
