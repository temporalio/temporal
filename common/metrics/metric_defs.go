...
var (
	...
	ActivityTaskPause                                = NewCounterDef("activity_task_pause", WithDescription("Number of activity pauses."))
	ActivityTaskUnpause                              = NewCounterDef("activity_task_unpause", WithDescription("Number of activity unpauses."))
