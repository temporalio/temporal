...
var (
	workflowServiceMetadata = map[string]MethodMetadata{
		...
		"CountCallbackExecutions":                      {Scope: ScopeNamespace, Access: AccessReadOnly, Polling: PollingNone},
		...
		"DeleteCallbackExecution":                      {Scope: ScopeNamespace, Access: AccessWrite, Polling: PollingNone},
		...
		"DescribeCallbackExecution":                    {Scope: ScopeNamespace, Access: AccessReadOnly, Polling: PollingCapable},
		...
		"PollCallbackExecution":                        {Scope: ScopeNamespace, Access: AccessReadOnly, Polling: PollingAlways},
		...
		"ListCallbackExecutions":                       {Scope: ScopeNamespace, Access: AccessReadOnly, Polling: PollingNone},
		...
		"StartCallbackExecution":                       {Scope: ScopeNamespace, Access: AccessWrite, Polling: PollingNone},
		...
		"TerminateCallbackExecution":                   {Scope: ScopeNamespace, Access: AccessWrite, Polling: PollingNone},
