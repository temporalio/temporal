...
func (mr *MockRPCFactoryMockRecorder) CreateHistoryGRPCConnection(rpcAddress interface{}) *gomock.Call {
...
func (mr *MockRPCFactoryMockRecorder) CreateMatchingGRPCConnection(rpcAddress interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRPCFactoryMockRecorder) CreateRemoteFrontendGRPCConnection(rpcAddress interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
