...
func NewExecutionPersistenceMetricsClient(persistence ExecutionManager, metricsHandler metrics.Handler, healthSignals HealthSignalAggregator, logger log.Logger, enableDataLossMetrics ...dynamicconfig.BoolPropertyFn) ExecutionManager {
	var enableDataLoss dynamicconfig.BoolPropertyFn
	if len(enableDataLossMetrics) > 0 {
		enableDataLoss = enableDataLossMetrics[0]
	}
	return &executionPersistenceClient{
		metricEmitter: metricEmitter{
			metricsHandler:        metricsHandler,
			logger:                logger,
			enableDataLossMetrics: enableDataLoss,
		},
		healthSignals: healthSignals,
		persistence:   persistence,
	}
...
func (p *executionPersistenceClient) CreateWorkflowExecution(
	...
	defer func() {
		...
		p.recordRequestMetrics(metrics.PersistenceCreateWorkflowExecutionScope, caller, time.Since(startTime), retErr, workflowID, runID)
...
func (p *executionPersistenceClient) GetWorkflowExecution(
	...
	defer func() {
		...
		p.recordRequestMetrics(metrics.PersistenceGetWorkflowExecutionScope, caller, time.Since(startTime), retErr, workflowID, runID)
...
func (p *executionPersistenceClient) SetWorkflowExecution(
	...
	defer func() {
		...
		p.recordRequestMetrics(metrics.PersistenceSetWorkflowExecutionScope, caller, time.Since(startTime), retErr, workflowID, runID)
...
func (p *executionPersistenceClient) UpdateWorkflowExecution(
	...
	defer func() {
		...
		p.recordRequestMetrics(metrics.PersistenceUpdateWorkflowExecutionScope, caller, time.Since(startTime), retErr, workflowID, runID)
...
func (p *executionPersistenceClient) ConflictResolveWorkflowExecution(
	...
	defer func() {
		...
		p.recordRequestMetrics(metrics.PersistenceConflictResolveWorkflowExecutionScope, caller, time.Since(startTime), retErr, workflowID, runID)
...
func (p *executionPersistenceClient) DeleteWorkflowExecution(
	...
	defer func() {
		...
		p.recordRequestMetrics(metrics.PersistenceDeleteWorkflowExecutionScope, caller, time.Since(startTime), retErr, workflowID, runID)
...
func (p *executionPersistenceClient) DeleteCurrentWorkflowExecution(
	...
	defer func() {
		...
		p.recordRequestMetrics(metrics.PersistenceDeleteCurrentWorkflowExecutionScope, caller, time.Since(startTime), retErr, workflowID, runID)
...
func (p *executionPersistenceClient) GetCurrentExecution(
	...
	defer func() {
		...
		p.recordRequestMetrics(metrics.PersistenceGetCurrentExecutionScope, caller, time.Since(startTime), retErr, workflowID, runID)
...
func (p *executionPersistenceClient) AddHistoryTasks(
	...
	defer func() {
		...
		p.recordRequestMetrics(metrics.PersistenceAddTasksScope, caller, time.Since(startTime), retErr, workflowID, runID)
...
func (p *executionPersistenceClient) PutReplicationTaskToDLQ(
	...
	defer func() {
		...
		p.recordRequestMetrics(metrics.PersistencePutReplicationTaskToDLQScope, caller, time.Since(startTime), retErr, workflowID, runID)
...
func (p *metricEmitter) recordRequestMetrics(operation string, caller string, latency time.Duration, err error, workflowID, runID string) {
...
func (p *metricEmitter) recordDataLossMetrics(operation string, caller string, err error, workflowID, runID string) {
	...
	if p.enableDataLossMetrics != nil && p.enableDataLossMetrics() {
