...
func (m *MockVisibilityQueryConverter) ConvertKeywordListComparisonExpr(operator string, col *query.SAColumnName, value sqlparser.Expr) (sqlparser.Expr, error) {
	m.ctrl.T.Helper()
...
func (m *MockVisibilityQueryConverter) ConvertTextComparisonExpr(operator string, col *query.SAColumnName, value sqlparser.Expr) (sqlparser.Expr, error) {
	m.ctrl.T.Helper()
