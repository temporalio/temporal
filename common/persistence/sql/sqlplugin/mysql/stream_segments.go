...
first_offset = VALUES(first_offset),
...
func (mdb *db) DeleteFromStreamSegmentsByTxn(
	...
	return mdb.ExecContext(ctx, deleteStreamSegmentsByTxnQry, filter.ShardID, filter.NamespaceID, filter.StreamID, filter.TxnID)
}
...
func (mdb *db) DeleteFromStreamSegmentsPrefix(
	...
	return mdb.ExecContext(ctx, deleteStreamSegmentsPrefixQry, filter.ShardID, filter.NamespaceID, filter.StreamID, filter.BelowOffset)
}
...
func (mdb *db) DeleteFromStreamSegments(
	...
	return mdb.ExecContext(ctx, deleteStreamSegmentsQry, filter.ShardID, filter.NamespaceID, filter.StreamID)
}
