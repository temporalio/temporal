...
func TestQueryConverter_ConvertComparisonExpr(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			col:      intCol,
			value:    123,
			out:      &rangeQuery{Field: intCol.FieldName, Gte: 123},
		},
		{
			...
			col:      intCol,
			value:    123,
			out:      &rangeQuery{Field: intCol.FieldName, Lte: 123},
		},
		{
			...
			col:      intCol,
			value:    123,
			out:      &rangeQuery{Field: intCol.FieldName, Gt: 123},
		},
		{
			...
			col:      intCol,
			value:    123,
			out:      &rangeQuery{Field: intCol.FieldName, Lt: 123},
		},
		{
			name:     "operator equal",
...
func TestQueryConverter_ConvertKeywordComparisonExpr(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			col:      keywordCol,
			value:    "foo",
			out:      &rangeQuery{Field: keywordCol.FieldName, Gte: "foo"},
		},
		{
			name:     "operator less equal",
			operator: sqlparser.LessEqualStr,
			col:      keywordCol,
			value:    "foo",
			out:      &rangeQuery{Field: keywordCol.FieldName, Lte: "foo"},
		},
		{
			name:     "operator greater than",
			operator: sqlparser.GreaterThanStr,
			col:      keywordCol,
			value:    "foo",
			out:      &rangeQuery{Field: keywordCol.FieldName, Gt: "foo"},
		},
		{
			name:     "operator less than",
			operator: sqlparser.LessThanStr,
			col:      keywordCol,
			value:    "foo",
			out:      &rangeQuery{Field: keywordCol.FieldName, Lt: "foo"},
		},
		{
			name:     "operator equal",
			operator: sqlparser.EqualStr,
...
func TestQueryConverter_ConvertRangeExpr(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			from:     "123",
			to:       "456",
			out:      &rangeQuery{Field: keywordCol.FieldName, Gte: "123", Lte: "456"},
		},
		{
			...
			to:       "456",
			out: newBoolQuery().MustNot(
				&rangeQuery{Field: keywordCol.FieldName, Gte: "123", Lte: "456"},
			),
		},
		{
			name:     "invalid operator",
