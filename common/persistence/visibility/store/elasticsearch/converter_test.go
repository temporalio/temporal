...
var supportedWhereCases = map[string]string{
	...
	"process_id > 1":                `{"bool":{"filter":[{"range":{"process_id":{"gt":1}}}]}}`,
	"process_id < 1":                `{"bool":{"filter":[{"range":{"process_id":{"lt":1}}}]}}`,
	"process_id <= 1":               `{"bool":{"filter":[{"range":{"process_id":{"lte":1}}}]}}`,
	"process_id >= 1":               `{"bool":{"filter":[{"range":{"process_id":{"gte":1}}}]}}`,
	"process_id != 1":               `{"bool":{"must_not":[{"term":{"process_id":1}}]}}`,
	"process_id = 0 and status= 1 and channel = 4": `{"bool":{"filter":[{"bool":{"filter":[{"term":{"process_id":0}},{"term":{"status":1}}]}},{"term":{"channel":4}}]}}`,
	"process_id > 1 and status = 1":                `{"bool":{"filter":[{"range":{"process_id":{"gt":1}}},{"term":{"status":1}}]}}`,
	"id > 1 or process_id = 0":                     `{"bool":{"should":[{"range":{"id":{"gt":1}}},{"term":{"process_id":0}}]}}`,
	"id > 1 and d = 1 or process_id = 0 and x = 2": `{"bool":{"should":[{"bool":{"filter":[{"range":{"id":{"gt":1}}},{"term":{"d":1}}]}},{"bool":{"filter":[{"term":{"process_id":0}},{"term":{"x":2}}]}}]}}`,
	"(id > 1 and d = 1)":                           `{"bool":{"filter":[{"range":{"id":{"gt":1}}},{"term":{"d":1}}]}}`,
	"(id > 1 and d = 1) or (c=1)":                  `{"bool":{"should":[{"bool":{"filter":[{"range":{"id":{"gt":1}}},{"term":{"d":1}}]}},{"term":{"c":1}}]}}`,
	...
	"value = '1'":                                  `{"bool":{"filter":[{"match":{"value":"1"}}]}}`,
	"value = 'true'":                               `{"bool":{"filter":[{"match":{"value":"true"}}]}}`,
	"value = 'True'":                               `{"bool":{"filter":[{"match":{"value":"True"}}]}}`,
	"value = true":                                 `{"bool":{"filter":[{"match":{"value":true}}]}}`,
	"value = True":                                 `{"bool":{"filter":[{"match":{"value":true}}]}}`,
	"value = 1528358645123456789":                  `{"bool":{"filter":[{"match":{"value":1528358645123456789}}]}}`,
	"value = 1528358645.1234567":                   `{"bool":{"filter":[{"match":{"value":1528358645.1234567}}]}}`,
	// Long float is truncated.
	"value = 1528358645.123456790":                                            `{"bool":{"filter":[{"match":{"value":1528358645.1234567}}]}}`,
	"id in (\"text1\",'text2') and content = 'aaaa'":                          `{"bool":{"filter":[{"terms":{"id":["text1","text2"]}},{"match":{"content":"aaaa"}}]}}`,
	"create_time BETWEEN '2015-01-01 00:00:00' and '2016-02-02 00:00:00'":     `{"bool":{"filter":[{"range":{"create_time":{"gte":"2015-01-01 00:00:00","lte":"2016-02-02 00:00:00"}}}]}}`,
	"create_time nOt between '2015-01-01 00:00:00' and '2016-02-02 00:00:00'": `{"bool":{"must_not":[{"range":{"create_time":{"gte":"2015-01-01 00:00:00","lte":"2016-02-02 00:00:00"}}}]}}`,
	"create_time between '2015-01-01T00:00:00+0800' and '2017-01-01T00:00:00+0800' and process_id = 0 and status >= 1 and content = '三个男人' and phone = '15810324322'": `{"bool":{"filter":[{"bool":{"filter":[{"bool":{"filter":[{"bool":{"filter":[{"range":{"create_time":{"gte":"2015-01-01T00:00:00+0800","lte":"2017-01-01T00:00:00+0800"}}},{"term":{"process_id":0}}]}},{"range":{"status":{"gte":1}}}]}},{"match":{"content":"三个男人"}}]}},{"match":{"phone":"15810324322"}}]}}`,
...
var supportedWhereOrderCases = map[string]struct {
	...
	"id > 1 order by id asc, order_id desc": {
		query:  `{"bool":{"filter":[{"range":{"id":{"gt":1}}}]}}`,
	...
	"id beTweeN 1 AnD 3 ORdeR BY random_id DESC": {
		query:  `{"bool":{"filter":[{"range":{"id":{"gte":1,"lte":3}}}]}}`,
