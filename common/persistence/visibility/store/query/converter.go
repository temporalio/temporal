...
type (
	StoreQueryConverter[ExprT any] interface {
		...
		ConvertComparisonExpr(operator string, col *SAColName, value any) (ExprT, error)

		ConvertKeywordComparisonExpr(operator string, col *SAColName, value any) (ExprT, error)

		ConvertKeywordListComparisonExpr(operator string, col *SAColName, value any) (ExprT, error)

		ConvertTextComparisonExpr(operator string, col *SAColName, value any) (ExprT, error)

		ConvertRangeExpr(operator string, col *SAColName, from, to any) (ExprT, error)

		ConvertIsExpr(operator string, col *SAColName) (ExprT, error)
	}
...
func (c *QueryConverter[ExprT]) convertColName(in sqlparser.Expr) (*SAColName, error) {
	...
	colName := NewSAColName(saAlias, saFieldName, saType)
