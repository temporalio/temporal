...
var _ sqlparser.Expr = (*SAColumnName)(nil)

var (
	NamespaceIDSAColumnName = NewSAColumnName(
		searchattribute.NamespaceID,
		searchattribute.NamespaceID,
		enumspb.INDEXED_VALUE_TYPE_KEYWORD,
	)

	NamespaceDivisionSAColumnName = NewSAColumnName(
		searchattribute.TemporalNamespaceDivision,
		searchattribute.TemporalNamespaceDivision,
		enumspb.INDEXED_VALUE_TYPE_KEYWORD,
	)

	CloseTimeSAColumnName = NewSAColumnName(
...
func (node *SAColumnName) Format(buf *sqlparser.TrackedBuffer) {
...
func NewSAColumnName(alias string, fieldName string, valueType enumspb.IndexedValueType) *SAColumnName {
	return &SAColumnName{
		Alias:     alias,
		FieldName: fieldName,
		ValueType: valueType,
