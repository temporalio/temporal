...
// SerializerCodecEnvVar controls which codec is used for encoding DataBlobs.
//
...
const SerializerCodecEnvVar = "TEMPORAL_TEST_DATA_ENCODING"
...
func EncodingTypeFromEnv() enumspb.EncodingType {
	codecType := os.Getenv(SerializerCodecEnvVar)
	...
	default:
		...
		panic(fmt.Sprintf("unknown codec %q for environment variable %s", codecType, SerializerCodecEnvVar))
	}
}
