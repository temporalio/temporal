...
func (_m *HistoryClient) GetWorkflowExecutionHistory(request *shared.GetWorkflowExecutionHistoryRequest) (*shared.GetWorkflowExecutionHistoryResponse, error) {
...
func (_m *HistoryClient) RecordActivityTaskHeartbeat(request *shared.RecordActivityTaskHeartbeatRequest) (*shared.RecordActivityTaskHeartbeatResponse, error) {
	ret := _m.Called(request)
...
func (_m *HistoryClient) RecordActivityTaskStarted(request *gohistory.RecordActivityTaskStartedRequest) (*gohistory.RecordActivityTaskStartedResponse, error) {
	ret := _m.Called(request)
...
func (_m *HistoryClient) RecordDecisionTaskStarted(request *gohistory.RecordDecisionTaskStartedRequest) (*gohistory.RecordDecisionTaskStartedResponse, error) {
	ret := _m.Called(request)
...
func (_m *HistoryClient) RespondActivityTaskCompleted(request *shared.RespondActivityTaskCompletedRequest) error {
	ret := _m.Called(request)
...
func (_m *HistoryClient) RespondActivityTaskFailed(request *shared.RespondActivityTaskFailedRequest) error {
	ret := _m.Called(request)
...
func (_m *HistoryClient) StartWorkflowExecution(request *shared.StartWorkflowExecutionRequest) (*shared.StartWorkflowExecutionResponse, error) {
	ret := _m.Called(request)
