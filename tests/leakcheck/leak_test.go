...
var goleakOpts = []goleak.Option{
	...
	goleak.IgnoreAnyFunction("go.temporal.io/server/common/membership.(*grpcResolver).listen"),
	...
	goleak.IgnoreAnyFunction("go.temporal.io/sdk/internal.(*baseWorker).Start.func2"),
