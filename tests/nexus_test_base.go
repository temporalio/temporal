...
// describeNexusOperation describes a standalone Nexus operation by ID, including its outcome and the
// info for any completion callbacks attached to it.
...
// (e.g. the Nexus operation gets canceled.)
