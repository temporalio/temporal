...
func TestLinks(t *testing.T) {
	t.Run("TerminateWorkflow_LinksAttachedToEvent", func(t *testing.T) {
		s := testcore.NewEnv(t)
		...
		history := sdkClient.GetWorkflowHistory(ctx, run.GetID(), "", false, enumspb.HISTORY_EVENT_FILTER_TYPE_CLOSE_EVENT)
		event, err := history.Next()
		s.NoError(err)
		protorequire.ProtoSliceEqual(t, links, event.Links)
	})

	t.Run("RequestCancelWorkflow_LinksAttachedToEvent", func(t *testing.T) {
		s := testcore.NewEnv(t)
		...
		history := sdkClient.GetWorkflowHistory(ctx, run.GetID(), "", false, enumspb.HISTORY_EVENT_FILTER_TYPE_ALL_EVENT)
		foundEvent := false
		for history.HasNext() {
			event, err := history.Next()
			s.NoError(err)
	...
	t.Run("SignalWorkflowExecution_LinksAttachedToEvent", func(t *testing.T) {
		s := testcore.NewEnv(t)
	...
	t.Run("SignalWithStartWorkflowExecution_LinksAttachedToRelevantEvents", func(t *testing.T) {
		s := testcore.NewEnv(t)
		...
		history := sdkClient.GetWorkflowHistory(ctx, workflowID, "", false, enumspb.HISTORY_EVENT_FILTER_TYPE_ALL_EVENT)
