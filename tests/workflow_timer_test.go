...
func TestWorkflowTimer(t *testing.T) {
	t.Run("CancelTimer", func(t *testing.T) {
		s := testcore.NewEnv(t)
		...
		wtHandler := func(task *workflowservice.PollWorkflowTaskQueueResponse) ([]*commandpb.Command, error) {
			...
			if !signalDelivered {
				t.Fatal("should receive a signal")
			}
		...
		require.Nil(t, s.SendSignal(s.Namespace().String(), workflowExecution, "random signal name", payloads.EncodeString("random signal payload"), identity))
...
`, historyEvents)
	...
	t.Run("CancelTimer_CancelFiredAndBuffered", func(t *testing.T) {
		s := testcore.NewEnv(t)
