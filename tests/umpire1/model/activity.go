...
// This file defines the standalone activity lifecycle used for planning and static validation in
// the compatibility implementation. Public scheduled, started, and terminal states are observable;
