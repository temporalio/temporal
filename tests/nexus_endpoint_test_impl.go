...
func runTestNexusEndpointsCommonSuite(t *testing.T) {
	parallelsuite.Run(t, &CommonSuite{})
}

func runTestNexusEndpointsMatchingSuite(t *testing.T) {
	parallelsuite.Run(t, &MatchingSuite{})
}

func runTestNexusEndpointsOperatorSuite(t *testing.T) {
