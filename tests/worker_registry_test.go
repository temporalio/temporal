...
func TestWorkerRegistryTestSuite(t *testing.T) {
	parallelsuite.RunLegacySequential(t, &WorkerRegistryTestSuite{}) //nolint:staticcheck // SA1019: suite runs sequentially to limit worker-service cluster churn.
}

func (s *WorkerRegistryTestSuite) newTestEnv(opts ...testcore.TestOption) *testcore.TestEnv {
	baseOpts := []testcore.TestOption{
		testcore.WithWorkerService("worker registry"),
