...
func TestNamespaceDelete(t *testing.T) {
	...
	t.Run("OverrideDelay", func(t *testing.T) {
		s := testcore.NewEnv(t,
			testcore.WithDynamicConfig(dynamicconfig.DeleteNamespaceDeleteActivityRPS, 1000000),
			testcore.WithDynamicConfig(dynamicconfig.TransferProcessorUpdateAckInterval, 1*time.Second),
			testcore.WithDynamicConfig(dynamicconfig.VisibilityProcessorUpdateAckInterval, 1*time.Second),
	...
	t.Run("Empty_WithID", func(t *testing.T) {
		s := testcore.NewEnv(t,
			testcore.WithDynamicConfig(dynamicconfig.DeleteNamespaceDeleteActivityRPS, 1000000),
			testcore.WithDynamicConfig(dynamicconfig.TransferProcessorUpdateAckInterval, 1*time.Second),
			testcore.WithDynamicConfig(dynamicconfig.VisibilityProcessorUpdateAckInterval, 1*time.Second),
	...
	t.Run("WithNameAndID", func(t *testing.T) {
		s := testcore.NewEnv(t,
			testcore.WithDynamicConfig(dynamicconfig.DeleteNamespaceDeleteActivityRPS, 1000000),
			testcore.WithDynamicConfig(dynamicconfig.TransferProcessorUpdateAckInterval, 1*time.Second),
			testcore.WithDynamicConfig(dynamicconfig.VisibilityProcessorUpdateAckInterval, 1*time.Second),
	...
	t.Run("WithWorkflows", func(t *testing.T) {
		s := testcore.NewEnv(t,
			testcore.WithDynamicConfig(dynamicconfig.DeleteNamespaceDeleteActivityRPS, 1000000),
			testcore.WithDynamicConfig(dynamicconfig.TransferProcessorUpdateAckInterval, 1*time.Second),
			testcore.WithDynamicConfig(dynamicconfig.VisibilityProcessorUpdateAckInterval, 1*time.Second),
	...
	t.Run("WithMissingWorkflows", func(t *testing.T) {
		s := testcore.NewEnv(t,
			testcore.WithDynamicConfig(dynamicconfig.DeleteNamespaceDeleteActivityRPS, 1000000),
			testcore.WithDynamicConfig(dynamicconfig.TransferProcessorUpdateAckInterval, 1*time.Second),
			testcore.WithDynamicConfig(dynamicconfig.VisibilityProcessorUpdateAckInterval, 1*time.Second),
	...
	t.Run("CrossNamespaceChild", func(t *testing.T) {
