...
machine UmpireWorld {
  ...
  fun ApplyChunk_0(selected: int) {
    if (selected == 0) { Apply_backlog_ack_BacklogPosition_0_DeliveryTask_0(); return; }
    if (selected == 1) { Apply_backlog_ack_BacklogPosition_0_DeliveryTask_1(); return; }
    if (selected == 2) { Apply_backlog_ack_BacklogPosition_1_DeliveryTask_0(); return; }
    if (selected == 3) { Apply_backlog_ack_BacklogPosition_1_DeliveryTask_1(); return; }
    if (selected == 4) { Apply_backlog_append_after_BacklogPosition_0_BacklogPosition_0_DeliveryTask_0(); return; }
    if (selected == 5) { Apply_backlog_append_after_BacklogPosition_0_BacklogPosition_0_DeliveryTask_1(); return; }
    if (selected == 6) { Apply_backlog_append_after_BacklogPosition_0_BacklogPosition_1_DeliveryTask_0(); return; }
    if (selected == 7) { Apply_backlog_append_after_BacklogPosition_0_BacklogPosition_1_DeliveryTask_1(); return; }
    if (selected == 8) { Apply_backlog_append_after_BacklogPosition_1_BacklogPosition_0_DeliveryTask_0(); return; }
    if (selected == 9) { Apply_backlog_append_after_BacklogPosition_1_BacklogPosition_0_DeliveryTask_1(); return; }
    if (selected == 10) { Apply_backlog_append_after_BacklogPosition_1_BacklogPosition_1_DeliveryTask_0(); return; }
    if (selected == 11) { Apply_backlog_append_after_BacklogPosition_1_BacklogPosition_1_DeliveryTask_1(); return; }
    if (selected == 12) { Apply_backlog_append_first_BacklogPosition_0_DeliveryTask_0(); return; }
    if (selected == 13) { Apply_backlog_append_first_BacklogPosition_0_DeliveryTask_1(); return; }
    if (selected == 14) { Apply_backlog_append_first_BacklogPosition_1_DeliveryTask_0(); return; }
    if (selected == 15) { Apply_backlog_append_first_BacklogPosition_1_DeliveryTask_1(); return; }
  ...
  fun ApplyChunk_1(selected: int) {
    if (selected == 16) { Apply_backlog_gc_BacklogPosition_0_DeliveryTask_0(); return; }
    if (selected == 17) { Apply_backlog_gc_BacklogPosition_0_DeliveryTask_1(); return; }
    if (selected == 18) { Apply_backlog_gc_BacklogPosition_1_DeliveryTask_0(); return; }
    if (selected == 19) { Apply_backlog_gc_BacklogPosition_1_DeliveryTask_1(); return; }
    if (selected == 20) { Apply_backlog_read_BacklogPosition_0(); return; }
    if (selected == 21) { Apply_backlog_read_BacklogPosition_1(); return; }
    if (selected == 22) { Apply_delivery_acknowledge_DeliveryTask_0_DeliveryAttempt_0(); return; }
    if (selected == 23) { Apply_delivery_acknowledge_DeliveryTask_0_DeliveryAttempt_1(); return; }
    if (selected == 24) { Apply_delivery_acknowledge_DeliveryTask_1_DeliveryAttempt_0(); return; }
    if (selected == 25) { Apply_delivery_acknowledge_DeliveryTask_1_DeliveryAttempt_1(); return; }
    if (selected == 26) { Apply_delivery_authorize_accept_WorkObligation_0_DeliveryTask_0_DeliveryAttempt_0(); return; }
    if (selected == 27) { Apply_delivery_authorize_accept_WorkObligation_0_DeliveryTask_0_DeliveryAttempt_1(); return; }
    if (selected == 28) { Apply_delivery_authorize_accept_WorkObligation_0_DeliveryTask_1_DeliveryAttempt_0(); return; }
    if (selected == 29) { Apply_delivery_authorize_accept_WorkObligation_0_DeliveryTask_1_DeliveryAttempt_1(); return; }
    if (selected == 30) { Apply_delivery_authorize_accept_WorkObligation_1_DeliveryTask_0_DeliveryAttempt_0(); return; }
    if (selected == 31) { Apply_delivery_authorize_accept_WorkObligation_1_DeliveryTask_0_DeliveryAttempt_1(); return; }
    assert false, "selected candidate is outside its generated chunk";
  }
  ...
  fun ApplyChunk_2(selected: int) {
    if (selected == 32) { Apply_delivery_authorize_accept_WorkObligation_1_DeliveryTask_1_DeliveryAttempt_0(); return; }
    if (selected == 33) { Apply_delivery_authorize_accept_WorkObligation_1_DeliveryTask_1_DeliveryAttempt_1(); return; }
    if (selected == 34) { Apply_delivery_authorize_reject_WorkObligation_0_DeliveryTask_0_DeliveryAttempt_0(); return; }
    if (selected == 35) { Apply_delivery_authorize_reject_WorkObligation_0_DeliveryTask_0_DeliveryAttempt_1(); return; }
    if (selected == 36) { Apply_delivery_authorize_reject_WorkObligation_0_DeliveryTask_1_DeliveryAttempt_0(); return; }
    if (selected == 37) { Apply_delivery_authorize_reject_WorkObligation_0_DeliveryTask_1_DeliveryAttempt_1(); return; }
    if (selected == 38) { Apply_delivery_authorize_reject_WorkObligation_1_DeliveryTask_0_DeliveryAttempt_0(); return; }
    if (selected == 39) { Apply_delivery_authorize_reject_WorkObligation_1_DeliveryTask_0_DeliveryAttempt_1(); return; }
    if (selected == 40) { Apply_delivery_authorize_reject_WorkObligation_1_DeliveryTask_1_DeliveryAttempt_0(); return; }
    if (selected == 41) { Apply_delivery_authorize_reject_WorkObligation_1_DeliveryTask_1_DeliveryAttempt_1(); return; }
    if (selected == 42) { Apply_delivery_dispatch_DeliveryTask_0_DeliveryAttempt_0(); return; }
    if (selected == 43) { Apply_delivery_dispatch_DeliveryTask_0_DeliveryAttempt_1(); return; }
    if (selected == 44) { Apply_delivery_dispatch_DeliveryTask_1_DeliveryAttempt_0(); return; }
    if (selected == 45) { Apply_delivery_dispatch_DeliveryTask_1_DeliveryAttempt_1(); return; }
    if (selected == 46) { Apply_delivery_expire_WorkObligation_0_DeliveryTask_0(); return; }
    if (selected == 47) { Apply_delivery_expire_WorkObligation_0_DeliveryTask_1(); return; }
    assert false, "selected candidate is outside its generated chunk";
  }
  ...
  fun ApplyChunk_3(selected: int) {
    if (selected == 48) { Apply_delivery_expire_WorkObligation_1_DeliveryTask_0(); return; }
    if (selected == 49) { Apply_delivery_expire_WorkObligation_1_DeliveryTask_1(); return; }
    if (selected == 50) { Apply_delivery_offer_sync_DeliveryTask_0(); return; }
    if (selected == 51) { Apply_delivery_offer_sync_DeliveryTask_1(); return; }
    if (selected == 52) { Apply_delivery_persist_ambiguous_WorkObligation_0_DeliveryTask_0_DeliveryQueue_0(); return; }
    if (selected == 53) { Apply_delivery_persist_ambiguous_WorkObligation_0_DeliveryTask_0_DeliveryQueue_1(); return; }
    if (selected == 54) { Apply_delivery_persist_ambiguous_WorkObligation_0_DeliveryTask_1_DeliveryQueue_0(); return; }
    if (selected == 55) { Apply_delivery_persist_ambiguous_WorkObligation_0_DeliveryTask_1_DeliveryQueue_1(); return; }
    if (selected == 56) { Apply_delivery_persist_ambiguous_WorkObligation_1_DeliveryTask_0_DeliveryQueue_0(); return; }
    if (selected == 57) { Apply_delivery_persist_ambiguous_WorkObligation_1_DeliveryTask_0_DeliveryQueue_1(); return; }
    if (selected == 58) { Apply_delivery_persist_ambiguous_WorkObligation_1_DeliveryTask_1_DeliveryQueue_0(); return; }
    if (selected == 59) { Apply_delivery_persist_ambiguous_WorkObligation_1_DeliveryTask_1_DeliveryQueue_1(); return; }
    if (selected == 60) { Apply_delivery_persist_success_WorkObligation_0_DeliveryTask_0_DeliveryQueue_0(); return; }
    if (selected == 61) { Apply_delivery_persist_success_WorkObligation_0_DeliveryTask_0_DeliveryQueue_1(); return; }
    if (selected == 62) { Apply_delivery_persist_success_WorkObligation_0_DeliveryTask_1_DeliveryQueue_0(); return; }
    if (selected == 63) { Apply_delivery_persist_success_WorkObligation_0_DeliveryTask_1_DeliveryQueue_1(); return; }
    assert false, "selected candidate is outside its generated chunk";
  }
  ...
  fun ApplyChunk_4(selected: int) {
    if (selected == 64) { Apply_delivery_persist_success_WorkObligation_1_DeliveryTask_0_DeliveryQueue_0(); return; }
    if (selected == 65) { Apply_delivery_persist_success_WorkObligation_1_DeliveryTask_0_DeliveryQueue_1(); return; }
    if (selected == 66) { Apply_delivery_persist_success_WorkObligation_1_DeliveryTask_1_DeliveryQueue_0(); return; }
    if (selected == 67) { Apply_delivery_persist_success_WorkObligation_1_DeliveryTask_1_DeliveryQueue_1(); return; }
    if (selected == 68) { Apply_delivery_reserve_DeliveryTask_0_DeliveryAttempt_0_Poller_0(); return; }
    if (selected == 69) { Apply_delivery_reserve_DeliveryTask_0_DeliveryAttempt_0_Poller_1(); return; }
    if (selected == 70) { Apply_delivery_reserve_DeliveryTask_0_DeliveryAttempt_1_Poller_0(); return; }
    if (selected == 71) { Apply_delivery_reserve_DeliveryTask_0_DeliveryAttempt_1_Poller_1(); return; }
    if (selected == 72) { Apply_delivery_reserve_DeliveryTask_1_DeliveryAttempt_0_Poller_0(); return; }
    if (selected == 73) { Apply_delivery_reserve_DeliveryTask_1_DeliveryAttempt_0_Poller_1(); return; }
    if (selected == 74) { Apply_delivery_reserve_DeliveryTask_1_DeliveryAttempt_1_Poller_0(); return; }
    if (selected == 75) { Apply_delivery_reserve_DeliveryTask_1_DeliveryAttempt_1_Poller_1(); return; }
    if (selected == 76) { Apply_delivery_resolve_persisted_WorkObligation_0_DeliveryTask_0(); return; }
    if (selected == 77) { Apply_delivery_resolve_persisted_WorkObligation_0_DeliveryTask_1(); return; }
    if (selected == 78) { Apply_delivery_resolve_persisted_WorkObligation_1_DeliveryTask_0(); return; }
    if (selected == 79) { Apply_delivery_resolve_persisted_WorkObligation_1_DeliveryTask_1(); return; }
    assert false, "selected candidate is outside its generated chunk";
  }
  ...
  fun ApplyChunk_5(selected: int) {
    if (selected == 80) { Apply_delivery_retire_DeliveryTask_0(); return; }
    if (selected == 81) { Apply_delivery_retire_DeliveryTask_1(); return; }
    if (selected == 82) { Apply_delivery_retry_DeliveryTask_0_DeliveryAttempt_0(); return; }
    if (selected == 83) { Apply_delivery_retry_DeliveryTask_0_DeliveryAttempt_1(); return; }
    if (selected == 84) { Apply_delivery_retry_DeliveryTask_1_DeliveryAttempt_0(); return; }
    if (selected == 85) { Apply_delivery_retry_DeliveryTask_1_DeliveryAttempt_1(); return; }
    if (selected == 86) { Apply_delivery_spool_DeliveryTask_0(); return; }
    if (selected == 87) { Apply_delivery_spool_DeliveryTask_1(); return; }
    assert false, "selected candidate is outside its generated chunk";
  }
