...
func (p *clusterPool) get(t *testing.T, opts testOptions) *FunctionalTestBase {
...
func (p *clusterPool) getShared(t *testing.T) *FunctionalTestBase {
	return p.shared.get(t, func() *FunctionalTestBase {
		return p.createCluster(t, testOptions{})
	})
}

func (p *clusterPool) getDedicated(t *testing.T, opts testOptions) *FunctionalTestBase {
...
func (p *clusterPool) createCluster(t *testing.T, opts testOptions) *FunctionalTestBase {
