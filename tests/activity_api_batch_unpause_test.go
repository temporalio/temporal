...
func TestActivityApiBatchUnpauseClientTestSuite(t *testing.T) {
	testcore.UseWorkerServiceForSuite(t, "batch operations")
	parallelsuite.RunLegacySequential(t, &ActivityApiBatchUnpauseClientTestSuite{}) //nolint:staticcheck // SA1019: suite requires legacy sequential execution.
}
