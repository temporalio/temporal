...
func TestActivityApiBatchUnpauseClientTestSuite(t *testing.T) {
	parallelsuite.RunLegacySequential(t, &ActivityApiBatchUnpauseClientTestSuite{}) //nolint:staticcheck // SA1019: suite runs sequentially to limit worker-service cluster churn.
}

func (s *ActivityApiBatchUnpauseClientTestSuite) newTestEnv(opts ...testcore.TestOption) *testcore.TestEnv {
